...
// 07/19/2013
//
// Vector Table for ARM Cortex M0 processor interrupt testing
//------------------------------------------------------------------------------
...
static void (* const vector_table[])(void) =
{
    ...
    (void (*)(void)) svcall_handler,//0x2C: SVCall Handler
    (void (*)(void)) 0,             //0x30: reserved
    (void (*)(void)) 0,             //0x34: reserved
    (void (*)(void)) pendsv_handler,//0x38: PendSV
    (void (*)(void)) 0,             //0x3C: SysTick (Reserved)
    (void (*)(void)) irq0_handler,  //0x40: IRQ0  Handler
    (void (*)(void)) irq1_handler,  //0x44: IRQ1  Handler
    (void (*)(void)) irq2_handler,  //0x48: IRQ2  Handler
    (void (*)(void)) irq3_handler,  //0x4C: IRQ3  Handler
    (void (*)(void)) irq4_handler,  //0x50: IRQ4  Handler
