...
//Description:  Temperature sensor test with V1P2
//				- PRCv17 / PMUv4 / SNTv1
//****************************************************************************************************
#include "PRCv17.h"
#include "PRCv17_RF.h"
...
static void operation_init(void){
	...
	*((volatile uint32_t *) 0xA000007C) = 0;
    ...
    sntv1_r01.TSNS_CONT_MODE = 1;
    sntv1_r01.TSNS_EN_CLK_REF = 1;
    mbus_remote_register_write(SNT_ADDR,1,sntv1_r01.as_int);

	// Set temp sensor conversion time
	sntv1_r03.TSNS_SEL_STB_TIME = 0x1; // Default: 0x3
...
int main() {
	...
	*NVIC_ISER = (1 << IRQ_WAKEUP) | (1 << IRQ_GOCEP) | (1 << IRQ_TIMER32) | (1 << IRQ_REG0)| (1 << IRQ_REG1)| (1 << IRQ_REG2)| (1 << IRQ_REG3);
    ...
    ////////////////////////////////////////////////////////
    // Enable TSNS Digital Power Gate (v1p2)
    sntv1_r01.TSNS_SEL_V1P2 = 1;
    mbus_remote_register_write(SNT_ADDR,1,sntv1_r01.as_int);

    ////////////////////////////////////////////////////////
    // Enable TSNS Analog Power Gate (V1P2)
    sntv1_r01.TSNS_EN_SENSOR_V1P2 = 1;
    mbus_remote_register_write(SNT_ADDR,1,sntv1_r01.as_int);
