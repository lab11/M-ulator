...
//			v3.3 debug: writes 0xFAFAFAFA to data storage [1-3] if erroneously went to sleep
//*******************************************************************
#include "PRCv17.h"
#include "PRCv17_RF.h"
#include "mbus.h"
...
#define TEMP_STORAGE_SIZE 100 // Need to leave about 500 Bytes for stack --> around 120
...
inline static void pmu_set_sleep_radio(){
    ...
    mbus_remote_register_write(PMU_ADDR,0x15, 
		...
		| (0xC << 5)  // Frequency multiplier L (actually L+1)
