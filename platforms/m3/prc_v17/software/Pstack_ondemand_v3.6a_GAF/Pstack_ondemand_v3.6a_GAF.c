...
//			v3.1: RDCv1 offset configuration
...
//			v3.6a_GAF: Slightly more data storage
//*******************************************************************
#include "PRCv17.h"
#include "PRCv17_RF.h"
#include "mbus.h"
...
#define DATA_STORAGE_SIZE 240 // Need to leave about 500 Bytes for stack --> around 60 words
