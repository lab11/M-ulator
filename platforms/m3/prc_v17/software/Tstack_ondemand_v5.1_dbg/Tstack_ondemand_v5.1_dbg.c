...
int main() {
    ...
    *NVIC_ISER = (1 << IRQ_WAKEUP) | (1 << IRQ_GOCEP) | (1 << IRQ_TIMER32) | (1 << IRQ_REG0)| (1 << IRQ_REG1)| (1 << IRQ_REG2)| (1 << IRQ_REG3);
    ...
    mbus_write_message32(0xC1, wakeup_data);
    mbus_write_message32(0xC2, wakeup_data_header);
    mbus_write_message32(0xC3, wakeup_data_field_0);
    mbus_write_message32(0xC4, wakeup_data_field_1);
    mbus_write_message32(0xC5, wakeup_data_field_2);
    mbus_write_message32(0xC6, exec_count_irq);
