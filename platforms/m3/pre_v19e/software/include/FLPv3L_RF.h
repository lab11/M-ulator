//************************************************************
// Desciption: FLPv3L Register File Header File
//      Generated by genRF (Version 1.10) 01/29/2018 15:48:58
//************************************************************
...
#define FLPv3L_R00_DEFAULT {{0x09, 0x04, 0x02, 0x1F}}
_Static_assert(sizeof(flpv3l_r00_t) == 4, "Punned Structure Size");

// Register 0x01
typedef union flpv3l_r01{
  struct{
    unsigned Tprog		: 8;
...
#define FLPv3L_R01_DEFAULT {{0x09, 0x007F}}
_Static_assert(sizeof(flpv3l_r01_t) == 4, "Punned Structure Size");

// Register 0x02
typedef union flpv3l_r02{
  struct{
    unsigned Terase		: 16;
  };
  uint32_t as_int;
} flpv3l_r02_t;
#define FLPv3L_R02_DEFAULT {{0x0100}}
_Static_assert(sizeof(flpv3l_r02_t) == 4, "Punned Structure Size");

// Register 0x03
typedef union flpv3l_r03{
  struct{
    unsigned Tben		: 10;
...
#define FLPv3L_R03_DEFAULT {{0x031, 0x03E8}}
_Static_assert(sizeof(flpv3l_r03_t) == 4, "Punned Structure Size");

// Register 0x04
typedef union flpv3l_r04{
  struct{
    unsigned Tsc_en		: 12;
...
#define FLPv3L_R04_DEFAULT {{0x3E8, 0x3E8}}
_Static_assert(sizeof(flpv3l_r04_t) == 4, "Punned Structure Size");

// Register 0x05
typedef union flpv3l_r05{
  struct{
    unsigned Tcap		: 20;
  };
  uint32_t as_int;
} flpv3l_r05_t;
#define FLPv3L_R05_DEFAULT {{0x007CF}}
_Static_assert(sizeof(flpv3l_r05_t) == 4, "Punned Structure Size");

// Register 0x06
typedef union flpv3l_r06{
  struct{
    unsigned Tvref		: 17;
  };
  uint32_t as_int;
} flpv3l_r06_t;
#define FLPv3L_R06_DEFAULT {{0x01F3F}}
_Static_assert(sizeof(flpv3l_r06_t) == 4, "Punned Structure Size");

// Register 0x07
typedef union flpv3l_r07{
  struct{
    unsigned SRAM_START_ADDR		: 13;
  };
  uint32_t as_int;
} flpv3l_r07_t;
#define FLPv3L_R07_DEFAULT {{0x0000}}
_Static_assert(sizeof(flpv3l_r07_t) == 4, "Punned Structure Size");

// Register 0x08
typedef union flpv3l_r08{
  struct{
    unsigned FLSH_START_ADDR		: 18;
  };
  uint32_t as_int;
} flpv3l_r08_t;
#define FLPv3L_R08_DEFAULT {{0x00000}}
_Static_assert(sizeof(flpv3l_r08_t) == 4, "Punned Structure Size");

// Register 0x09
typedef union flpv3l_r09{
  struct{
    unsigned GO		: 1;
    unsigned CMD		: 4;
    unsigned IRQ_EN		: 1;
...
#define FLPv3L_R09_DEFAULT {{0x0, 0x0, 0x0, 0x0000}}
_Static_assert(sizeof(flpv3l_r09_t) == 4, "Punned Structure Size");

// Register 0x0A
typedef union flpv3l_r0A{
  struct{
...
#define FLPv3L_R0A_DEFAULT {{0x0, 0x1, 0x1, 0x1, 0x1}}
_Static_assert(sizeof(flpv3l_r0A_t) == 4, "Punned Structure Size");

// Register 0x0B
// -- EMPTY --

// Register 0x0C
typedef union flpv3l_r0C{
  struct{
...
#define FLPv3L_R0C_DEFAULT {{0x1, 0x0, 0x0}}
_Static_assert(sizeof(flpv3l_r0C_t) == 4, "Punned Structure Size");

// Register 0x0D
typedef union flpv3l_r0D{
  struct{
    unsigned TIMEOUT_EXT		: 20;
  };
  uint32_t as_int;
} flpv3l_r0D_t;
#define FLPv3L_R0D_DEFAULT {{0xFFFFF}}
_Static_assert(sizeof(flpv3l_r0D_t) == 4, "Punned Structure Size");

// Register 0x0E
typedef union flpv3l_r0E{
  struct{
    unsigned SRAM_START_ADDR_EXT		: 13;
  };
  uint32_t as_int;
} flpv3l_r0E_t;
#define FLPv3L_R0E_DEFAULT {{0x0000}}
_Static_assert(sizeof(flpv3l_r0E_t) == 4, "Punned Structure Size");

// Register 0x0F
typedef union flpv3l_r0F{
  struct{
...
#define FLPv3L_R0F_DEFAULT {{0x00, 0x10}}
_Static_assert(sizeof(flpv3l_r0F_t) == 4, "Punned Structure Size");

// Register 0x10
typedef union flpv3l_r10{
  struct{
...
#define FLPv3L_R10_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(flpv3l_r10_t) == 4, "Punned Structure Size");

// Register 0x11
typedef union flpv3l_r11{
  struct{
...
#define FLPv3L_R11_DEFAULT {{0x0, 0x1, 0x1, 0x1, 0x0, 0x1}}
_Static_assert(sizeof(flpv3l_r11_t) == 4, "Punned Structure Size");

// Register 0x12
typedef union flpv3l_r12{
  struct{
...
#define FLPv3L_R12_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(flpv3l_r12_t) == 4, "Punned Structure Size");

// Register 0x13
typedef union flpv3l_r13{
  struct{
...
#define FLPv3L_R13_DEFAULT {{0x0, 0x00000}}
_Static_assert(sizeof(flpv3l_r13_t) == 4, "Punned Structure Size");

// Register 0x14
typedef union flpv3l_r14{
  struct{
...
#define FLPv3L_R14_DEFAULT {{0x1, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(flpv3l_r14_t) == 4, "Punned Structure Size");

// Register 0x15
typedef union flpv3l_r15{
  struct{
    unsigned PP_FLSH_ADDR		: 18;
  };
  uint32_t as_int;
} flpv3l_r15_t;
#define FLPv3L_R15_DEFAULT {{0x00000}}
_Static_assert(sizeof(flpv3l_r15_t) == 4, "Punned Structure Size");

// Register 0x16
typedef union flpv3l_r16{
  struct{
    unsigned PP_LENGTH_STREAMED		: 19;
  };
  uint32_t as_int;
} flpv3l_r16_t;
#define FLPv3L_R16_DEFAULT {{0x00000}}
_Static_assert(sizeof(flpv3l_r16_t) == 4, "Punned Structure Size");

// Register 0x17
typedef union flpv3l_r17{
  struct{
...
#define FLPv3L_R17_DEFAULT {{0x00000, 0x0, 0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(flpv3l_r17_t) == 4, "Punned Structure Size");

// Register 0x18
typedef union flpv3l_r18{
  struct{
...
#define FLPv3L_R18_DEFAULT {{0x1, 0xC}}
_Static_assert(sizeof(flpv3l_r18_t) == 4, "Punned Structure Size");

// Register 0x19
typedef union flpv3l_r19{
  struct{
...
#define FLPv3L_R19_DEFAULT {{0x3, 0x0, 0x8, 0x1}}
_Static_assert(sizeof(flpv3l_r19_t) == 4, "Punned Structure Size");
...
// Register 0x1F
typedef union flpv3l_r1F{
  struct{
    unsigned FORCE_RESETN		: 1;
  };
  uint32_t as_int;
} flpv3l_r1F_t;
#define FLPv3L_R1F_DEFAULT {{0x1}}
_Static_assert(sizeof(flpv3l_r1F_t) == 4, "Punned Structure Size");

// Register 0x20
typedef union flpv3l_r20{
  struct{
    unsigned FLSH_SNT		: 5;
...
#define FLPv3L_R20_DEFAULT {{0x07, 0x04, 0x04}}
_Static_assert(sizeof(flpv3l_r20_t) == 4, "Punned Structure Size");

// Register 0x21
typedef union flpv3l_r21{
  struct{
...
#define FLPv3L_R21_DEFAULT {{0x04, 0x04, 0x04}}
_Static_assert(sizeof(flpv3l_r21_t) == 4, "Punned Structure Size");

// Register 0x22
typedef union flpv3l_r22{
  struct{
...
#define FLPv3L_R22_DEFAULT {{0x07, 0x07}}
_Static_assert(sizeof(flpv3l_r22_t) == 4, "Punned Structure Size");

// Register 0x23
typedef union flpv3l_r23{
  struct{
...
#define FLPv3L_R23_DEFAULT {{0x07, 0x03, 0x03, 0x01}}
_Static_assert(sizeof(flpv3l_r23_t) == 4, "Punned Structure Size");

// Register 0x24
typedef union flpv3l_r24{
  struct{
...
#define FLPv3L_R24_DEFAULT {{0x01, 0x07, 0x07}}
_Static_assert(sizeof(flpv3l_r24_t) == 4, "Punned Structure Size");

// Register 0x25
// -- EMPTY --

// Register 0x26
typedef union flpv3l_r26{
  struct{
...
#define FLPv3L_R26_DEFAULT {{0x8, 0x8, 0x7, 0x7, 0xD}}
_Static_assert(sizeof(flpv3l_r26_t) == 4, "Punned Structure Size");

// Register 0x27
typedef union flpv3l_r27{
  struct{
    unsigned FLSH_SMV		: 6;
...
#define FLPv3L_R27_DEFAULT {{0x08, 0x0F, 0x03, 0x01}}
_Static_assert(sizeof(flpv3l_r27_t) == 4, "Punned Structure Size");

// Register 0x28
typedef union flpv3l_r28{
  struct{
...
#define FLPv3L_R28_DEFAULT {{0x07, 0x07}}
_Static_assert(sizeof(flpv3l_r28_t) == 4, "Punned Structure Size");

// Register 0x29
// -- EMPTY --

// Register 0x2A
typedef union flpv3l_r2A{
  struct{
    unsigned FLSH_SAB		: 6;
  };
  uint32_t as_int;
} flpv3l_r2A_t;
#define FLPv3L_R2A_DEFAULT {{0x02}}
_Static_assert(sizeof(flpv3l_r2A_t) == 4, "Punned Structure Size");
...
#define FLPv3L_R30_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xF0}}
_Static_assert(sizeof(flpv3l_r30_t) == 4, "Punned Structure Size");

// Register 0x31
typedef union flpv3l_r31{
  struct{
...
#define FLPv3L_R31_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x00}}
_Static_assert(sizeof(flpv3l_r31_t) == 4, "Punned Structure Size");

// Register 0x32
typedef union flpv3l_r32{
  struct{
...
#define FLPv3L_R32_DEFAULT {{0x1FFF, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x1}}
_Static_assert(sizeof(flpv3l_r32_t) == 4, "Punned Structure Size");

// Register 0x33
typedef union flpv3l_r33{
  struct{
    unsigned STR_WR_CH1_BUF_OFF		: 13;
  };
  uint32_t as_int;
} flpv3l_r33_t;
#define FLPv3L_R33_DEFAULT {{0x0000}}
_Static_assert(sizeof(flpv3l_r33_t) == 4, "Punned Structure Size");

// Register 0x34
typedef union flpv3l_r34{
  struct{
...
#define FLPv3L_R34_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xF0}}
_Static_assert(sizeof(flpv3l_r34_t) == 4, "Punned Structure Size");

// Register 0x35
typedef union flpv3l_r35{
  struct{
...
#define FLPv3L_R35_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x00}}
_Static_assert(sizeof(flpv3l_r35_t) == 4, "Punned Structure Size");

// Register 0x36
typedef union flpv3l_r36{
  struct{
...
#define FLPv3L_R36_DEFAULT {{0x1FFF, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x1}}
_Static_assert(sizeof(flpv3l_r36_t) == 4, "Punned Structure Size");

// Register 0x37
typedef union flpv3l_r37{
  struct{
    unsigned STR_WR_CH0_BUF_OFF		: 13;
  };
  uint32_t as_int;
} flpv3l_r37_t;
#define FLPv3L_R37_DEFAULT {{0x0000}}
_Static_assert(sizeof(flpv3l_r37_t) == 4, "Punned Structure Size");
...
#define FLPv3L_R3A_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1}}
_Static_assert(sizeof(flpv3l_r3A_t) == 4, "Punned Structure Size");
...
#define FLPv3L_R47_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(flpv3l_r47_t) == 4, "Punned Structure Size");
