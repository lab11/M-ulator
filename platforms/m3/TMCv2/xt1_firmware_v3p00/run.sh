...
sed -i "s/#define __NFC_GPO__ 1/#define __NFC_GPO__ 0/" include/TMCv2.h
sed -i "s/#define __NFC_SCL__ 3/#define __NFC_SCL__ 1/" include/TMCv2.h
sed -i "s/#define __NFC_SDA__ 0/#define __NFC_SDA__ 3/" include/TMCv2.h
make clean_libs
make others
make *_devel
make *_temp
...
make clean_libs
make *_nodevel
sed -i "s/#define __NFC_GPO__ 0/#define __NFC_GPO__ 1/" include/TMCv2.h
sed -i "s/#define __NFC_SCL__ 1/#define __NFC_SCL__ 3/" include/TMCv2.h
sed -i "s/#define __NFC_SDA__ 3/#define __NFC_SDA__ 0/" include/TMCv2.h
make clean_libs
make *_std
echo ">>> *_devel.memmap"
