...
static void stop_timer32_timeout_check(uint32_t code){
	...
	*TIMER32_GO = 0;
	if (wfi_timeout_flag){
		wfi_timeout_flag = 0;
		error_code = code;
		mbus_write_message32(0xA0, error_code);
	}
}
...
void handler_ext_int_timer32(void) { // TIMER32
    ...
    *TIMER32_STAT = 0x0;
	...
	mbus_write_message32(0xB0, 0x00000000);
    }
void handler_ext_int_reg0(void) { // REG0
    *NVIC_ICPR = (0x1 << IRQ_REG0);
    set_halt_until_mbus_tx();
	mbus_write_message32(0xB0, 0x00000001);
}
void handler_ext_int_reg1(void) { // REG1
    *NVIC_ICPR = (0x1 << IRQ_REG1);
    set_halt_until_mbus_tx();
	mbus_write_message32(0xB0, 0x00000002);
}
void handler_ext_int_reg2(void) { // REG2
    *NVIC_ICPR = (0x1 << IRQ_REG2);
    set_halt_until_mbus_tx();
	mbus_write_message32(0xB0, 0x00000003);
}
void handler_ext_int_reg3(void) { // REG3
    *NVIC_ICPR = (0x1 << IRQ_REG3);
    set_halt_until_mbus_tx();
	mbus_write_message32(0xB0, 0x00000004);
}
void handler_ext_int_gocep(void) { // GOCEP
    *NVIC_ICPR = (0x1 << IRQ_GOCEP);
    set_halt_until_mbus_tx();
	mbus_write_message32(0xB0, 0x00000005);
}
...
inline static void pmu_setting_temp_based(){
    ...
    }else if (sht35_cur_temp > 31831){ // 40-50C
		if (pmu_setting_state != PMU_45C){
			pmu_setting_state = PMU_45C;
	        pmu_set_active_clk(0xA,0x1,0x10,0x2/*V1P2*/);
	        pmu_set_sleep_clk(0xA,0x0,0x1,0x1/*V1P2*/);
		}
    }else if (sht35_cur_temp > 28086){ // 30-40C
		if (pmu_setting_state != PMU_35C){
			pmu_setting_state = PMU_35C;
	        pmu_set_active_clk(0xF,0x1,0x10,0x2/*V1P2*/);
			pmu_set_sleep_low();
		}
    }else if (sht35_cur_temp < 24342){ // 10-20C
...
static void radio_power_on(){
    ...
    // Turn on voltage clamp
	mrrv10_r21.MRR_TRX_EN_DIV = 1;
	mrrv10_r21.MRR_TRX_ENb_COMP = 0;
	mrrv10_r21.MRR_TRX_SEL_VCLAMP = 31;
	mbus_remote_register_write(MRR_ADDR,0x21,mrrv10_r21.as_int);

	// New for MRRv10
	mrr_ldo_power_on();

    // Voltage Clamp Comparator
	mrrv10_r21.MRR_TRX_ISOLn_COMP = 1;
	mbus_remote_register_write(MRR_ADDR,0x21,mrrv10_r21.as_int);
...
static void radio_power_off(){
	...
	mrrv10_r21.MRR_TRX_ISOLn_COMP = 0;
	mbus_remote_register_write(MRR_ADDR,0x21,mrrv10_r21.as_int);
	mrrv10_r21.MRR_TRX_EN_DIV = 0;
	mrrv10_r21.MRR_TRX_ENb_COMP = 1;
	mbus_remote_register_write(MRR_ADDR,0x21,mrrv10_r21.as_int);
...
static void turn_sleep_vclamp_on(){

    mrrv10_r21.MRR_TRX_SEL_VCLAMP_SLP = 0;
	mbus_remote_register_write(MRR_ADDR,0x21,mrrv10_r21.as_int);

    mrrv10_r21.MRR_TRX_EN_SLP_VCLAMP = 1;
	mbus_remote_register_write(MRR_ADDR,0x21,mrrv10_r21.as_int);

}

static void turn_sleep_vclamp_off(){
    mrrv10_r21.MRR_TRX_EN_SLP_VCLAMP = 0;
	mbus_remote_register_write(MRR_ADDR,0x21,mrrv10_r21.as_int);
...
static void send_radio_data_mrr_sub1(){
    ...
    // Release reset for vclamp counter
    mrrv10_r21.MRR_TRX_RESETn_RC_CNT = 1;
	mbus_remote_register_write(MRR_ADDR,0x21,mrrv10_r21.as_int);
    ...
    mbus_remote_register_read(MRR_ADDR,0x22,3); // CNT_VALUE_EXT
    set_halt_until_mbus_tx();
    mbus_write_message32(0xC4,*REG3);
//  
//  // Reset vclamp counter
    mrrv10_r21.MRR_TRX_RESETn_RC_CNT = 0;
    mbus_remote_register_write(MRR_ADDR,0x21,mrrv10_r21.as_int);
}
...
static void operation_init(void){
    ...
    prev20_r0B.CLK_GEN_DIV_CORE = 0x2; 
