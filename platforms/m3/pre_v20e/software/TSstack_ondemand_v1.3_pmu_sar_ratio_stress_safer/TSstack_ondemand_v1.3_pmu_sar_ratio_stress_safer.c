...
// System parameters
#define	MBUS_DELAY 400 // Amount of delay between successive messages; 200: 6-7ms
...
static void pmu_set_sar_override(uint32_t val){
    ...
    pmu_reg_write(0x05, //default 12'h000
		...
		| (1 << 12) // Let VDD_CLK always connected to vbat
		| (1 << 11) // Enable override setting [10] (1'h0)
		| (0 << 10) // Have the converter have the periodic reset (1'h0)
		| (1 << 9) // Enable override setting [8] (1'h0)
		| (0 << 8) // Switch input / output power rails for upconversion (1'h0)
		| (1 << 7) // Enable override setting [6:0] (1'h0)
		| (adc_sar_val) 		// Binary converter's conversion ratio (7'h00)
	));
	adc_sar_val = val;
    pmu_reg_write(0x05, //default 12'h000
		( (1 << 13) // Enables override setting [12] (1'b1)
	...
	*NVIC_ISER = (1 << IRQ_WAKEUP) | (1 << IRQ_GOCEP) | (1 << IRQ_TIMER32) | (1 << IRQ_REG0)| (1 << IRQ_REG1)| (1 << IRQ_REG2)| (1 << IRQ_REG3);
    ...
    if(wakeup_data_header == 1){
		...
		*MBCWD_RESET = 1;
		...
		while (1){
			pmu_set_sar_override(50);
			delay(pmu_delay);
			pmu_set_sar_override(52);
			delay(pmu_delay);
			pmu_set_sar_override(57);
			delay(pmu_delay);
			pmu_set_sar_override(50);
			delay(pmu_delay);
			pmu_set_sar_override(57);
		...
		*MBCWD_RESET = 1;
		...
		pmu_reg_write(0x05, //default 12'h000
			...
			| (0 << 8) // Switch input / output power rails for upconversion (1'h0)
			| (1 << 7) // Enable override setting [6:0] (1'h0)
			| (57) 		// Binary converter's conversion ratio (7'h00)
		));

		// Swtich without toggling VDD_CLK
		delay(MBUS_DELAY);
		...
		pmu_reg_write(0x05, //default 12'h000
			...
			| (0 << 8) // Switch input / output power rails for upconversion (1'h0)
			| (1 << 7) // Enable override setting [6:0] (1'h0)
			| (50) 		// Binary converter's conversion ratio (7'h00)
		));
		delay(MBUS_DELAY);
		...
		// Connect VDD_CLK to VBAT & switch
		delay(MBUS_DELAY);
		...
		// Don't override bit 12 & switch
		delay(MBUS_DELAY);
		mbus_write_message32(0xAA,0x7);
		pmu_reg_write(0x05, //default 12'h000
			( (0 << 13) // Enables override setting [12] (1'b1)
			| (0 << 12) // Let VDD_CLK always connected to vbat
			| (1 << 11) // Enable override setting [10] (1'h0)
