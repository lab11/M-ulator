...
//    set_halt_until_mbus_rx();
	...
	*REG_MBUS_WD = 1500000*3; // default: 1500000
	...
	mrrv10_r15.MRR_RAD_FSM_RX_DATA_BITS = 0x0; //Set RX data 1b
...
*/
	...
	mrrv10_r15.MRR_RAD_FSM_RX_HDR_BITS = 0x00;  //Set RX header
	mrrv10_r15.MRR_RAD_FSM_RX_HDR_TH = 0x00;    //Set RX header threshold
	// FIXME: somehow writing value >= 0x10 onto MRR_RAD_FSM_RX_DATA_BITS causes TX to hang
	//mrrv10_r15.MRR_RAD_FSM_RX_DATA_BITS = 0x20; //Set RX data 1b
	//mrrv10_r15.MRR_RAD_FSM_RX_DATA_BITS = 0x10; //Set RX data 1b
	//mrrv10_r15.MRR_RAD_FSM_RX_DATA_BITS = 0x5; //Set RX data 1b
	mbus_remote_register_write(MRR_ADDR,0x15,mrrv10_r15.as_int);
