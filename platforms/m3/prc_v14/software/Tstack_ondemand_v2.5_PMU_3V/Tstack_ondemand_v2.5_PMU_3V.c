...
//			v2.2 3V: Increasing radio packet distance; adding header for data TX
//			v2.3 3V: v2.3 is a harvesting update; skipping for 3V
//			v2.4 3V: During Trig 2, if radio option is on, transmit PMU ADC and count
//				     Radio packet delay is configurable now
//				     Initial trig2 delay removed
//			v2.5:  Chip ID configuration
...
#define TEMP_STORAGE_SIZE 580 // Need to leave about 500 Bytes for stack --> around 120 words
