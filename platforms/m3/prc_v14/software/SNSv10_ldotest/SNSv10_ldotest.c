...
int main() {
    ...
    snsv10_r00.LDO_EN_TSNS_OUT	= 1; // Default: 1
    snsv10_r00.LDO_EN_CDC_OUT	= 1;
    ...
    //snsv10_r01.TSNS_SEL_V1P2 = 1;
    snsv10_r01.TSNS_SEL_LDO = 1;
    //snsv10_r01.TSNS_EN_SENSOR_V1P2 = 0;
    //snsv10_r01.TSNS_EN_SENSOR_LDO = 1;
    snsv10_r01.TSNS_BURST_MODE = 1;
    snsv10_r01.TSNS_CONT_MODE = 1;
    //snsv10_r01.TSNS_EN_IRQ = 0;
