...
typedef union vimv1_r0B{
  struct{
    unsigned R_PMU_IREF_LDOP		: 3;
    unsigned R_PMU_IREF_LDOA_AMP	: 3;
    unsigned R_PMU_IREF_MONIT		: 3;
    unsigned R_PMU_IREF_LDOH		: 3;
  };
  uint32_t as_int;
} vimv1_r0B_t;
#define VIMv1_R0B_DEFAULT {{0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(vimv1_r0B_t) == 4, "Punned Structure Size");

// Register 0x0C
typedef union vimv1_r0C{
  struct{
    unsigned R_PMU_IREF_LDON_AMP	: 3;
    unsigned R_PMU_IREF_VREF		: 3;
    unsigned R_PMU_IREF_TMR		: 3;
    unsigned R_PMU_IREF_PIXBIAS		: 3;
  };
  uint32_t as_int;
} vimv1_r0C_t;
#define VIMv1_R0C_DEFAULT {{0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(vimv1_r0C_t) == 4, "Punned Structure Size");

// Register 0x0D
typedef union vimv1_r0D{
  struct{
    unsigned R_PMU_IREF_PIXCAS		: 3;
    unsigned R_PMU_IREF_ADCBIAS		: 3;
    unsigned R_PMU_IREF_ADCCAS		: 3;
    unsigned R_PMU_IREF_BUF_PIXBIAS	: 3;
  };
  uint32_t as_int;
} vimv1_r0D_t;
#define VIMv1_R0D_DEFAULT {{0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(vimv1_r0D_t) == 4, "Punned Structure Size");

// Register 0x0E
typedef union vimv1_r0E{
  struct{
    unsigned R_PMU_IREF_BUF_ADCBIAS	: 3;
    unsigned R_PMU_IREF_BUF_VCC		: 3;
    unsigned R_PMU_IREF_BUF_TRANS	: 3;
  };
  uint32_t as_int;
} vimv1_r0E_t;
#define VIMv1_R0E_DEFAULT {{0x0, 0x0, 0x0}}
