...
//	*((volatile uint32_t *) 0xA2000008) = 0x1202903;
	...
	*((volatile uint32_t *) 0xA7000004 ) = 0x00000002;	//SSPCR1 ? Slave SyncEnable LookBack
	...
	write_mbus_message(0x14, 0xDEAD );
	write_mbus_message(0x13, *((volatile uint32_t *) 0xA7000000 ));
	delay(1000);
	write_mbus_message(0x13, *((volatile uint32_t *) 0xA7000FE0 ));
	delay(1000);
	write_mbus_message(0x13, *((volatile uint32_t *) 0xA7000FE8 ));
	delay(1000);
	write_mbus_message(0x13, *((volatile uint32_t *) 0xA7000FEC ));
...
/*
	...
	write_mbus_message(0x14, 0xDEAD );
	while (i<8) {
	  *((volatile uint32_t *) 0xA7000008 ) = 0x00000055;	//SSPDR Data register
	  i++;
	}
	*((volatile uint32_t *) 0xA7000004 ) = 0x00000002;	//SSPCR1 ? Slave SyncEnable LookBack
	write_mbus_message(0x14, 0xBEEF );
...
//	*((volatile uint32_t *) 0xA7000008 ) = 0x00000110; //WREN
	*((volatile uint32_t *) 0xA7000008 ) = 0x00000101; //RDSR
	...
	while(1){
		write_mbus_message(0x14, 0xABCD );
		*((volatile uint32_t *) 0xA7000008 ) = 0x00000101; //RDSR
