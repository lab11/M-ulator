...
void mrm_init(uint32_t irq_reg_idx, uint32_t clk_gen_s, uint32_t tpar_30, uint32_t tpar_31, uint32_t tpar_32, uint32_t tpar_33, uint32_t tpar_34, uint32_t tpar_35) {
    ...
    mbus_remote_register_write(MRM_ADDR, 0x31, tpar_31);
    mbus_remote_register_write(MRM_ADDR, 0x32, tpar_32);
    mbus_remote_register_write(MRM_ADDR, 0x33, tpar_33);
    mbus_remote_register_write(MRM_ADDR, 0x34, tpar_34);
    mbus_remote_register_write(MRM_ADDR, 0x35, tpar_35);
