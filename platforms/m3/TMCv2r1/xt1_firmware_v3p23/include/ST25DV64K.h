...
//      Name                                    Addr       Bytes                Description                                                                                                                                                                        
//      -------------------------------------------------------------------------------------------
#define EEPROM_ADDR_USE_LIMIT_TYPE              12     //      1 (           0) 0x00 - No limit.  0xFF - decrement limit, bytes 14, 15 for 16 bit decrement to 0                                                                                                   
#define EEPROM_ADDR_USE_LIMIT_RESERVED          13     //      1 (           0)                                                                                                                                                                                    
#define EEPROM_ADDR_USE_LIMIT_COUNT             14     //      2 (           0)                                                                                                                                                                                    
#define EEPROM_ADDR_PRODUCT_INFO                16     //     14 (            ) Drug Info, Mfg, Batch ID, Exp date                                                                                                                                                 
...
//                                                                                                                                                                                                                                                                 
//      --- Debug Information                                                                                                                                                                                                                                      
#define EEPROM_ADDR_SNT_RESTART_COUNT           112    //      1 (            ) Incrementing whenever snt_restart_timer() is called. Reset upon boot-up. Maxed at 255.                                                                                             
#define EEPROM_ADDR_EID_RESTART_COUNT           113    //      1 (            ) Incrementing whenever eid_restart_timer() is called. Reset upon boot-up. Maxed at 255.                                                                                             
