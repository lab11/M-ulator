...
#define __PMU_TICK_ADC_RESET__  1   // Pulse Width of PMU's ADC_RESET signal (Default: 50)
#define __PMU_TICK_ADC_CLK__    1   // Pulse Width of PMU's ADC_CLK signal (Default: 2)
