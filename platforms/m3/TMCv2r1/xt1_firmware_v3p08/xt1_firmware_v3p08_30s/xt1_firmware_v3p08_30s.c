...
#define WAKEUP_INTERVAL_ACTIVE      60   // *seconds* (Default: 1) Wakeup Interval for XT1_ACTIVE (unit: minutes)
#ifdef USE_SHORT_REFRESH
    #define WAKEUP_INTERVAL_IDLE    30   // *seconds* (Default: 720) Wakeup Interval for XT1_IDLE (unit: minutes)
#else
    #define WAKEUP_INTERVAL_IDLE    30    // *seconds* (Default: 720) Wakeup Interval for XT1_IDLE (unit: minutes)
#endif
