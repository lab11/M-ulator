...
#define FAIL_ID_WTH     7           // SNT Timer Threshold Update (Timeout)
#define FAIL_ID_GEN     8           // Generic/Unknown
...
// Return  : threshold
//              - If the timer gets restarted, it resets the theshold to
//                  threshold = 84000 (i.e., 1 min)
//-------------------------------------------------------------------
