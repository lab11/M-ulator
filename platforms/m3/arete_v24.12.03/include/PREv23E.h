//*******************************************************************
//Author: Yejoong Kim
//Description: PREv23E header file
//*******************************************************************
...
//#define SCTR_REG_CLR_WUP_SOURCE     ((volatile uint32_t *) 0xAFFFF00C) // OBSOLETE
 ...
 *
 * @param   cps_full    3-bit pattern. 
 *                      '1' enables the corresponding COTS switch (full-strength).
 *                      '0' disables the corresponding COTS switch (full-strength).
 *          cps_weak    3-bit pattern. 
 *                      '1' enables the corresponding COTS switch (weak-strength).
 *                      '0' disables the corresponding COTS switch (weak-strength).
 *                      NOTE: Currently, only 0x4 and 0x0 are valid values.
 */
