...
//              - Take average for measurement result TX
...
#define RAD_BIT_DELAY       1      //40      //0x54    //Radio tuning: Delay between bits sent (16 bits / packet)
...
// CDC configurations
#define NUM_SAMPLES         4      //Number of CDC samples to take (only 2^n allowed: 2, 4, 8, 16...)
#define NUM_SAMPLES_2PWR    2      //NUM_SAMPLES = 2^NUM_SAMPLES_2PWR
#define CDC_TIMEOUT         0x6    //Timeout for CDC

// Sleep-Wakeup control
#define WAKEUP_PERIOD_CONT_INIT    5    // Wakeup period for initial portion of continuous pressure sensing
#define WAKEUP_PERIOD_CONT         50   //244  // 213:10min Wakeup period for continous pressure sensing
