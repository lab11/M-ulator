...
//                  - Updated set_xo_timer() to support the new PAD_XO_CLK selections.
//*******************************************************************
...
void set_xo_timer (uint8_t mode, uint32_t timestamp, uint8_t wreq_en, uint8_t irq_en, uint8_t auto_reset, uint8_t sel_pad) {
    ...
    if (sel_pad!=0)    regval0 |= sel_pad; // "2'h0: Tie-Lo, 2'h1: CLK_XO_LP, 2'h2: CLK_XO_HP, 2'h3: CLK_XO_TMR"
