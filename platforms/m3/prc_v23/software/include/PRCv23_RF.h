//************************************************************
// Desciption: PRCv23 Register File Header File
//      Generated by genRF (Version 1.51) 07/19/2022 23:43:59
//************************************************************
...
typedef union prcv23_r00{
  struct{
    unsigned MBUS_R0		: 24;
  };
  uint32_t as_int;
} prcv23_r00_t;
#define PRCv23_R00_DEFAULT {{0x000000}}
#define PRCv23_R00_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(prcv23_r00_t) == 4, "Punned Structure Size");

// Register 0x01 [AMBA:0xA0000004]
typedef union prcv23_r01{
  struct{
    unsigned MBUS_R1		: 24;
  };
  uint32_t as_int;
} prcv23_r01_t;
#define PRCv23_R01_DEFAULT {{0x000000}}
#define PRCv23_R01_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(prcv23_r01_t) == 4, "Punned Structure Size");

// Register 0x02 [AMBA:0xA0000008]
typedef union prcv23_r02{
  struct{
    unsigned MBUS_R2		: 24;
  };
  uint32_t as_int;
} prcv23_r02_t;
#define PRCv23_R02_DEFAULT {{0x000000}}
#define PRCv23_R02_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(prcv23_r02_t) == 4, "Punned Structure Size");

// Register 0x03 [AMBA:0xA000000C]
typedef union prcv23_r03{
  struct{
    unsigned MBUS_R3		: 24;
  };
  uint32_t as_int;
} prcv23_r03_t;
#define PRCv23_R03_DEFAULT {{0x000000}}
#define PRCv23_R03_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(prcv23_r03_t) == 4, "Punned Structure Size");

// Register 0x04 [AMBA:0xA0000010]
typedef union prcv23_r04{
  struct{
    unsigned MBUS_R4		: 24;
  };
  uint32_t as_int;
} prcv23_r04_t;
#define PRCv23_R04_DEFAULT {{0x000000}}
#define PRCv23_R04_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(prcv23_r04_t) == 4, "Punned Structure Size");

// Register 0x05 [AMBA:0xA0000014]
typedef union prcv23_r05{
  struct{
    unsigned MBUS_R5		: 24;
  };
  uint32_t as_int;
} prcv23_r05_t;
#define PRCv23_R05_DEFAULT {{0x000000}}
#define PRCv23_R05_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(prcv23_r05_t) == 4, "Punned Structure Size");

// Register 0x06 [AMBA:0xA0000018]
typedef union prcv23_r06{
  struct{
    unsigned MBUS_R6		: 24;
  };
  uint32_t as_int;
} prcv23_r06_t;
#define PRCv23_R06_DEFAULT {{0x000000}}
#define PRCv23_R06_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(prcv23_r06_t) == 4, "Punned Structure Size");

// Register 0x07 [AMBA:0xA000001C]
typedef union prcv23_r07{
  struct{
    unsigned MBUS_R7		: 24;
  };
  uint32_t as_int;
} prcv23_r07_t;
#define PRCv23_R07_DEFAULT {{0x000000}}
#define PRCv23_R07_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(prcv23_r07_t) == 4, "Punned Structure Size");

// Register 0x08 [AMBA:0xA0000020]
typedef union prcv23_r08{
  struct{
    unsigned GOCEP_CHIP_ID		: 16;
  };
  uint32_t as_int;
} prcv23_r08_t;
#define PRCv23_R08_DEFAULT {{0x0000}}
#define PRCv23_R08_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(prcv23_r08_t) == 4, "Punned Structure Size");

// Register 0x09 [AMBA:0xA0000024]
typedef union prcv23_r09{
  struct{
    unsigned MBUS_NUM_BITS_THRESHOLD		: 20;
  };
  uint32_t as_int;
} prcv23_r09_t;
#define PRCv23_R09_DEFAULT {{0x80008}}
#define PRCv23_R09_DEFAULT_AS_INT 0x080008
_Static_assert(sizeof(prcv23_r09_t) == 4, "Punned Structure Size");

// Register 0x0A [AMBA:0xA0000028]
typedef union prcv23_r0A{
  struct{
    unsigned FLAGS		: 24;
  };
  uint32_t as_int;
} prcv23_r0A_t;
#define PRCv23_R0A_DEFAULT {{0x000000}}
#define PRCv23_R0A_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(prcv23_r0A_t) == 4, "Punned Structure Size");

// Register 0x0B [AMBA:0xA000002C]
typedef union prcv23_r0B{
  struct{
    unsigned GOC_SEL		: 4;
...
#define PRCv23_R0B_DEFAULT {{0x8, 0x0, 0x0, 0x7, 0x1, 0x0, 0x1, 0x2, 0x3, 0x0}}
#define PRCv23_R0B_DEFAULT_AS_INT 0x0D2788
_Static_assert(sizeof(prcv23_r0B_t) == 4, "Punned Structure Size");
...
typedef union prcv23_r0E{
  struct{
    unsigned GOCEP_TIMEOUT		: 24;
  };
  uint32_t as_int;
} prcv23_r0E_t;
#define PRCv23_R0E_DEFAULT {{0x1E8480}}
#define PRCv23_R0E_DEFAULT_AS_INT 0x1E8480
_Static_assert(sizeof(prcv23_r0E_t) == 4, "Punned Structure Size");

// Register 0x0F [AMBA:0xA000003C]
typedef union prcv23_r0F{
  struct{
...
#define PRCv23_R0F_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}}
#define PRCv23_R0F_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(prcv23_r0F_t) == 4, "Punned Structure Size");

// Register 0x10 [AMBA:0xA0000040]
typedef union prcv23_r10{
  struct{
    unsigned RUN_CPU		: 1;
  };
  uint32_t as_int;
} prcv23_r10_t;
#define PRCv23_R10_DEFAULT {{0x0}}
#define PRCv23_R10_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(prcv23_r10_t) == 4, "Punned Structure Size");

// Register 0x11 [AMBA:0xA0000044]
typedef union prcv23_r11{
  struct{
...
#define PRCv23_R11_DEFAULT {{0x000000, 0x0, 0x1}}
#define PRCv23_R11_DEFAULT_AS_INT 0x800000
_Static_assert(sizeof(prcv23_r11_t) == 4, "Punned Structure Size");
...
#define PRCv23_R1B_DEFAULT {{0x1E, 0x0, 0x1, 0x1, 0x0, 0x1}}
#define PRCv23_R1B_DEFAULT_AS_INT 0x0002DE
_Static_assert(sizeof(prcv23_r1B_t) == 4, "Punned Structure Size");

// Register 0x1C [AMBA:0xA0000070]
typedef union prcv23_r1C{
  struct{
...
#define PRCv23_R1C_DEFAULT {{0x0, 0x10, 0x2, 0x00}}
#define PRCv23_R1C_DEFAULT_AS_INT 0x0000A0
_Static_assert(sizeof(prcv23_r1C_t) == 4, "Punned Structure Size");
...
typedef union prcv23_r1F{
  struct{
    unsigned MBUS_WATCHDOG_THRESHOLD		: 24;
  };
  uint32_t as_int;
} prcv23_r1F_t;
#define PRCv23_R1F_DEFAULT {{0x16E360}}
#define PRCv23_R1F_DEFAULT_AS_INT 0x16E360
_Static_assert(sizeof(prcv23_r1F_t) == 4, "Punned Structure Size");
...
#define PRCv23_R29_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xF0}}
#define PRCv23_R29_DEFAULT_AS_INT 0xF00000
_Static_assert(sizeof(prcv23_r29_t) == 4, "Punned Structure Size");

// Register 0x2A [AMBA:0xA00000A8]
typedef union prcv23_r2A{
  struct{
...
#define PRCv23_R2A_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x00}}
#define PRCv23_R2A_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(prcv23_r2A_t) == 4, "Punned Structure Size");

// Register 0x2B [AMBA:0xA00000AC]
typedef union prcv23_r2B{
  struct{
...
#define PRCv23_R2B_DEFAULT {{0x7FF, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1}}
#define PRCv23_R2B_DEFAULT_AS_INT 0x8007FF
_Static_assert(sizeof(prcv23_r2B_t) == 4, "Punned Structure Size");

// Register 0x2C [AMBA:0xA00000B0]
typedef union prcv23_r2C{
  struct{
    unsigned STR_WR_CH1_BUF_OFF		: 11;
  };
  uint32_t as_int;
} prcv23_r2C_t;
#define PRCv23_R2C_DEFAULT {{0x000}}
#define PRCv23_R2C_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(prcv23_r2C_t) == 4, "Punned Structure Size");

// Register 0x2D [AMBA:0xA00000B4]
typedef union prcv23_r2D{
  struct{
...
#define PRCv23_R2D_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xF0}}
#define PRCv23_R2D_DEFAULT_AS_INT 0xF00000
_Static_assert(sizeof(prcv23_r2D_t) == 4, "Punned Structure Size");

// Register 0x2E [AMBA:0xA00000B8]
typedef union prcv23_r2E{
  struct{
...
#define PRCv23_R2E_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x00}}
#define PRCv23_R2E_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(prcv23_r2E_t) == 4, "Punned Structure Size");

// Register 0x2F [AMBA:0xA00000BC]
typedef union prcv23_r2F{
  struct{
...
#define PRCv23_R2F_DEFAULT {{0x7FF, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1}}
#define PRCv23_R2F_DEFAULT_AS_INT 0x8007FF
_Static_assert(sizeof(prcv23_r2F_t) == 4, "Punned Structure Size");

// Register 0x30 [AMBA:0xA00000C0]
typedef union prcv23_r30{
  struct{
    unsigned STR_WR_CH0_BUF_OFF		: 11;
  };
  uint32_t as_int;
} prcv23_r30_t;
#define PRCv23_R30_DEFAULT {{0x000}}
#define PRCv23_R30_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(prcv23_r30_t) == 4, "Punned Structure Size");
...
#define PRCv23_R33_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1}}
#define PRCv23_R33_DEFAULT_AS_INT 0x800000
_Static_assert(sizeof(prcv23_r33_t) == 4, "Punned Structure Size");
...
typedef union prcv23_r3E{
  struct{
    unsigned GOCEP_PASSWORD		: 24;
  };
  uint32_t as_int;
} prcv23_r3E_t;
#define PRCv23_R3E_DEFAULT {{0x000000}}
#define PRCv23_R3E_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(prcv23_r3E_t) == 4, "Punned Structure Size");

// Register 0x3F [AMBA:0xA00000FC]
typedef union prcv23_r3F{
  struct{
    unsigned CHIP_ID		: 24;
  };
  uint32_t as_int;
} prcv23_r3F_t;
#define PRCv23_R3F_DEFAULT {{0x000000}}
#define PRCv23_R3F_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(prcv23_r3F_t) == 4, "Punned Structure Size");

// Register 0x40 [AMBA:0xA0000100]
typedef union prcv23_r40{
  struct{
...
#define PRCv23_R40_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}}
#define PRCv23_R40_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(prcv23_r40_t) == 4, "Punned Structure Size");
