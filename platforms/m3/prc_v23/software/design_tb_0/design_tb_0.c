...
volatile uint32_t do_cycle9  = 0; // Reserved for PRE
volatile uint32_t do_cycle10 = 0; // Reserved for PRE
...
void cycle3 (void) {
    ...
    //----------------------------------------------------------------------------------------------------------    
        ...
        *NVIC_ISER = irq_set;
        ...
        mbus_copy_mem_from_remote_to_any_bulk (FLP_ADDR, 0x00000000, PRC_ADDR, (uint32_t *) mem_rsvd_0, 0);
    ...
    //----------------------------------------------------------------------------------------------------------    
        ...
        *NVIC_ISER = irq_set;
        ...
        mbus_copy_mem_from_remote_to_any_bulk (FLP_ADDR, 0x00000000, PRC_ADDR, (uint32_t *) mem_rsvd_1, 9);
