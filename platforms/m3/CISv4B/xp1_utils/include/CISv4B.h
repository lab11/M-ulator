...
// TIMEOUT CHECK
//-------------------------------------------------------------------
#define FAIL_ID_RDC     1           // Display Update
...
//           For detailed algorithm, see CISv4B.c
...
// Fast I2C
//      If enabled, CIS executes the low-level implementation of the I2C, 
