...
#define EEPROM_ADDR_DISP_REFRESH_INTERVAL   30  //  2       Display Refresh Interval (unit: minute)
...
//#define EEPROM_ADDR_RESERVED              54  //  2       Reserved
#define EEPROM_ADDR_TEMP_CALIB_A            56  //  4       Temperature Calibration Coefficient a
#define EEPROM_ADDR_TEMP_CALIB_B            60  //  4       Temperature Calibration Coefficient b
#define EEPROM_ADDR_SNT_BASE_FREQ           64  //  2       SNT Timer Base Frequency in Hz (integer value only)
#define EEPROM_ADDR_SNT_CALIB_CONFIG        66  //  2       [7]: Calibration Duration (0: 7.5sec, 1: 15sec); [6:5]: XO Frequency (0: 4kHz, 1: 8kHz, 2: 16kHz, 3: 32kHz); [4:3]: Reserved; [2:0]: Max Error allowed (# bit shift from SNT_BASE_FREQ)

//--- EID Configuration
#define EEPROM_ADDR_EID_DURATION_HIGH       68  //  2       EID duration (ECTR_PULSE_WIDTH) for High Temperature
#define EEPROM_ADDR_EID_FE_DURATION_HIGH    70  //  2       EID 'Field Erase' duration (ECTR_PULSE_WIDTH) for High Temperature. '0' makes it skip 'Field Erase'
#define EEPROM_ADDR_EID_HIGH_TEMP_THRESHOLD 72  //  2       Temperature Threshold (Raw Code) to determin HIGH and MID temperature
#define EEPROM_ADDR_EID_DURATION_MID        74  //  2       EID duration (ECTR_PULSE_WIDTH) for Mid Temperature
#define EEPROM_ADDR_EID_FE_DURATION_MID     76  //  2       EID 'Field Erase' duration (ECTR_PULSE_WIDTH) for Mid Temperature. '0' makes it skip 'Field Erase'
#define EEPROM_ADDR_EID_LOW_TEMP_THRESHOLD  78  //  2       Temperature Threshold (Raw Code) to determin MID and LOW temperature
#define EEPROM_ADDR_EID_DURATION_LOW        80  //  2       EID duration (ECTR_PULSE_WIDTH) for Low Temperature
#define EEPROM_ADDR_EID_FE_DURATION_LOW     82  //  2       EID 'Field Erase' duration (ECTR_PULSE_WIDTH) for Low Temperature. '0' makes it skip 'Field Erase'
#define EEPROM_ADDR_EID_CRIT_TEMP_THRESHOLD 84  //  2       Temperature Threshold (Raw Code) below which the system does not perform display refresh
//#define EEPROM_ADDR_RESERVED              86  //  14      Reserved
