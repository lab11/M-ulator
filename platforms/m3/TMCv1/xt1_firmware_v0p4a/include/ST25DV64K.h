...
#define EEPROM_ADDR_EID_RFRSH_INT_HR_HIGH   80  //  1       ( 2    (=2hr)  ) EID Refresh interval for High Temperature (unit: hr). '0' means 'do not refresh'.
...
#define EEPROM_ADDR_EID_RFRSH_INT_HR_MID    86  //  1       ( 4    (=4hr)  ) EID Refresh interval for Mid Temperature (unit: hr). '0' means 'do not refresh'.
...
#define EEPROM_ADDR_EID_RFRSH_INT_HR_LOW    92  //  1       ( 8    (=8hr)  ) EID Refresh interval for Low Temperature (unit: hr). '0' means 'do not refresh'.
