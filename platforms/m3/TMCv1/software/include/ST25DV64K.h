...
#define EEPROM_ADDR_SNT_BASE_FREQ           66  //  2       SNT Timer Base Frequency in Hz (integer value only)
#define EEPROM_ADDR_SNT_CALIB_CONFIG        68  //  1       [7]: Calibration Duration (0: 7.5sec, 1: 15sec); [6:5]: XO Frequency (0: 4kHz, 1: 8kHz, 2: 16kHz, 3: 32kHz); [4:3]: Reserved; [2:0]: Max Error allowed (# bit shift from SNT_BASE_FREQ)
//#define EEPROM_ADDR_RESERVED              69  //  1       Reserved

//--- EID Configuration                                     Recommended Value
#define EEPROM_ADDR_EID_HIGH_TEMP_THRESHOLD 70  //  2       ( 1250 (=20C)  ) Temperature Threshold (Raw Code) to determin HIGH and MID temperature
#define EEPROM_ADDR_EID_LOW_TEMP_THRESHOLD  72  //  2       ( 700  (=10C)  ) Temperature Threshold (Raw Code) to determin MID and LOW temperature
#define EEPROM_ADDR_EID_DURATION_HIGH       74  //  2       ( 30   (=0.25s)) EID duration (ECTR_PULSE_WIDTH) for High Temperature
#define EEPROM_ADDR_EID_FE_DURATION_HIGH    76  //  2       ( 15   (=0.12s)) EID 'Field Erase' duration (ECTR_PULSE_WIDTH) for High Temperature. '0' makes it skip 'Field Erase'
#define EEPROM_ADDR_EID_RFRSH_INT_HR_HIGH   78  //  1       ( 2    (=2hr)  ) EID Refresh interval for High Temperature (unit: hr). '0' makes it skip the refresh.
//#define EEPROM_ADDR_RESERVED              79  //  1       Reserved
#define EEPROM_ADDR_EID_DURATION_MID        80  //  2       ( 250  (=2s)   ) EID duration (ECTR_PULSE_WIDTH) for Mid Temperature
#define EEPROM_ADDR_EID_FE_DURATION_MID     82  //  2       ( 125  (=1s)   ) EID 'Field Erase' duration (ECTR_PULSE_WIDTH) for Mid Temperature. '0' makes it skip 'Field Erase'
#define EEPROM_ADDR_EID_RFRSH_INT_HR_MID    84  //  1       ( 4    (=4hr)  ) EID Refresh interval for Mid Temperature (unit: hr). '0' makes it skip the refresh.
//#define EEPROM_ADDR_RESERVED              85  //  1       Reserved
#define EEPROM_ADDR_EID_DURATION_LOW        86  //  2       ( 500  (=4s)   ) EID duration (ECTR_PULSE_WIDTH) for Low Temperature
#define EEPROM_ADDR_EID_FE_DURATION_LOW     88  //  2       ( 500  (=4s)   ) EID 'Field Erase' duration (ECTR_PULSE_WIDTH) for Low Temperature. '0' makes it skip 'Field Erase'
#define EEPROM_ADDR_EID_RFRSH_INT_HR_LOW    90  //  1       ( 8    (=8hr)  ) EID Refresh interval for Low Temperature (unit: hr). '0' makes it skip the refresh.
//#define EEPROM_ADDR_RESERVED              91  //  1       Reserved

//--- Reserved
//#define EEPROM_ADDR_RESERVED              92  //  8       Reserved
