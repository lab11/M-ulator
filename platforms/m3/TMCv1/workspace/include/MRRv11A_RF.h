...
//  - Prefix mrrv11a is replaced by mrr
//  - Prefix MRRv11A is replaced by MRR
//-------------------------------------------------------------------------------------------
...
#define MRR_R00_DEFAULT {{0x0, 0x08, 0x000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}}
#define MRR_R00_DEFAULT_AS_INT 0x000010
_Static_assert(sizeof(mrr_r00_t) == 4, "Punned Structure Size");

// Register 0x01
typedef union mrr_r01{
  struct{
...
#define MRR_R01_DEFAULT {{0x000, 0x00, 0x00}}
#define MRR_R01_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(mrr_r01_t) == 4, "Punned Structure Size");

// Register 0x02
typedef union mrr_r02{
  struct{
...
#define MRR_R02_DEFAULT {{0x1FFF, 0x1, 0x0, 0x7}}
#define MRR_R02_DEFAULT_AS_INT 0x03BFFF
_Static_assert(sizeof(mrr_r02_t) == 4, "Punned Structure Size");

// Register 0x03
typedef union mrr_r03{
  struct{
...
#define MRR_R03_DEFAULT {{0x0801, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0}}
#define MRR_R03_DEFAULT_AS_INT 0x040801
_Static_assert(sizeof(mrr_r03_t) == 4, "Punned Structure Size");

// Register 0x04
typedef union mrr_r04{
  struct{
...
#define MRR_R04_DEFAULT {{0x0, 0x0, 0x0, 0x1, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4, 0x0}}
#define MRR_R04_DEFAULT_AS_INT 0x008018
_Static_assert(sizeof(mrr_r04_t) == 4, "Punned Structure Size");

// Register 0x05
typedef union mrr_r05{
  struct{
...
#define MRR_R05_DEFAULT {{0xD, 0x1, 0x1, 0x1, 0x0, 0x0, 0x8}}
#define MRR_R05_DEFAULT_AS_INT 0x80015D
_Static_assert(sizeof(mrr_r05_t) == 4, "Punned Structure Size");

// Register 0x06
typedef union mrr_r06{
  struct{
    unsigned RO_PDIFF		: 15;
  };
  uint32_t as_int;
} mrr_r06_t;
#define MRR_R06_DEFAULT {{0x1000}}
#define MRR_R06_DEFAULT_AS_INT 0x001000
_Static_assert(sizeof(mrr_r06_t) == 4, "Punned Structure Size");

// Register 0x07
typedef union mrr_r07{
  struct{
    unsigned RO_MOM		: 7;
    unsigned RO_MIM		: 7;
  };
...
#define MRR_R07_DEFAULT {{0x10, 0x10}}
#define MRR_R07_DEFAULT_AS_INT 0x000810
_Static_assert(sizeof(mrr_r07_t) == 4, "Punned Structure Size");

// Register 0x08
typedef union mrr_r08{
  struct{
    unsigned RO_POLY		: 24;
  };
  uint32_t as_int;
} mrr_r08_t;
#define MRR_R08_DEFAULT {{0x400000}}
#define MRR_R08_DEFAULT_AS_INT 0x400000
_Static_assert(sizeof(mrr_r08_t) == 4, "Punned Structure Size");

// Register 0x09
typedef union mrr_r09{
  struct{
    unsigned MEM_TX_WRITE_ONLY		: 1;
  };
  uint32_t as_int;
} mrr_r09_t;
#define MRR_R09_DEFAULT {{0x0}}
#define MRR_R09_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(mrr_r09_t) == 4, "Punned Structure Size");
...
#define MRR_R10_DEFAULT {{0x50, 0x7AC8}}
#define MRR_R10_DEFAULT_AS_INT 0x7AC850
_Static_assert(sizeof(mrr_r10_t) == 4, "Punned Structure Size");

// Register 0x11
typedef union mrr_r11{
  struct{
...
#define MRR_R11_DEFAULT {{0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0C0}}
#define MRR_R11_DEFAULT_AS_INT 0x00C001
_Static_assert(sizeof(mrr_r11_t) == 4, "Punned Structure Size");

// Register 0x12
typedef union mrr_r12{
  struct{
...
#define MRR_R12_DEFAULT {{0x018, 0x031, 0x0}}
#define MRR_R12_DEFAULT_AS_INT 0x00C418
_Static_assert(sizeof(mrr_r12_t) == 4, "Punned Structure Size");

// Register 0x13
typedef union mrr_r13{
  struct{
    unsigned FSM_TX_C_LEN		: 15;
  };
  uint32_t as_int;
} mrr_r13_t;
#define MRR_R13_DEFAULT {{0x0064}}
#define MRR_R13_DEFAULT_AS_INT 0x000064
_Static_assert(sizeof(mrr_r13_t) == 4, "Punned Structure Size");

// Register 0x14
typedef union mrr_r14{
  struct{
...
#define MRR_R14_DEFAULT {{0x0, 0x0, 0x0000, 0x0, 0x0, 0x0}}
#define MRR_R14_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(mrr_r14_t) == 4, "Punned Structure Size");

// Register 0x15
typedef union mrr_r15{
  struct{
    unsigned FSM_RX_DATA_BITS		: 8;
  };
  uint32_t as_int;
} mrr_r15_t;
#define MRR_R15_DEFAULT {{0x00}}
#define MRR_R15_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(mrr_r15_t) == 4, "Punned Structure Size");

// Register 0x16
typedef union mrr_r16{
  struct{
...
#define MRR_R16_DEFAULT {{0x0, 0x0, 0x0, 0x0}}
#define MRR_R16_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(mrr_r16_t) == 4, "Punned Structure Size");
...
// Register 0x1E
typedef union mrr_r1E{
  struct{
    unsigned FSM_IRQ_REPLY_PACKET		: 24;
  };
  uint32_t as_int;
} mrr_r1E_t;
#define MRR_R1E_DEFAULT {{0x001002}}
#define MRR_R1E_DEFAULT_AS_INT 0x001002
_Static_assert(sizeof(mrr_r1E_t) == 4, "Punned Structure Size");

// Register 0x1F
typedef union mrr_r1F{
  struct{
...
#define MRR_R1F_DEFAULT {{0x3, 0x3, 0x0}}
#define MRR_R1F_DEFAULT_AS_INT 0x00000F
_Static_assert(sizeof(mrr_r1F_t) == 4, "Punned Structure Size");

// Register 0x20
// -- READ-ONLY --

// Register 0x21
typedef union mrr_r21{
  struct{
...
#define MRR_R21_DEFAULT {{0x0, 0x1, 0x0, 0x0, 0x11, 0x1, 0x0, 0x0, 0x0}}
#define MRR_R21_DEFAULT_AS_INT 0x000512
_Static_assert(sizeof(mrr_r21_t) == 4, "Punned Structure Size");

// Register 0x22
// -- READ-ONLY --

// Register 0x23
typedef union mrr_r23{
  struct{
    unsigned TRX_IRQ_REPLY_PACKET		: 24;
  };
  uint32_t as_int;
} mrr_r23_t;
#define MRR_R23_DEFAULT {{0x001003}}
#define MRR_R23_DEFAULT_AS_INT 0x001003
_Static_assert(sizeof(mrr_r23_t) == 4, "Punned Structure Size");
...
#define MRR_R2A_DEFAULT {{0x1, 0x0}}
#define MRR_R2A_DEFAULT_AS_INT 0x000001
_Static_assert(sizeof(mrr_r2A_t) == 4, "Punned Structure Size");

// Register 0x2B
typedef union mrr_r2B{
  struct{
...
#define MRR_R2B_DEFAULT {{0x1, 0x0, 0x0, 0x0}}
#define MRR_R2B_DEFAULT_AS_INT 0x000001
_Static_assert(sizeof(mrr_r2B_t) == 4, "Punned Structure Size");
...
#define MRR_R3D_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xF0}}
#define MRR_R3D_DEFAULT_AS_INT 0xF00000
_Static_assert(sizeof(mrr_r3D_t) == 4, "Punned Structure Size");

// Register 0x3E
typedef union mrr_r3E{
  struct{
...
#define MRR_R3E_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x00}}
#define MRR_R3E_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(mrr_r3E_t) == 4, "Punned Structure Size");

// Register 0x3F
typedef union mrr_r3F{
  struct{
...
#define MRR_R3F_DEFAULT {{0x7, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1}}
#define MRR_R3F_DEFAULT_AS_INT 0x800007
_Static_assert(sizeof(mrr_r3F_t) == 4, "Punned Structure Size");

// Register 0x40
typedef union mrr_r40{
  struct{
    unsigned STR_WR_CH0_BUF_OFF		: 3;
  };
  uint32_t as_int;
} mrr_r40_t;
#define MRR_R40_DEFAULT {{0x0}}
#define MRR_R40_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(mrr_r40_t) == 4, "Punned Structure Size");
...
#define MRR_R43_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1}}
#define MRR_R43_DEFAULT_AS_INT 0x800000
_Static_assert(sizeof(mrr_r43_t) == 4, "Punned Structure Size");
...
#define MRR_R50_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}}
#define MRR_R50_DEFAULT_AS_INT 0x000000
_Static_assert(sizeof(mrr_r50_t) == 4, "Punned Structure Size");
