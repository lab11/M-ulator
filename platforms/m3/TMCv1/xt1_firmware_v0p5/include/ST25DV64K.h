...
#define EEPROM_ADDR_HW_ID                   0   //  4       Hardware ID; 0x00000001
...
#define EEPROM_ADDR_DISPLAY                 16  //  2       Current e-ink display
                                                ...
                                                //                          System wakes up every 1 min and checkes whether there is a valid NFC command at EEPROM_ADDR_CMD.
                                                //                          All segments become white (DISPLAY = 0x00)
                                                //                      - STARTED:
...
#define EEPROM_ADDR_CMD                     32  //  1       Command (REQ/ACK/ERR/CMD)
                                                ...
                                                //                            0x1: START
                                                //                            0x2: STOP
                                                //                            0x3: UPDATE (Debug/Devel Purpose Only)
...
#define EEPROM_ADDR_VBAT_INFO               60  //  2       VBAT + calibration data
...
//----------------------------------------------------
                                                //          Recommended Value          
#define EEPROM_ADDR_ADC_T1                  62  //  2       (         1250 ) Temperature Threshold (Raw Code) for ADC. See the table above.
#define EEPROM_ADDR_ADC_T2                  64  //  2       (         1250 ) Temperature Threshold (Raw Code) for ADC. See the table above.
#define EEPROM_ADDR_ADC_T3                  66  //  2       (         1250 ) Temperature Threshold (Raw Code) for ADC. See the table above.
#define EEPROM_ADDR_ADC_T4                  68  //  2       (         1250 ) Temperature Threshold (Raw Code) for ADC. See the table above.
...
#define EEPROM_ADDR_SNT_CALIB_CONFIG        77  //  1       (          194 ) [7]: Calibration Duration (0: 7.5sec, 1: 15sec); [6:5]: XO Frequency (0: 4kHz, 1: 8kHz, 2: 16kHz, 3: 32kHz); [4:3]: Reserved; [2:0]: Max Error allowed (# bit shift from SNT_BASE_FREQ)
