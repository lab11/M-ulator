...
#define EEPROM_ADDR_EID_HIGH_TEMP_THRESHOLD 80  //  2       ( 850  (=15C)  ) Temperature Threshold (Raw Code) to determine HIGH and MID temperature for EID
#define EEPROM_ADDR_EID_LOW_TEMP_THRESHOLD  82  //  2       ( 300  (=-5C)  ) Temperature Threshold (Raw Code) to determine MID and LOW temperature for EID
