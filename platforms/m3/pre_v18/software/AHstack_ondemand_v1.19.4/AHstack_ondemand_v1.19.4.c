...
static void operation_spi_init(){
	...
	*SPI_SSPCPSR = 0x02;   // Clock Prescale Register
	...
	gpio_write_data_with_mask(adxl_mask,(0<<GPIO_ADXL_EN) | (0<<GPIO_ADXL_INT)); // << Crashes here
	unfreeze_gpio_out();
	unfreeze_spi_out();
}
...
static void operation_init(void){
	...
	*REG_SRAM0_TUNE = prev18_r1C.as_int;
    ...
    enumerated = 0x41481194; // 0x4148 is AH in ascii
    exec_count = 0;
    wakeup_count = 0;
    exec_count_irq = 0;
