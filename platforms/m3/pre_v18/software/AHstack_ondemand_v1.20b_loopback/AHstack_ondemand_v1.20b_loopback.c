...
static void send_radio_data_mrr_sub1(){
	...
	// FIXME: this might need to be fixed for loopback
...
static void operation_init(void){
	...
	*REG_SRAM0_TUNE = prev18_r1C.as_int;
    ...
    enumerated = 0x4148120b; // 0x4148 is AH in ascii
    exec_count = 0;
    wakeup_count = 0;
    exec_count_irq = 0;
...
//    set_halt_until_mbus_rx();
	...
	*REG_MBUS_WD = 1500000*3; // default: 1500000
	...
	// Turn off RX mode
    mrrv7_r03.MRR_TRX_MODE_EN = 1; //Set TRX mode: 0 for TX only, 1 for Loopback
	mbus_remote_register_write(MRR_ADDR,3,mrrv7_r03.as_int);
	...
	*REG_MBUS_WD = 1500000; // default: 1500000
	...
	// Loopback debugging
	mrrv7_r15.MRR_EN_DIG_MONITOR = 1; //1

	mrrv7_r16.MRR_DIG_MONITOR_SEL2 = 0xC; //C
	mbus_remote_register_write(MRR_ADDR,0x15,mrrv7_r15.as_int);
...
*/
    ...
    }else if(wakeup_data_header == 0xA1){
	...
	// Turn on cont mode
		...
		*MBCWD_RESET = 1;
		...
		mrrv7_r00.MRR_TRX_CAP_ANTP_TUNE_COARSE = 0x0;  //ANT CAP 14b unary 805.5 MHz
		mbus_remote_register_write(MRR_ADDR,0x00,mrrv7_r00.as_int);

		mrrv7_r01.MRR_TRX_CAP_ANTN_TUNE_COARSE = 0x0;  //ANT CAP 14b unary 805.5 MHz
		mbus_remote_register_write(MRR_ADDR,0x01,mrrv7_r01.as_int);
		mrrv7_r01.MRR_TRX_CAP_ANTP_TUNE_FINE = 0;  //ANT CAP 14b unary 830.5 MHz
		mrrv7_r01.MRR_TRX_CAP_ANTN_TUNE_FINE = 0; //ANT CAP 14b unary 830.5 MHz
	mbus_remote_register_write(MRR_ADDR,0x01,mrrv7_r01.as_int);
