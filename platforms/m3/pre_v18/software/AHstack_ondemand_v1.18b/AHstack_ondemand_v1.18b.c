...
static void operation_init(void){
    ...
    prev18_r0B.CLK_GEN_RING = 0x0; // Default 0x1
	...
	*REG_SRAM0_TUNE = prev18_r1C.as_int;
    ...
    enumerated = 0x41481180; // 0x4148 is AH in ascii
    exec_count = 0;
    exec_count_irq = 0;
...
*/
	...
	}else if(wakeup_data_header == 0x3F){
		// ADXL debugging trigger
		...
		*REG_CPS = *REG_CPS | 0x2;
		...
		ADXL362_reg_rd(ADXL362_DEVID_AD);
		send_radio_data_mrr(0,0xA0,*REG_CHIP_ID,((0xBB00|read_data_batadc)<<8),*SPI_SSPDR);	
		ADXL362_reg_rd(ADXL362_DEVID_MST);
		send_radio_data_mrr(0,0xA0,*REG_CHIP_ID,((0xBB00|read_data_batadc)<<8),*SPI_SSPDR);	
		ADXL362_reg_rd(ADXL362_PARTID);
		send_radio_data_mrr(0,0xA0,*REG_CHIP_ID,((0xBB00|read_data_batadc)<<8),*SPI_SSPDR);	
		ADXL362_reg_rd(ADXL362_REVID);
		send_radio_data_mrr(1,0xA0,*REG_CHIP_ID,((0xBB00|read_data_batadc)<<8),*SPI_SSPDR);	
