//************************************************************
// Desciption: ADOv5V Register File Header File
//      Generated by genRF (Version 1.2) 06/13/2018 00:24:38
//************************************************************
...
#define ADOv5V_R00_DEFAULT {{0x0, 0x0, 0x2, 0x1, 0x3, 0x3, 0x0, 0x0, 0x0, 0x1, 0x1, 0x3, 0x4}}
_Static_assert(sizeof(adov5v_r00_t) == 4, "Punned Structure Size");

// Register 0x01
typedef union adov5v_r01{
  struct{
...
#define ADOv5V_R01_DEFAULT {{0x0F0, 0x3E8}}
_Static_assert(sizeof(adov5v_r01_t) == 4, "Punned Structure Size");

// Register 0x02
typedef union adov5v_r02{
  struct{
...
#define ADOv5V_R02_DEFAULT {{0x65, 0x01, 0x10, 0x0, 0x0}}
_Static_assert(sizeof(adov5v_r02_t) == 4, "Punned Structure Size");

// Register 0x03
typedef union adov5v_r03{
  struct{
    unsigned DSP_SRAM1_TUNE_RDRSB		: 4;
    unsigned DSP_SRAM1_TUNE_DLY2		: 4;
    unsigned DSP_SRAM1_TUNE_DLY1		: 4;
    unsigned DSP_SRAM0_TUNE_RDRSB		: 4;
    unsigned DSP_SRAM0_TUNE_DLY2		: 4;
    unsigned DSP_SRAM0_TUNE_DLY1		: 4;
  };
  uint32_t as_int;
} adov5v_r03_t;
#define ADOv5V_R03_DEFAULT {{0x0, 0x2, 0x2, 0x0, 0x2, 0x2}}
_Static_assert(sizeof(adov5v_r03_t) == 4, "Punned Structure Size");

// Register 0x04
typedef union adov5v_r04{
  struct{
...
#define ADOv5V_R04_DEFAULT {{0x0040, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0}}
_Static_assert(sizeof(adov5v_r04_t) == 4, "Punned Structure Size");

// Register 0x05
typedef union adov5v_r05{
  struct{
    unsigned DSP_PHS_DATA_IN_FE		: 8;
  };
  uint32_t as_int;
} adov5v_r05_t;
#define ADOv5V_R05_DEFAULT {{0x00}}
_Static_assert(sizeof(adov5v_r05_t) == 4, "Punned Structure Size");

// Register 0x06
typedef union adov5v_r06{
  struct{
    unsigned DSP_PHS_WR_FE		: 1;
  };
  uint32_t as_int;
} adov5v_r06_t;
#define ADOv5V_R06_DEFAULT {{0x0}}
_Static_assert(sizeof(adov5v_r06_t) == 4, "Punned Structure Size");

// Register 0x07
typedef union adov5v_r07{
  struct{
...
#define ADOv5V_R07_DEFAULT {{0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(adov5v_r07_t) == 4, "Punned Structure Size");

// Register 0x08
typedef union adov5v_r08{
  struct{
    unsigned DSP_LUT_WR		: 1;
  };
  uint32_t as_int;
} adov5v_r08_t;
#define ADOv5V_R08_DEFAULT {{0x0}}
_Static_assert(sizeof(adov5v_r08_t) == 4, "Punned Structure Size");

// Register 0x09
typedef union adov5v_r09{
  struct{
    unsigned DSP_TH_DATA_IN		: 16;
  };
  uint32_t as_int;
} adov5v_r09_t;
#define ADOv5V_R09_DEFAULT {{0x0000}}
_Static_assert(sizeof(adov5v_r09_t) == 4, "Punned Structure Size");

// Register 0x0A
typedef union adov5v_r0A{
  struct{
    unsigned DSP_TH_WR		: 1;
  };
  uint32_t as_int;
} adov5v_r0A_t;
#define ADOv5V_R0A_DEFAULT {{0x0}}
_Static_assert(sizeof(adov5v_r0A_t) == 4, "Punned Structure Size");

// Register 0x0B
typedef union adov5v_r0B{
  struct{
...
#define ADOv5V_R0B_DEFAULT {{0x000, 0x0, 0x00, 0x0}}
_Static_assert(sizeof(adov5v_r0B_t) == 4, "Punned Structure Size");

// Register 0x0C
typedef union adov5v_r0C{
  struct{
    unsigned DSP_PHS_WR_FS		: 1;
  };
  uint32_t as_int;
} adov5v_r0C_t;
#define ADOv5V_R0C_DEFAULT {{0x0}}
_Static_assert(sizeof(adov5v_r0C_t) == 4, "Punned Structure Size");

// Register 0x0D
typedef union adov5v_r0D{
  struct{
...
#define ADOv5V_R0D_DEFAULT {{0x1, 0x1, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x1, 0x1, 0x0, 0x1, 0x1, 0x1, 0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(adov5v_r0D_t) == 4, "Punned Structure Size");

// Register 0x0E
typedef union adov5v_r0E{
  struct{
...
#define ADOv5V_R0E_DEFAULT {{0x0, 0x0, 0x0, 0x2, 0x2, 0x0, 0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(adov5v_r0E_t) == 4, "Punned Structure Size");

// Register 0x0F
typedef union adov5v_r0F{
  struct{
    ...
    unsigned VAD_ADC_DLY_SEL		: 3;
    unsigned VAD_ADC_SDLY_SEL		: 2;
  };
  uint32_t as_int;
} adov5v_r0F_t;
#define ADOv5V_R0F_DEFAULT {{0x0, 0x0, 0x0, 0x1, 0x1, 0x0, 0x0, 0x0, 0x3}}
_Static_assert(sizeof(adov5v_r0F_t) == 4, "Punned Structure Size");

// Register 0x10
typedef union adov5v_r10{
  struct{
...
#define ADOv5V_R10_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(adov5v_r10_t) == 4, "Punned Structure Size");

// Register 0x11
typedef union adov5v_r11{
  struct{
...
#define ADOv5V_R11_DEFAULT {{0x9, 0xC, 0xA, 0xC, 0x6, 0x8}}
_Static_assert(sizeof(adov5v_r11_t) == 4, "Punned Structure Size");

// Register 0x12
typedef union adov5v_r12{
  struct{
...
#define ADOv5V_R12_DEFAULT {{0x6, 0x8, 0x4, 0x8, 0x3, 0x8}}
_Static_assert(sizeof(adov5v_r12_t) == 4, "Punned Structure Size");

// Register 0x13
typedef union adov5v_r13{
  struct{
...
#define ADOv5V_R13_DEFAULT {{0x1, 0x1, 0x1, 0x1, 0x1, 0x1, 0x1, 0x1, 0x1, 0x0, 0x0, 0x0, 0x0, 0x1, 0x1, 0x1, 0x1, 0x1, 0x1}}
_Static_assert(sizeof(adov5v_r13_t) == 4, "Punned Structure Size");

// Register 0x14
typedef union adov5v_r14{
  struct{
...
#define ADOv5V_R14_DEFAULT {{0x01, 0x0, 0x00, 0x0, 0x0, 0x0, 0x1, 0x0, 0x3}}
_Static_assert(sizeof(adov5v_r14_t) == 4, "Punned Structure Size");

// Register 0x15
typedef union adov5v_r15{
  struct{
...
#define ADOv5V_R15_DEFAULT {{0x01, 0x0, 0x000, 0x0, 0x3, 0x1, 0x0, 0x1}}
_Static_assert(sizeof(adov5v_r15_t) == 4, "Punned Structure Size");

// Register 0x16
typedef union adov5v_r16{
  struct{
...
#define ADOv5V_R16_DEFAULT {{0x2, 0x5, 0x5, 0x03, 0x5, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(adov5v_r16_t) == 4, "Punned Structure Size");

// Register 0x17
typedef union adov5v_r17{
  struct{
...
#define ADOv5V_R17_DEFAULT {{0x01, 0x01, 0x0, 0x10, 0x0, 0x0, 0x3, 0x0, 0x7}}
_Static_assert(sizeof(adov5v_r17_t) == 4, "Punned Structure Size");

// Register 0x18
typedef union adov5v_r18{
  struct{
...
#define ADOv5V_R18_DEFAULT {{0x08, 0x08, 0x07, 0x07}}
_Static_assert(sizeof(adov5v_r18_t) == 4, "Punned Structure Size");

// Register 0x19
typedef union adov5v_r19{
  struct{
...
#define ADOv5V_R19_DEFAULT {{0x04, 0x04, 0x0, 0x7, 0x0}}
_Static_assert(sizeof(adov5v_r19_t) == 4, "Punned Structure Size");

// Register 0x1A
typedef union adov5v_r1A{
  struct{
...
#define ADOv5V_R1A_DEFAULT {{0x0, 0x3, 0x0, 0x7, 0x0, 0x1F, 0x1, 0x4, 0x4}}
_Static_assert(sizeof(adov5v_r1A_t) == 4, "Punned Structure Size");

// Register 0x1B
typedef union adov5v_r1B{
  struct{
...
#define ADOv5V_R1B_DEFAULT {{0x07, 0x07, 0x0, 0x7, 0x0, 0x7}}
_Static_assert(sizeof(adov5v_r1B_t) == 4, "Punned Structure Size");

// Register 0x1C
typedef union adov5v_r1C{
  struct{
...
#define ADOv5V_R1C_DEFAULT {{0x0, 0x7, 0x0, 0x7, 0x0, 0x7, 0x0}}
_Static_assert(sizeof(adov5v_r1C_t) == 4, "Punned Structure Size");
...
#define ADOv5V_R2F_DEFAULT {{0x00FFF, 0x0, 0x0, 0x0, 0x1}}
_Static_assert(sizeof(adov5v_r2F_t) == 4, "Punned Structure Size");

// Register 0x30
typedef union adov5v_r30{
  struct{
    unsigned STR_WR_CH0_BUF_OFF		: 20;
  };
  uint32_t as_int;
} adov5v_r30_t;
#define ADOv5V_R30_DEFAULT {{0x00000}}
_Static_assert(sizeof(adov5v_r30_t) == 4, "Punned Structure Size");
...
#define ADOv5V_R33_DEFAULT {{0x00000, 0x0, 0x0, 0x0, 0x1}}
_Static_assert(sizeof(adov5v_r33_t) == 4, "Punned Structure Size");
...
#define ADOv5V_R40_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(adov5v_r40_t) == 4, "Punned Structure Size");
