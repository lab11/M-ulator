...
void cycle1 (void) {
    if (do_cycle1 == 1) {
        ...
        if ((get_flag(FLAG_PMU_SUB_1)==0) & (get_flag(FLAG_PMU_SUB_0)==0)) {
            ...
            set_halt_until_mbus_tx();
            PMUv12_REG_CONF.PMU_IRQ_EN = 0x1;
            PMUv12_REG_CONF.PMU_CHECK_WRITE = 0x1;
            mbus_remote_register_write(PMU_ADDR, 0x51, PMUv12_REG_CONF.as_int);
        ...
        // Sub-Test 1: PMU DIN Glitch
            ...
            set_halt_until_mbus_tx();
            PMUv12_REG_CONF.PMU_IRQ_EN = 0x1;
            PMUv12_REG_CONF.PMU_CHECK_WRITE = 0x0;
            mbus_remote_register_write(PMU_ADDR, 0x51, PMUv12_REG_CONF.as_int);
