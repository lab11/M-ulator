...
// const int32_t PMU_TEMP_THRESH[6] = {0x190, 0x258, 0x3E8, 0x7D0, 0xC80, 0x1B58};
// const int32_t PMU_TEMP_THRESH[6] = {0x1FD, 0x34B, 0x546, 0x81A, 0xD65, 0x1838}; // #2
const int32_t PMU_TEMP_THRESH[6] = {0x1DD, 0x312, 0x4DE, 0x772, 0xC2C, 0x16A8}; // #7
//                                        {0, 10, 20, 30, 45, 60}	// FIXME: change these temporary values
