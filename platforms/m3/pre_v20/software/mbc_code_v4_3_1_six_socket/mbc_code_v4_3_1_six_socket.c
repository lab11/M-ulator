...
int main() {
    ...
    *NVIC_ISER = (1 << IRQ_WAKEUP | 1 << IRQ_GOCEP | 1 << IRQ_TIMER32 | 
    ...
    mbus_write_message32(0xC0, goc_state);
...
#define STATE_VERIFY 5
	    ...
	    // mbus_write_message32(0xC1, xot_last_timer_list[STORE_LNT]);
	    // mbus_write_message32(0xC2, xot_timer_list[STORE_LNT]);
	    // mbus_write_message32(0xC3, xot_last_timer_list[STORE_SNT]);
	    // mbus_write_message32(0xC4, xot_timer_list[STORE_SNT]);
	}
