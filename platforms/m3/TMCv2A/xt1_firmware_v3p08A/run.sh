...
# Main Body
make clean
sed -i "s/\/\/#define DEVEL/#define DEVEL/" include/TMCv2A.h
sed -i "s/#define __NFC_GPO__ 1/#define __NFC_GPO__ 0/" include/TMCv2A.h
sed -i "s/#define __NFC_SCL__ 3/#define __NFC_SCL__ 1/" include/TMCv2A.h
sed -i "s/#define __NFC_SDA__ 0/#define __NFC_SDA__ 2/" include/TMCv2A.h
make clean_libs
make others
make *_devel
sed -i "s/#define DEVEL/\/\/#define DEVEL/" include/TMCv2A.h
make clean_libs
make *_nodevel
sed -i "s/#define __NFC_GPO__ 0/#define __NFC_GPO__ 1/" include/TMCv2A.h
sed -i "s/#define __NFC_SCL__ 1/#define __NFC_SCL__ 3/" include/TMCv2A.h
sed -i "s/#define __NFC_SDA__ 2/#define __NFC_SDA__ 0/" include/TMCv2A.h
make clean_libs
make *_std
sed -i "s/11491200/478800/" libs/TMCv2A.c
make clean_libs
make *_std_short
sed -i "s/478800/11491200/" libs/TMCv2A.c
echo ">>> *_devel.memmap"
