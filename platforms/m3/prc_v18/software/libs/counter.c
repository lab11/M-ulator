...
volatile prcv18_r0D_t prcv18_r0D = PRCv18_R0D_DEFAULT;
...
//    prcv18_r0D.SRAM_TUNE_ASO_DLY = 31; // Default 0x0, 5 bits
//    prcv18_r0D.SRAM_TUNE_DECODER_DLY = 15; // Default 0x2, 4 bits
//    prcv18_r0D.SRAM_USE_INVERTER_SA = 1; // Default 0x2, 4 bits
//	*REG_SRAM0_TUNE = prcv18_r0D.as_int;///////////////////////////////////// changed from REG_SRAM_TUNE to REG_SRAM0_TUNE////////////////////////////////////////
...
//    uint32_t wakeup_data_threshold = wakeup_data & 0xFFFFF;
    //wakeup_data = 0x0;
    uint32_t wakeup_data_mode = 1;
    uint32_t wakeup_data_vco = 2; // 1: V1P2, 2: V0P6, 3: V3P6
//    uint32_t wakeup_data_freq = wakeup_data>>20 & 0xF;
    //uint32_t wakeup_data_threshold = 100;
    uint32_t wakeup_data_threshold = 20000;
...
//    mbus_write_message32(0xDD, wakeup_data_vco);
//    mbus_write_message32(0xDD, wakeup_data_threshold);
