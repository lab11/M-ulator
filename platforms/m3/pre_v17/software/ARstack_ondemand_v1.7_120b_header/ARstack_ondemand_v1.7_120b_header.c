...
static void send_radio_data_mrr(uint32_t last_packet, uint32_t radio_data_0, uint32_t radio_data_1, uint32_t radio_data_2){
	...
	// MRR REG_D: reserved for header
	// MRR REG_E: DATA[23:0]
	// MRR REG_F: DATA[47:24]
	// MRR REG_10: DATA[71:48]
    mbus_remote_register_write(MRR_ADDR,0xE,radio_data_0);
    mbus_remote_register_write(MRR_ADDR,0xF,radio_data_1);
    mbus_remote_register_write(MRR_ADDR,0x10,radio_data_2);
...
//    set_halt_until_mbus_rx();
	...
	mbus_remote_register_write(MRR_ADDR,0x0C,0x0);
	mbus_remote_register_write(MRR_ADDR,0x0D,0x7AC800);
