...
//			v1.4: optimizing CLEN, PMU strength
//				  should ADC be disabled or not? parking or not?
//*******************************************************************
#include "PREv17.h"
#include "PREv17_RF.h"
#include "mbus.h"
...
static void mrr_configure_pulse_width_long(){
    ...
    mrrv5_r11.MRR_RAD_FSM_TX_POWERON_LEN = 0; //3bits
...
//    set_halt_until_mbus_rx();
	...
	mrrv5_r03.MRR_DCP_S_OW = 1;  //TX_Decap S (forced charge decaps)
...
*/
		...
		// Current Limter set-up 
		mrrv5_r00.MRR_CL_CTRL = wakeup_data & 0xFFFF; //Set CL 1: unlimited, 8: 30uA, 16: 3uA
		mbus_remote_register_write(MRR_ADDR,0x00,mrrv5_r00.as_int);
