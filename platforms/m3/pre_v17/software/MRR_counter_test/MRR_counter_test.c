	...
	*NVIC_ISER = (1 << IRQ_WAKEUP) | (1 << IRQ_GOCEP) | (1 << IRQ_TIMER32) | (1 << IRQ_REG0)| (1 << IRQ_REG1)| (1 << IRQ_REG2)| (1 << IRQ_REG3);
	...
	// Turn on cont mode
		...
		*MBCWD_RESET = 1;
		...
		// Start counter
		mrrv6_r00.MRR_TRX_DIV_RESETN = 0x1;
		mbus_remote_register_write(MRR_ADDR,0x00,mrrv6_r00.as_int);
		
		mrrv6_r00.MRR_TRX_DIV_EN = 0x1;
		mbus_remote_register_write(MRR_ADDR,0x00,mrrv6_r00.as_int);
		...
		*TIMER32_GO = 0;
		...
		// Read counter value
		mbus_remote_register_read(MRR_ADDR,0x20,1);
		mbus_write_message32(0xAA, *REG1);
		...
		mrrv6_r00.MRR_TRX_DIV_RESETN = 0x0;
		mbus_remote_register_write(MRR_ADDR,0x00,mrrv6_r00.as_int);
		
		mrrv6_r00.MRR_TRX_DIV_EN = 0x0;
		mbus_remote_register_write(MRR_ADDR,0x00,mrrv6_r00.as_int);
