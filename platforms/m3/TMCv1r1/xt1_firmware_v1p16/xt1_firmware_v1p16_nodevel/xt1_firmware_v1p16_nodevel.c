...
// Version 1.16 (no_devel)
//------------------------
#define HARDWARE_ID 0x01005843  // XT1r1 Hardware ID
#define FIRMWARE_ID 0x0110      // [15:8] Integer part, [7:0]: Non-Integer part
//-------------------------------------------------------------------------------------------
// < UPDATE HISTORY >
...
static void operation_init (void) {
    ...
    if (!get_flag(FLAG_ENUMERATED)) {
        ...
        *REG_WUPT_CONFIG = *REG_WUPT_CONFIG & 0xFF3FFFFF; // WUP_ENABLE=0, WUP_WREQ_EN=0
        ...
        ////-------------------------------------------------
        //// New SAR Ratio function testing
        ////-------------------------------------------------
        //uint32_t i;
        //for (i=65; i<164; i++) {
        //    pmu_calc_new_sar_ratio(/*adc_val*/i, /*offset*/0, /*num_cons_meas*/0);
        //}
