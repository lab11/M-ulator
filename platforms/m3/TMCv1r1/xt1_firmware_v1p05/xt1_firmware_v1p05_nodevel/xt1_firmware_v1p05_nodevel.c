...
// Version 1.05 (no_devel)
//------------------------
#define HARDWARE_ID 0x01005843  // XT1r1 Hardware ID
#define FIRMWARE_ID 0x0105      // [15:8] Integer part, [7:0]: Non-Integer part
//-------------------------------------------------------------------------------------------
// < UPDATE HISTORY >
...
// Pre-defined Wakeup Intervals
    ...
    #define WAKEUP_INTERVAL_IDLE    10   // (Default: 1440) Wakeup Interval for XT1_IDLE (unit: minutes)
#else
...
static void snt_operation (uint32_t update_eeprom) {
    ...
    //--- Refresh
        ...
        if (xt1_state == XT1_IDLE) {
            ...
            if (// Display has been updated at a low temperature
...
static void update_system_configs(uint32_t use_default) {
    ...
    if (use_default) {
        ...
        //--- Other Configurations
        eeprom_eid_update_type          =  7;   // (            1 ) Display update type to be used in each temperature zone.
                                                //                  [2] HIGH Temperature - 0: Global Update, 1: Local Update
                                                //                  [1] MID Temperature  - 0: Global Update, 1: Local Update
                                                //                  [0] LOW Temperature  - 0: Global Update, 1: Local Update
