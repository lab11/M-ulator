...
//      ----------------------------------------------------
//                                                                     Default                                                                                                                                                                                     
#define EEPROM_ADDR_ADC_T1                      6      //      2 (           0) Temperature Threshold "10x(T+80)" for ADC. See the table above.                                                                                                                    
#define EEPROM_ADDR_ADC_T2                      8      //      2 (           0) Temperature Threshold "10x(T+80)" for ADC. See the table above.                                                                                                                    
#define EEPROM_ADDR_ADC_T3                      10     //      2 (           0) Temperature Threshold "10x(T+80)" for ADC. See the table above.                                                                                                                    
#define EEPROM_ADDR_ADC_T4                      12     //      2 (           0) Temperature Threshold "10x(T+80)" for ADC. See the table above.                                                                                                                    
...
//      EEPROM_ADDR_RESERVED                                   1                                                                                                                                                                                                   
//                                                                                                                                                                                                                                                                 
//                                                                                                                                                                                                                                                                 
//      --- EID Configuration                                          Default                                                                                                                                                                                     
#define EEPROM_ADDR_EID_HIGH_TEMP_THRESHOLD     22     //      2 (         950) (=15C) Temperature Threshold "10x(T+80)" to determine HIGH and MID temperature for EID                                                                                             
#define EEPROM_ADDR_EID_LOW_TEMP_THRESHOLD      24     //      2 (         750) (=-5C) Temperature Threshold "10x(T+80)" to determine MID and LOW temperature for EID                                                                                              
...
#define EEPROM_ADDR_MISC_CONFIG                 35     //      1 (          21) Misc. System Configuration                                                                                                                                                         
//                                                                              [  7] Reserved
//                                                                              [  6] EID_UPDATE_TYPE_HIGH  - Display Update type to be used in HIGH temperature zone
//                                                                                                              0: Global Update, 1: Local Update
//                                                                              [  5] EID_UPDATE_TYPE_MID   - Display Update type to be used in MID temperature zone
//                                                                                                              0: Global Update, 1: Local Update
//                                                                              [  4] EID_UPDATE_TYPE_LOW   - Display Update type to be used in LOW temperature zone
//                                                                                                              0: Global Update, 1: Local Update
//                                                                              [3:0] PMU_NUM_CONS_MEAS     - Number of consecutive measurements required to change SAR ratio
//                                                                                                              or trigger Low VBAT warning/Crash Handler.
//                                                                                                                                                                                                                                                                 
//      --- Temperature Calibration Coefficients                                                                                                                                                                                                                   
#define EEPROM_ADDR_TEMP_CALIB_A                36     //      4 (    31.63574) Temperature Calibration Coefficient a                                                                                                                                              
#define EEPROM_ADDR_TEMP_CALIB_B                40     //      4 (    5406.431) Temperature Calibration Coefficient b                                                                                                                                              
//                                                                                                                                                                                                                                                                 
//      -------------------------------------------------------------------------------------------
//      START INFO AND USER CONFIGURATION (Byte 48 - 91)
//      -------------------------------------------------------------------------------------------
//                                              Byte         Num                                                                                                                                                                                                   
//      Name                                    Addr       Bytes                Description                                                                                                                                                                        
//      -------------------------------------------------------------------------------------------
...
//                                                                                                                                                                                                                                                                 
//      --- User Commands                                                                                                                                                                                                                                          
#define EEPROM_ADDR_HIGH_TEMP_THRESHOLD         68     //      2 (            ) Threshold for High Temperature "10x(T+80)"                                                                                                                                         
#define EEPROM_ADDR_LOW_TEMP_THRESHOLD          70     //      2 (            ) Threshold for Low Temperature "10x(T+80)"                                                                                                                                          
...
//                                                                                            0x1E: RESET                                                                                                                                                          
//      For GETSEC command:                                                                                                                                                                                                                                        
//          {Byte#95[0], Byte#94[7:0], Byte#93[7:0]} - (17-bit integer) Number of seconds from the last sample
//          Byte#95[6:1] - Last Chunk ID.                                                                                                                                                                                                                          
//                          Chunk#N indicates byte#(Nx256+128) ~ byte#((N+1)x256-128-1), where N=0~31.
//                          The Last Chunk (Chunk#31) size is 128 bytes.
//          Byte#95[7] - Not Used                                                                                                                                                                                                                                  
...
//                                                                                  [0] Make 'Play' black                                                                                                                                                          
//                                                                                                                                                                                                                                                                 
#define EEPROM_ADDR_CHKSUM                      94     //      2 (            ) Checksum                                                                                                                                                                           
//                                                                                                                                                                                                                                                                 
//                                                                                                                                                                                                                                                                 
//      -------------------------------------------------------------------------------------------
//      SYSTEM STATUS (Byte 104 - 127)                                                                                                                                                                                                                             
//      -------------------------------------------------------------------------------------------
//                                              Byte         Num                                                                                                                                                                                                   
//      Name                                    Addr       Bytes                Description                                                                                                                                                                        
//      -------------------------------------------------------------------------------------------
...
//                                                                                  [  5] Valid Samples                                                                                                                                                            
//                                                                                      0x0: It does NOT have a valid sample in Data Section                                                                                                                       
//                                                                                      0x1: It has at least 1 valid sample in Data Section                                                                                                                        
//                                                                                  [  4] Sample Type                                                                                                                                                              
//                                                                                      0x0: Converted & compressed values                                                                                                                                         
//                                                                                      0x1: 16-bit Raw values                                                                                                                                                     
...
#define EEPROM_ADDR_HIGH_SAMPLE_0               110    //      3 (            ) 1st sample number that violates the high threshold                                                                                                                                 
#define EEPROM_ADDR_HIGH_SAMPLE_1               113    //      3 (            ) 2nd sample number that violates the high threshold                                                                                                                                 
#define EEPROM_ADDR_HIGH_SAMPLE_2               116    //      3 (            ) 3rd sample number that violates the high threshold                                                                                                                                 
#define EEPROM_ADDR_LOW_SAMPLE_0                119    //      3 (            ) 1st sample number that violates the low threshold                                                                                                                                  
#define EEPROM_ADDR_LOW_SAMPLE_1                122    //      3 (            ) 2nd sample number that violates the low threshold                                                                                                                                  
#define EEPROM_ADDR_LOW_SAMPLE_2                125    //      3 (            ) 3rd sample number that violates the low threshold                                                                                                                                  
