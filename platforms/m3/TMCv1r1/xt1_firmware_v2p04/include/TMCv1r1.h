...
#define __PMU_ADC_FIXED_HYSTERESIS__    // If enabled, hysteresis in pmu_calc_new_sar_ratio is fixed at 1
#define __PMU_ADC_FIXED_MARGIN__        // If enabled, sel_margin in pmu_calc_new_sar_ratio is set for the 8% margin
...
//                                  0           8%
//                              ---------------------------
//                          [NOTE] If __PMU_ADC_FIXED_MARGIN__ is enabled,
//                                  sel_margin is fixed at 2 (i.e., 7% margin)
...
//                          [NOTE] If __PMU_ADC_FIXED_HYSTERESIS__ is enabled,
//                                  hysteresis is fixed at 1
// Description:
//           Find out a new SAR Ratio based on 
