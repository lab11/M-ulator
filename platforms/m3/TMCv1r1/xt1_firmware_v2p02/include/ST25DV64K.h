...
//                                                                              0xF00D: App writes 0xF00D if all INITILIZATION variables are valid. Once read, firmware writes 0x0 in INIT_STATUS.
//                                                                              0xBEEF: App writes 0xBEEF if all INITILIZATION variables, except TEMP_CALIB_*, are valid. Once read, firmware writes 0x0 in INIT_STATUS.
...
#define EEPROM_ADDR_EID_RFRSH_INT_HR_HIGH       35     //      1 (          12) (=12hr) EID Refresh interval for High Temperature (unit: hr). '0' means 'do not refresh'.
#define EEPROM_ADDR_EID_RFRSH_INT_HR_MID        36     //      1 (          24) (=24hr) EID Refresh interval for Mid Temperature (unit: hr). '0' means 'do not refresh'.
#define EEPROM_ADDR_EID_RFRSH_INT_HR_LOW        37     //      1 (           0) (=none) EID Refresh interval for Low Temperature (unit: hr). '0' means 'do not refresh'.
//
//      --- Other Configuration                                        Default
#define EEPROM_ADDR_MISC_CONFIG                 38     //      1 (           5) Misc. System Configuration
//                                                                              [7:6] Reserved
...
//      Name                                    Addr       Bytes                Description
//      -------------------------------------------------------------------------------------------
#define EEPROM_ADDR_PRODUCT_INFO                12     //     20 (            ) Drug Info, Mfg, Batch ID, Exp date
...
#define EEPROM_ADDR_TEMP_MEAS_START_DELAY       50     //      2 (            ) Temperature Measurement Start Delay (unit: minute). 0 is invalid.
//      EEPROM_ADDR_RESERVED                    52             8
//
//      -------------------------------------------------------------------------------------------
...
//
//                                                                              DEBUG command:
//                                                                                  0x00: Store INIT variables in EEPROM as shown in INITIALIZATION SECTION.
//
//
//
