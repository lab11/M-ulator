...
// Version 1.06 (no_devel)
//------------------------
#define HARDWARE_ID 0x01005843  // XT1r1 Hardware ID
#define FIRMWARE_ID 0x0106      // [15:8] Integer part, [7:0]: Non-Integer part
//-------------------------------------------------------------------------------------------
// < UPDATE HISTORY >
...
static uint32_t calc_system_status_at_stop(void) {
    ...
    uint32_t seconds_since_last_sample = div_int(/*dividend*/snt_delta, /*divisor*/snt_freq)&0x1FFFF;
