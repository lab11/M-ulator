...
#define EEPROM_ADDR_MISC_CONFIG                 35     //      1 (           5) Misc. System Configuration                                                                                                                                                         
//                                                                              [7:6] Reserved
//                                                                              [  5] EID_DISABLE_LOCAL_UPDATE
...
//                                                                              [  4] EID_CRIT_TEMP_THRESHOLD
//                                                                                      Display does not update when temperature is lower than EID_CRIT_TEMP_THRESHOLD
//                                                                                      0x1: -20C
//                                                                                      0x0: -25C
//                                                                              [3:0] PMU_NUM_CONS_MEAS
//                                                                                      Number of consecutive measurements required to change SAR ratio
...
#define EEPROM_ADDR_TEMP_MEAS_INTERVAL          72     //      2 (            ) Temperature Measurement Interval (unit: seconds). 0 is invalid.                                                                                                                     
#define EEPROM_ADDR_TEMP_MEAS_START_DELAY       74     //      2 (            ) Temperature Measurement Start Delay (unit: seconds). 0 is invalid.                                                                                                                  
//                                                                                                                                                                                                                                                                 
//      --- Start Information                                                                                                                                                                                                                                      
