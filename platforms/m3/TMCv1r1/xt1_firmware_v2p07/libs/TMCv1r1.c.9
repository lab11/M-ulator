...
uint32_t pmu_calc_new_sar_ratio_v2(uint32_t adc_val, uint32_t offset, uint32_t sel_margin, uint32_t hysteresis) {
...
void nfc_init(void){
    ...
    //--- Area 1 (Byte 0 ~ 31)
    //      RF READ : Always Allowed
    //      RF WRITE: Allowed only in security session RF_PWD_1
    nfc_i2c_byte_write( /*e2*/1, 
                        /*addr*/    ST25DV_ADDR_RFA1SS, 
                        /*data*/    (0x0 << 4)  //  RFU
                                |   (0x1 << 2)  //  RF_PROTECTION_A1
                                |   (0x1 << 0)  //  PWD_CTRL_A1
                                ,
                        /*nb*/  1
                        );
    nfc_i2c_byte_write( /*e2*/1, 
                        /*addr*/    ST25DV_ADDR_ENDA1,
                        /*data*/    (0x00 << 0), //  ENDA1
                        /*nb*/  1
                        );

    //--- Area 2 (Byte 32 ~ 127)
    //      RF READ : Allowed only in security session RF_PWD_1
    //      RF WRITE: Allowed only in security session RF_PWD_1
    nfc_i2c_byte_write( /*e2*/1, 
                        /*addr*/    ST25DV_ADDR_RFA2SS, 
                        /*data*/    (0x0 << 4)  //  RFU
                                |   (0x2 << 2)  //  RF_PROTECTION_A2
                                |   (0x1 << 0)  //  PWD_CTRL_A2
                                ,
                        /*nb*/  1
                        );
    nfc_i2c_byte_write( /*e2*/1, 
                        /*addr*/    ST25DV_ADDR_ENDA2,
                        /*data*/    (0x03 << 0), //  ENDA2
                        /*nb*/  1
                        );

    //--- Area 3 (Byte 128 ~ 8191)
    //      RF READ : Allowed only in security session RF_PWD_1
    //      RF WRITE: Always Forbidden
    nfc_i2c_byte_write( /*e2*/1, 
                        /*addr*/    ST25DV_ADDR_RFA3SS, 
                        /*data*/    (0x0 << 4)  //  RFU
                                |   (0x3 << 2)  //  RF_PROTECTION_A3
                                |   (0x1 << 0)  //  PWD_CTRL_A3
                                ,
                        /*nb*/  1
                        );
    nfc_i2c_byte_write( /*e2*/1, 
                        /*addr*/    ST25DV_ADDR_ENDA3,
                        /*data*/    (0xFF << 0), //  ENDA3
                        /*nb*/  1
                        );
...
void eid_init(void) {
    ...
    mbus_remote_register_write(EID_ADDR,0x13,
        ...
        mbus_remote_register_write(EID_ADDR,0x17,
                                      ( 1             << 23)  // WCTR_RESETB_CP_C
                                    | ( 0             << 22)  // WCTR_VIN_CP_C
                                    | (~0x018 & 0x7FF << 11)  // WCTR_EN_CP_PD_C
                                    | ( 0x018         <<  0)  // WCTR_EN_CP_CK_C
                                    );
    #endif
}
