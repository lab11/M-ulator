...
//[CISv2] PRE Version Change (PREv20E -> PREv21E)
//-----------------------------------------------
//#include "PREv20.h"
//#include "PREv20_RF.h"
//-->
...
// NOTE: prev20_r* have been renamed to prev21e_r*
// NOTE: PREv20* have been renamed to PREv21E*
//-----------------------------------------------

//[CISv2] PMU Version Change (PMUv11 -> PMUv12)
//-----------------------------------------------
//#include "PMUv7_RF.h"
//-->
#include "PMUv12_RF.h"
// NOTE: PMU Controller state name change (only for reference purpose; does not affect the code itself)
...
//[CISv2] SNT Version Change (SNTv4 -> SNTv5)
//-----------------------------------------------
//#include "SNTv4_RF.h"
//-->
#include "SNTv5_RF.h"
// NOTE: sntv4_r* have been renamed to sntv5_r*
// NOTE: SNTv4* have been renamed to SNTv5*
// NOTE: snt_read_wup_counter() has been updated to use the synchronous reading.
//-----------------------------------------------
  
//[CISv2] MRR Version Change (MRRv10A -> MRRv11A)
//-----------------------------------------------
//#include "MRRv10_RF.h"
//-->
#include "MRRv11A_RF.h"
// NOTE: mrrv10_r* have been renamed to mrrv11a_r*
// NOTE: MRRv10* have been renamed to MRRv11A*
//
// MRR Register Name Changes:
//      REG 0x00
//           MRR_CL_EN -> TRX_CL_EN
//           MRR_CL_CTRL -> TRX_CL_CTRL
//           MRR_TRX_CAP_ANTP_TUNE_COARSE -> TRX_CAP_ANTP_TUNE_COARSE
//      REG 0x01
//           MRR_TRX_CAP_ANTN_TUNE_COARSE -> TRX_CAP_ANTN_TUNE_COARSE
//           MRR_TRX_CAP_ANTN_TUNE_FINE -> TRX_CAP_ANTN_TUNE_FINE
//           MRR_TRX_CAP_ANTP_TUNE_FINE -> TRX_CAP_ANTP_TUNE_FINE
//      REG 0x02
//           MRR_TX_BIAS_TUNE -> TX_BIAS_TUNE
//      REG 0x03
//           MRR_TRX_ISOLATEN -> TRX_ISOLATEN
//           MRR_TRX_MODE_EN -> TRX_MODE_EN
//           MRR_DCP_S_OW -> TRX_DCP_S_OW1, TRX_DCP_S_OW2
//           MRR_DCP_P_OW -> TRX_DCP_P_OW1, TRX_DCP_P_OW2
//      REG 0x10
//           MRR_RAD_FSM_TX_DATA_7 -> Moved to memory mapping
//           (New) FSM_TX_TP_LEN
//           (New) FSM_TX_PASSCODE
//      REG 0x11
//           MRR_RAD_FSM_SLEEP -> FSM_SLEEP
//           MRR_RAD_FSM_EN -> FSM_EN
//           MRR_RAD_FSM_RSTN -> FSM_RESET_B
//           MRR_RAD_FSM_TX_H_LEN -> Deleted
//           MRR_RAD_FSM_TX_D_LEN -> FSM_TX_DATA_BITS
//           MRR_RAD_FSM_CONT_PULSE_MODEb (in REG 0x16) -> FSM_CONT_PULSE_MODE (note the polarity change)
//      REG 0x12
//           MRR_RAD_FSM_TX_PW_LEN -> FSM_TX_PW_LEN
//           MRR_RAD_FSM_TX_PS_LEN -> FSM_TX_PS_LEN
//      REG 0x13
//           MRR_RAD_FSM_TX_C_LEN -> FSM_TX_C_LEN
//           MRR_RAD_FSM_TX_MODE -> Deleted
//      REG 0x14
//           MRR_RAD_FSM_TX_POWERON_LEN -> FSM_TX_POWERON_LEN
//      REG 0x15
//           MRR_RAD_FSM_RX_HDR_BITS -> Deleted
//           MRR_RAD_FSM_RX_HDR_TH -> Deleted
//           MRR_RAD_FSM_RX_DATA_BITS -> FSM_RX_DATA_BITS
//      REG 0x16
//           MRR_RAD_FSM_CONT_PULSE_MODEb -> FSM_CONT_PULSE_MODE (in REG 0x11; note the polarity change)
//      REG 0x1E
//           MRR_RAD_FSM_IRQ_REPLY_PACKET -> FSM_IRQ_REPLY_PACKET
//      REG 0x1F
//           No Change
//      REG 0x21
//           MRR_TRX_ENb_CONT_RC -> TRX_ENb_CONT_RC
//-----------------------------------------------
...
////-->
//#define RADIO_DATA_NUM_WORDS 3 // (Num of 32-bit words) =192-96 (NOTE: In CISv2, you do not include the training bits & passcode bits here)
////-----------------------------------------------
////
////[CISv2] Newly Added
////-----------------------------------------------
//uint32_t mrr_tx_data[RADIO_DATA_NUM_WORDS];    // Can be up to 256 bits (i.e., uint32_t mrr_tx_data[8])
////-----------------------------------------------
//
//
...
//    mbus_copy_mem_from_local_to_remote_stream (0x0, 0xA, (uint32_t *) (0x000 << 2), 255);
//    mbus_copy_mem_from_local_to_remote_stream (0x0, 0xA, (uint32_t *) (0x100 << 2), 255);
//    mbus_copy_mem_from_local_to_remote_stream (0x0, 0xA, (uint32_t *) (0x200 << 2), 255);
//    mbus_copy_mem_from_local_to_remote_stream (0x0, 0xA, (uint32_t *) (0x300 << 2), 255);
//    mbus_copy_mem_from_local_to_remote_stream (0x0, 0xA, (uint32_t *) (0x400 << 2), 255);
//    mbus_copy_mem_from_local_to_remote_stream (0x0, 0xA, (uint32_t *) (0x500 << 2), 255);
//    mbus_copy_mem_from_local_to_remote_stream (0x0, 0xA, (uint32_t *) (0x600 << 2), 255);
//    mbus_copy_mem_from_local_to_remote_stream (0x0, 0xA, (uint32_t *) (0x700 << 2), 255);
//    mbus_copy_mem_from_local_to_remote_stream (0x0, 0xA, (uint32_t *) (0x800 << 2), 255);
//    mbus_copy_mem_from_local_to_remote_stream (0x0, 0xA, (uint32_t *) (0x900 << 2), 255);
//    mbus_copy_mem_from_local_to_remote_stream (0x0, 0xA, (uint32_t *) (0xA00 << 2), 255);
//    mbus_copy_mem_from_local_to_remote_stream (0x0, 0xA, (uint32_t *) (0xB00 << 2), 255);
...
//	mbus_write_message32(0xAF, 0x00000111);

// [NOTE] Only the first iteration runs.. Something wrong with returning from function calls?
//    for (uint32_t i=0; i<65; i++) {
//	    mbus_write_message32(0xAB, (i << 24) | (*((volatile uint32_t *) (0xA0000000 | i)) & 0x00FFFFFF));
//	    mbus_write_message32(0xAB, (i << 24) | (*((volatile uint32_t *) (0xA0000000 | i)) & 0x00FFFFFF));
//    }
    
//	mbus_write_message32(0xAB, (0x00 << 24) | (*((volatile uint32_t *) 0xA0000000) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x01 << 24) | (*((volatile uint32_t *) 0xA0000004) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x02 << 24) | (*((volatile uint32_t *) 0xA0000008) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x03 << 24) | (*((volatile uint32_t *) 0xA000000C) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x04 << 24) | (*((volatile uint32_t *) 0xA0000010) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x05 << 24) | (*((volatile uint32_t *) 0xA0000014) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x06 << 24) | (*((volatile uint32_t *) 0xA0000018) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x07 << 24) | (*((volatile uint32_t *) 0xA000001C) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x08 << 24) | (*((volatile uint32_t *) 0xA0000020) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x09 << 24) | (*((volatile uint32_t *) 0xA0000024) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x0A << 24) | (*((volatile uint32_t *) 0xA0000028) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x0B << 24) | (*((volatile uint32_t *) 0xA000002C) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x0C << 24) | (*((volatile uint32_t *) 0xA0000030) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x0D << 24) | (*((volatile uint32_t *) 0xA0000034) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x0E << 24) | (*((volatile uint32_t *) 0xA0000038) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x0F << 24) | (*((volatile uint32_t *) 0xA000003C) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x10 << 24) | (*((volatile uint32_t *) 0xA0000040) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x11 << 24) | (*((volatile uint32_t *) 0xA0000044) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x12 << 24) | (*((volatile uint32_t *) 0xA0000048) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x13 << 24) | (*((volatile uint32_t *) 0xA000004C) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x14 << 24) | (*((volatile uint32_t *) 0xA0000050) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x15 << 24) | (*((volatile uint32_t *) 0xA0000054) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x16 << 24) | (*((volatile uint32_t *) 0xA0000058) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x17 << 24) | (*((volatile uint32_t *) 0xA000005C) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x18 << 24) | (*((volatile uint32_t *) 0xA0000060) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x19 << 24) | (*((volatile uint32_t *) 0xA0000064) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x1A << 24) | (*((volatile uint32_t *) 0xA0000068) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x1B << 24) | (*((volatile uint32_t *) 0xA000006C) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x1C << 24) | (*((volatile uint32_t *) 0xA0000070) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x1D << 24) | (*((volatile uint32_t *) 0xA0000074) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x1E << 24) | (*((volatile uint32_t *) 0xA0000078) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x1F << 24) | (*((volatile uint32_t *) 0xA000007C) & 0x00FFFFFF));
//
//	mbus_write_message32(0xAB, (0x20 << 24) | (*((volatile uint32_t *) 0xA0000080) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x21 << 24) | (*((volatile uint32_t *) 0xA0000084) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x22 << 24) | (*((volatile uint32_t *) 0xA0000088) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x23 << 24) | (*((volatile uint32_t *) 0xA000008C) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x24 << 24) | (*((volatile uint32_t *) 0xA0000090) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x25 << 24) | (*((volatile uint32_t *) 0xA0000094) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x26 << 24) | (*((volatile uint32_t *) 0xA0000098) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x27 << 24) | (*((volatile uint32_t *) 0xA000009C) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x28 << 24) | (*((volatile uint32_t *) 0xA00000A0) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x29 << 24) | (*((volatile uint32_t *) 0xA00000A4) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x2A << 24) | (*((volatile uint32_t *) 0xA00000A8) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x2B << 24) | (*((volatile uint32_t *) 0xA00000AC) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x2C << 24) | (*((volatile uint32_t *) 0xA00000B0) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x2D << 24) | (*((volatile uint32_t *) 0xA00000B4) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x2E << 24) | (*((volatile uint32_t *) 0xA00000B8) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x2F << 24) | (*((volatile uint32_t *) 0xA00000BC) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x30 << 24) | (*((volatile uint32_t *) 0xA00000C0) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x31 << 24) | (*((volatile uint32_t *) 0xA00000C4) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x32 << 24) | (*((volatile uint32_t *) 0xA00000C8) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x33 << 24) | (*((volatile uint32_t *) 0xA00000CC) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x34 << 24) | (*((volatile uint32_t *) 0xA00000D0) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x35 << 24) | (*((volatile uint32_t *) 0xA00000D4) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x36 << 24) | (*((volatile uint32_t *) 0xA00000D8) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x37 << 24) | (*((volatile uint32_t *) 0xA00000DC) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x38 << 24) | (*((volatile uint32_t *) 0xA00000E0) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x39 << 24) | (*((volatile uint32_t *) 0xA00000E4) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x3A << 24) | (*((volatile uint32_t *) 0xA00000E8) & 0x00FFFFFF));
//	mbus_write_message32(0xAB, (0x3B << 24) | (*((volatile uint32_t *) 0xA00000EC) & 0x00FFFFFF));
...
//
//    //[CISv2] Deleted (its default value is already 2)
//    //-----------------------------------------------
...
//
//    //[CISv2] Deleted (does not need to send the first message twice)
//    //-----------------------------------------------
...
//    //-----------------------------------------------
//
//    //[CISv2] Deleted - we will try the default EN_VSOLAR_SHORT behavior
//    //-----------------------------------------------
//    //pmu_reg_write(0x0E, 
...
//    //[CISv2]
//    //-----------------------------------------------
//	//mrrv11a_r16.MRR_RAD_FSM_CONT_PULSE_MODEb = 1;
...
//
//    //[CISv2] Below description was for SNTv4 in CISv1
//    //-----------------------------------------------
...
//    //[CISv2]
//    //-----------------------------------------------
//    //mbus_remote_register_write(MRR_ADDR,0x0D,radio_data & 0xFFFFFF);
//    //mbus_remote_register_write(MRR_ADDR,0x0E,(*REG_CHIP_ID<<8)|(radio_data>>24));
//    //mbus_remote_register_write(MRR_ADDR,0x0F,(radio_packet_prefix<<20)|(radio_packet_count&0xFFFFF));
...
//    // Four 24-bit data -> Three 32-bit data conversion
...
//    //[CISv2] Below warning was for SNTv4 in CISv1
//    //-----------------------------------------------
...
//    //set_halt_until_mbus_tx();
//    //-->
//    //NOTE: In SNTv5, writing into Register 0x14 triggers a synchronous counter read.
...
//    prev21e_r0B.CLK_GEN_RING = 0x1; // Default 0x1
//    prev21e_r0B.CLK_GEN_DIV_MBC = 0x1; // Default 0x2
//    prev21e_r0B.CLK_GEN_DIV_CORE = 0x2; // Default 0x3
////    prev21e_r0B.GOC_CLK_GEN_SEL_FREQ = 0x5; // Default 0x7
////    prev21e_r0B.GOC_CLK_GEN_SEL_DIV = 0x0; // Default 0x1
////    prev21e_r0B.GOC_SEL = 0xF; // Default 0x8
...
//    //[CISv2] Newly Added
//    //-----------------------------------------------
//	mrrv11a_r02.TX_EN_OW = 0;  // Turn of TX_EN_OW
//    //-----------------------------------------------
//    
...
//    //[CISv2] Deleted
//    //-----------------------------------------------
//	//mrrv11a_r15.MRR_RAD_FSM_RX_HDR_BITS = 0x00;  //Set RX header
//	//mrrv11a_r15.MRR_RAD_FSM_RX_HDR_TH = 0x00;    //Set RX header threshold
//    //-----------------------------------------------
//    
...
//    //[CISv2] Deleted
//    //-----------------------------------------------
//	//mrrv11a_r11.MRR_RAD_FSM_TX_H_LEN = 0; //31-31b header (max)
//    //-----------------------------------------------
//    
//	mrrv11a_r11.FSM_TX_DATA_BITS = RADIO_DATA_NUM_WORDS * 32;
//	mbus_remote_register_write(MRR_ADDR,0x11,mrrv11a_r11.as_int);
//
//    //[CISv2] Deleted
//    //-----------------------------------------------
...
//    mbus_remote_register_write(MRR_ADDR,0x04,mrrv11a_r04.as_int);
//
//    //[CISv2] Deleted (its default value is already 0x1002)
//    //-----------------------------------------------
//	// Mbus return address
...
//    }
//
//	mbus_write_message32(0xAF, 0x00000005);
//
