//************************************************************
// Desciption: PRCv20F Register File Header File
//      Generated by genRF (Version 1.30) 11/01/2019 09:57:25
//************************************************************
...
typedef union prcv20f_r00{
  struct{
    unsigned MBUS_R0		: 24;
  };
  uint32_t as_int;
} prcv20f_r00_t;
#define PRCv20F_R00_DEFAULT {{0x000000}}
_Static_assert(sizeof(prcv20f_r00_t) == 4, "Punned Structure Size");

// Register 0x01 [AMBA:0xA0000004]
typedef union prcv20f_r01{
  struct{
    unsigned MBUS_R1		: 24;
  };
  uint32_t as_int;
} prcv20f_r01_t;
#define PRCv20F_R01_DEFAULT {{0x000000}}
_Static_assert(sizeof(prcv20f_r01_t) == 4, "Punned Structure Size");

// Register 0x02 [AMBA:0xA0000008]
typedef union prcv20f_r02{
  struct{
    unsigned MBUS_R2		: 24;
  };
  uint32_t as_int;
} prcv20f_r02_t;
#define PRCv20F_R02_DEFAULT {{0x000000}}
_Static_assert(sizeof(prcv20f_r02_t) == 4, "Punned Structure Size");

// Register 0x03 [AMBA:0xA000000C]
typedef union prcv20f_r03{
  struct{
    unsigned MBUS_R3		: 24;
  };
  uint32_t as_int;
} prcv20f_r03_t;
#define PRCv20F_R03_DEFAULT {{0x000000}}
_Static_assert(sizeof(prcv20f_r03_t) == 4, "Punned Structure Size");

// Register 0x04 [AMBA:0xA0000010]
typedef union prcv20f_r04{
  struct{
    unsigned MBUS_R4		: 24;
  };
  uint32_t as_int;
} prcv20f_r04_t;
#define PRCv20F_R04_DEFAULT {{0x000000}}
_Static_assert(sizeof(prcv20f_r04_t) == 4, "Punned Structure Size");

// Register 0x05 [AMBA:0xA0000014]
typedef union prcv20f_r05{
  struct{
    unsigned MBUS_R5		: 24;
  };
  uint32_t as_int;
} prcv20f_r05_t;
#define PRCv20F_R05_DEFAULT {{0x000000}}
_Static_assert(sizeof(prcv20f_r05_t) == 4, "Punned Structure Size");

// Register 0x06 [AMBA:0xA0000018]
typedef union prcv20f_r06{
  struct{
    unsigned MBUS_R6		: 24;
  };
  uint32_t as_int;
} prcv20f_r06_t;
#define PRCv20F_R06_DEFAULT {{0x000000}}
_Static_assert(sizeof(prcv20f_r06_t) == 4, "Punned Structure Size");

// Register 0x07 [AMBA:0xA000001C]
typedef union prcv20f_r07{
  struct{
    unsigned MBUS_R7		: 24;
  };
  uint32_t as_int;
} prcv20f_r07_t;
#define PRCv20F_R07_DEFAULT {{0x000000}}
_Static_assert(sizeof(prcv20f_r07_t) == 4, "Punned Structure Size");

// Register 0x08 [AMBA:0xA0000020]
typedef union prcv20f_r08{
  struct{
    unsigned GOCEP_CHIP_ID		: 16;
  };
  uint32_t as_int;
} prcv20f_r08_t;
#define PRCv20F_R08_DEFAULT {{0x0000}}
_Static_assert(sizeof(prcv20f_r08_t) == 4, "Punned Structure Size");

// Register 0x09 [AMBA:0xA0000024]
typedef union prcv20f_r09{
  struct{
    unsigned MBUS_NUM_BITS_THRESHOLD		: 20;
  };
  uint32_t as_int;
} prcv20f_r09_t;
#define PRCv20F_R09_DEFAULT {{0x80008}}
_Static_assert(sizeof(prcv20f_r09_t) == 4, "Punned Structure Size");

// Register 0x0A [AMBA:0xA0000028]
typedef union prcv20f_r0A{
  struct{
    unsigned FLAGS		: 24;
  };
  uint32_t as_int;
} prcv20f_r0A_t;
#define PRCv20F_R0A_DEFAULT {{0x000000}}
_Static_assert(sizeof(prcv20f_r0A_t) == 4, "Punned Structure Size");

// Register 0x0B [AMBA:0xA000002C]
typedef union prcv20f_r0B{
  struct{
...
#define PRCv20F_R0B_DEFAULT {{0x2, 0x1, 0x1, 0x0, 0x1, 0x0, 0x1, 0x2, 0x3, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(prcv20f_r0B_t) == 4, "Punned Structure Size");
...
typedef union prcv20f_r0E{
  struct{
    unsigned GOCEP_TIMEOUT		: 24;
  };
  uint32_t as_int;
} prcv20f_r0E_t;
#define PRCv20F_R0E_DEFAULT {{0x1E8480}}
_Static_assert(sizeof(prcv20f_r0E_t) == 4, "Punned Structure Size");

// Register 0x0F [AMBA:0xA000003C]
typedef union prcv20f_r0F{
  struct{
...
#define PRCv20F_R0F_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(prcv20f_r0F_t) == 4, "Punned Structure Size");

// Register 0x10 [AMBA:0xA0000040]
typedef union prcv20f_r10{
  struct{
    unsigned RUN_CPU		: 1;
  };
  uint32_t as_int;
} prcv20f_r10_t;
#define PRCv20F_R10_DEFAULT {{0x0}}
_Static_assert(sizeof(prcv20f_r10_t) == 4, "Punned Structure Size");

// Register 0x11 [AMBA:0xA0000044]
typedef union prcv20f_r11{
  struct{
...
#define PRCv20F_R11_DEFAULT {{0x000000, 0x0, 0x0}}
_Static_assert(sizeof(prcv20f_r11_t) == 4, "Punned Structure Size");
...
#define PRCv20F_R1B_DEFAULT {{0x0, 0x0}}
_Static_assert(sizeof(prcv20f_r1B_t) == 4, "Punned Structure Size");

// Register 0x1C [AMBA:0xA0000070]
typedef union prcv20f_r1C{
  struct{
...
#define PRCv20F_R1C_DEFAULT {{0x00, 0x00}}
_Static_assert(sizeof(prcv20f_r1C_t) == 4, "Punned Structure Size");

// Register 0x1D [AMBA:0xA0000074]
typedef union prcv20f_r1D{
  struct{
...
#define PRCv20F_R1D_DEFAULT {{0x1, 0x0F, 0x4}}
_Static_assert(sizeof(prcv20f_r1D_t) == 4, "Punned Structure Size");

// Register 0x1E [AMBA:0xA0000078]
// -- READ-ONLY --

// Register 0x1F [AMBA:0xA000007C]
typedef union prcv20f_r1F{
  struct{
    unsigned MBUS_WATCHDOG_THRESHOLD		: 24;
  };
  uint32_t as_int;
} prcv20f_r1F_t;
#define PRCv20F_R1F_DEFAULT {{0x16E360}}
_Static_assert(sizeof(prcv20f_r1F_t) == 4, "Punned Structure Size");
...
#define PRCv20F_R29_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xF0}}
_Static_assert(sizeof(prcv20f_r29_t) == 4, "Punned Structure Size");

// Register 0x2A [AMBA:0xA00000A8]
typedef union prcv20f_r2A{
  struct{
...
#define PRCv20F_R2A_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x00}}
_Static_assert(sizeof(prcv20f_r2A_t) == 4, "Punned Structure Size");

// Register 0x2B [AMBA:0xA00000AC]
typedef union prcv20f_r2B{
  struct{
...
#define PRCv20F_R2B_DEFAULT {{0x1FFF, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1}}
_Static_assert(sizeof(prcv20f_r2B_t) == 4, "Punned Structure Size");

// Register 0x2C [AMBA:0xA00000B0]
typedef union prcv20f_r2C{
  struct{
    unsigned STR_WR_CH1_BUF_OFF		: 13;
  };
  uint32_t as_int;
} prcv20f_r2C_t;
#define PRCv20F_R2C_DEFAULT {{0x0000}}
_Static_assert(sizeof(prcv20f_r2C_t) == 4, "Punned Structure Size");

// Register 0x2D [AMBA:0xA00000B4]
typedef union prcv20f_r2D{
  struct{
...
#define PRCv20F_R2D_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xF0}}
_Static_assert(sizeof(prcv20f_r2D_t) == 4, "Punned Structure Size");

// Register 0x2E [AMBA:0xA00000B8]
typedef union prcv20f_r2E{
  struct{
...
#define PRCv20F_R2E_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x00}}
_Static_assert(sizeof(prcv20f_r2E_t) == 4, "Punned Structure Size");

// Register 0x2F [AMBA:0xA00000BC]
typedef union prcv20f_r2F{
  struct{
...
#define PRCv20F_R2F_DEFAULT {{0x1FFF, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1}}
_Static_assert(sizeof(prcv20f_r2F_t) == 4, "Punned Structure Size");

// Register 0x30 [AMBA:0xA00000C0]
typedef union prcv20f_r30{
  struct{
    unsigned STR_WR_CH0_BUF_OFF		: 13;
  };
  uint32_t as_int;
} prcv20f_r30_t;
#define PRCv20F_R30_DEFAULT {{0x0000}}
_Static_assert(sizeof(prcv20f_r30_t) == 4, "Punned Structure Size");
...
#define PRCv20F_R33_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1}}
_Static_assert(sizeof(prcv20f_r33_t) == 4, "Punned Structure Size");
...
typedef union prcv20f_r3F{
  struct{
    unsigned CHIP_ID		: 24;
  };
  uint32_t as_int;
} prcv20f_r3F_t;
#define PRCv20F_R3F_DEFAULT {{0x000000}}
_Static_assert(sizeof(prcv20f_r3F_t) == 4, "Punned Structure Size");

// Register 0x40 [AMBA:0xA0000100]
typedef union prcv20f_r40{
  struct{
...
#define PRCv20F_R40_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(prcv20f_r40_t) == 4, "Punned Structure Size");
