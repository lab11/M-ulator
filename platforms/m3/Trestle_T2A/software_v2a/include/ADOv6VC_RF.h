//************************************************************
// Desciption: ADOv6VC Register File Header File
//      Generated by genRF (Version 1.22) 06/22/2019 17:20:28
//************************************************************
...
#define ADOv6VC_R00_DEFAULT {{0x0, 0x0, 0x2, 0x1, 0x3, 0x3, 0x0, 0x0, 0x0, 0x1, 0x1, 0x3, 0x4}}
_Static_assert(sizeof(adov6vc_r00_t) == 4, "Punned Structure Size");

// Register 0x01
typedef union adov6vc_r01{
  struct{
...
#define ADOv6VC_R01_DEFAULT {{0x0F0, 0x3E8}}
_Static_assert(sizeof(adov6vc_r01_t) == 4, "Punned Structure Size");

// Register 0x02
typedef union adov6vc_r02{
  struct{
...
#define ADOv6VC_R02_DEFAULT {{0x65, 0x01, 0x10, 0x0, 0x0}}
_Static_assert(sizeof(adov6vc_r02_t) == 4, "Punned Structure Size");

// Register 0x03
typedef union adov6vc_r03{
  struct{
...
#define ADOv6VC_R03_DEFAULT {{0x0, 0x2, 0x10, 0x0, 0x2, 0x10}}
_Static_assert(sizeof(adov6vc_r03_t) == 4, "Punned Structure Size");

// Register 0x04
typedef union adov6vc_r04{
  struct{
...
#define ADOv6VC_R04_DEFAULT {{0x0040, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0}}
_Static_assert(sizeof(adov6vc_r04_t) == 4, "Punned Structure Size");

// Register 0x05
typedef union adov6vc_r05{
  struct{
    unsigned DSP_PHS_DATA_IN_FE		: 8;
  };
  uint32_t as_int;
} adov6vc_r05_t;
#define ADOv6VC_R05_DEFAULT {{0x00}}
_Static_assert(sizeof(adov6vc_r05_t) == 4, "Punned Structure Size");

// Register 0x06
typedef union adov6vc_r06{
  struct{
    unsigned DSP_PHS_WR_FE		: 1;
  };
  uint32_t as_int;
} adov6vc_r06_t;
#define ADOv6VC_R06_DEFAULT {{0x0}}
_Static_assert(sizeof(adov6vc_r06_t) == 4, "Punned Structure Size");

// Register 0x07
typedef union adov6vc_r07{
  struct{
...
#define ADOv6VC_R07_DEFAULT {{0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(adov6vc_r07_t) == 4, "Punned Structure Size");

// Register 0x08
typedef union adov6vc_r08{
  struct{
    unsigned DSP_LUT_WR		: 1;
  };
  uint32_t as_int;
} adov6vc_r08_t;
#define ADOv6VC_R08_DEFAULT {{0x0}}
_Static_assert(sizeof(adov6vc_r08_t) == 4, "Punned Structure Size");

// Register 0x09
typedef union adov6vc_r09{
  struct{
    unsigned DSP_TH_DATA_IN		: 16;
  };
  uint32_t as_int;
} adov6vc_r09_t;
#define ADOv6VC_R09_DEFAULT {{0x0000}}
_Static_assert(sizeof(adov6vc_r09_t) == 4, "Punned Structure Size");

// Register 0x0A
typedef union adov6vc_r0A{
  struct{
    unsigned DSP_TH_WR		: 1;
  };
  uint32_t as_int;
} adov6vc_r0A_t;
#define ADOv6VC_R0A_DEFAULT {{0x0}}
_Static_assert(sizeof(adov6vc_r0A_t) == 4, "Punned Structure Size");

// Register 0x0B
typedef union adov6vc_r0B{
  struct{
...
#define ADOv6VC_R0B_DEFAULT {{0x000, 0x0, 0x00, 0x0}}
_Static_assert(sizeof(adov6vc_r0B_t) == 4, "Punned Structure Size");

// Register 0x0C
typedef union adov6vc_r0C{
  struct{
    unsigned DSP_PHS_WR_FS		: 1;
  };
  uint32_t as_int;
} adov6vc_r0C_t;
#define ADOv6VC_R0C_DEFAULT {{0x0}}
_Static_assert(sizeof(adov6vc_r0C_t) == 4, "Punned Structure Size");

// Register 0x0D
typedef union adov6vc_r0D{
  struct{
...
#define ADOv6VC_R0D_DEFAULT {{0x1, 0x1, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x1, 0x1, 0x0, 0x1, 0x1, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1}}
_Static_assert(sizeof(adov6vc_r0D_t) == 4, "Punned Structure Size");

// Register 0x0E
typedef union adov6vc_r0E{
  struct{
...
#define ADOv6VC_R0E_DEFAULT {{0x0, 0x0, 0x0, 0x2, 0x2, 0x0, 0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(adov6vc_r0E_t) == 4, "Punned Structure Size");

// Register 0x0F
typedef union adov6vc_r0F{
  struct{
...
#define ADOv6VC_R0F_DEFAULT {{0x0, 0x0, 0x0, 0x1, 0x1, 0x0, 0x0}}
_Static_assert(sizeof(adov6vc_r0F_t) == 4, "Punned Structure Size");

// Register 0x10
typedef union adov6vc_r10{
  struct{
...
#define ADOv6VC_R10_DEFAULT {{0x1, 0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(adov6vc_r10_t) == 4, "Punned Structure Size");

// Register 0x11
typedef union adov6vc_r11{
  struct{
...
#define ADOv6VC_R11_DEFAULT {{0x9, 0xC, 0xA, 0xC, 0x6, 0x8}}
_Static_assert(sizeof(adov6vc_r11_t) == 4, "Punned Structure Size");

// Register 0x12
typedef union adov6vc_r12{
  struct{
...
#define ADOv6VC_R12_DEFAULT {{0x6, 0x8, 0x4, 0x8, 0x3, 0x8}}
_Static_assert(sizeof(adov6vc_r12_t) == 4, "Punned Structure Size");

// Register 0x13
typedef union adov6vc_r13{
  struct{
...
#define ADOv6VC_R13_DEFAULT {{0x1, 0x1, 0x1, 0x1, 0x1, 0x1, 0x1, 0x1, 0x1, 0x0, 0x0, 0x0, 0x0, 0x1, 0x1, 0x1, 0x1}}
_Static_assert(sizeof(adov6vc_r13_t) == 4, "Punned Structure Size");

// Register 0x14
typedef union adov6vc_r14{
  struct{
...
#define ADOv6VC_R14_DEFAULT {{0x01, 0x0, 0x00, 0x0, 0x0, 0x0, 0x1, 0x0, 0x3}}
_Static_assert(sizeof(adov6vc_r14_t) == 4, "Punned Structure Size");

// Register 0x15
typedef union adov6vc_r15{
  struct{
...
#define ADOv6VC_R15_DEFAULT {{0x01, 0x0, 0x000, 0x0, 0x3, 0x1, 0x0, 0x1}}
_Static_assert(sizeof(adov6vc_r15_t) == 4, "Punned Structure Size");

// Register 0x16
typedef union adov6vc_r16{
  struct{
...
#define ADOv6VC_R16_DEFAULT {{0x2, 0x5, 0x5, 0x03, 0x5, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(adov6vc_r16_t) == 4, "Punned Structure Size");

// Register 0x17
typedef union adov6vc_r17{
  struct{
...
#define ADOv6VC_R17_DEFAULT {{0x01, 0x01, 0x0, 0x10, 0x0, 0x0, 0x3, 0x0, 0x7}}
_Static_assert(sizeof(adov6vc_r17_t) == 4, "Punned Structure Size");

// Register 0x18
typedef union adov6vc_r18{
  struct{
...
#define ADOv6VC_R18_DEFAULT {{0x08, 0x08, 0x07, 0x07}}
_Static_assert(sizeof(adov6vc_r18_t) == 4, "Punned Structure Size");

// Register 0x19
typedef union adov6vc_r19{
  struct{
...
#define ADOv6VC_R19_DEFAULT {{0x04, 0x04, 0x0, 0x7, 0x0}}
_Static_assert(sizeof(adov6vc_r19_t) == 4, "Punned Structure Size");

// Register 0x1A
typedef union adov6vc_r1A{
  struct{
...
#define ADOv6VC_R1A_DEFAULT {{0x0, 0x3, 0x0, 0x7, 0x0, 0x1F, 0x1, 0x4, 0x4}}
_Static_assert(sizeof(adov6vc_r1A_t) == 4, "Punned Structure Size");

// Register 0x1B
typedef union adov6vc_r1B{
  struct{
...
#define ADOv6VC_R1B_DEFAULT {{0x07, 0x07, 0x0, 0x7, 0x0, 0x7, 0x1}}
_Static_assert(sizeof(adov6vc_r1B_t) == 4, "Punned Structure Size");

// Register 0x1C
typedef union adov6vc_r1C{
  struct{
...
#define ADOv6VC_R1C_DEFAULT {{0x0, 0x7, 0x0, 0x7, 0x0, 0x7, 0x0, 0x5, 0x4}}
_Static_assert(sizeof(adov6vc_r1C_t) == 4, "Punned Structure Size");

// Register 0x1D
typedef union adov6vc_r1D{
  struct{
    unsigned DSM_IN_HP_PGA		: 6;
    unsigned DSM_IN_LP_PGA		: 6;
    unsigned DSM_IN_LNA		: 6;
    unsigned RST_LNA		: 1;
    unsigned V1P2_PG		: 1;
    unsigned CLK_GATE		: 1;
    unsigned HP_F_SEL		: 1;
...
#define ADOv6VC_R1D_DEFAULT {{0x1F, 0x1F, 0x1F, 0x1, 0x1, 0x0, 0x1, 0x1, 0x1}}
_Static_assert(sizeof(adov6vc_r1D_t) == 4, "Punned Structure Size");

// Register 0x1E
typedef union adov6vc_r1E{
  struct{
    unsigned SEL_FREQ_HP_PGA		: 5;
    unsigned SEL_FREQ_LP_PGA		: 4;
    unsigned SEL_FREQ_LNA		: 5;
    unsigned AFE_16K_EN		: 1;
  };
  uint32_t as_int;
} adov6vc_r1E_t;
#define ADOv6VC_R1E_DEFAULT {{0x00, 0x0, 0x00, 0x1}}
_Static_assert(sizeof(adov6vc_r1E_t) == 4, "Punned Structure Size");
...
#define ADOv6VC_R2F_DEFAULT {{0x00FFF, 0x0, 0x0, 0x0, 0x1}}
_Static_assert(sizeof(adov6vc_r2F_t) == 4, "Punned Structure Size");

// Register 0x30
typedef union adov6vc_r30{
  struct{
    unsigned STR_WR_CH0_BUF_OFF		: 20;
  };
  uint32_t as_int;
} adov6vc_r30_t;
#define ADOv6VC_R30_DEFAULT {{0x00000}}
_Static_assert(sizeof(adov6vc_r30_t) == 4, "Punned Structure Size");
...
#define ADOv6VC_R33_DEFAULT {{0x00000, 0x0, 0x0, 0x0, 0x1}}
_Static_assert(sizeof(adov6vc_r33_t) == 4, "Punned Structure Size");
...
#define ADOv6VC_R40_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(adov6vc_r40_t) == 4, "Punned Structure Size");
