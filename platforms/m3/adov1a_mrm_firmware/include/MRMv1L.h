...
//                      Valid Range: [0, 98303]
//      wait_for_irq - If 1, it waits until MRM layer sends out the IRQ message at the end.
//                      If 0, it immediately returns 1 after sending out the GO command (mrm_cmd_go_noirq)
// Description:
...
// Args    : 
//      mrm_prefix  - MRM Short Prefix
//          xadr   - Test Register Address (xadr)
