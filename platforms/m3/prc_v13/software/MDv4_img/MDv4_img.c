...
//Description: 	Code for Image capturing with MDv3 or MDv4
//				Derived from MDv3_img_robust.c
//*******************************************************************
#include "PRCv13.h"
#include "PRCv13_RF.h"
#include "mbus.h"
...
static void initialize_md_reg(){
	...
	mdv3_r3.SEL_VREF = 0; // 0
	mdv3_r3.SEL_VREFP = 7; // 7
	mdv3_r3.SEL_VBN = 3; // 3
	mdv3_r3.SEL_VBP = 3; // 3 
	mdv3_r3.SEL_VB_RAMP = 11; //15
	mdv3_r3.SEL_RAMP = 12; //1
