...
#define TEMP_TIMEOUT_COUNT 2500
...
static void operation_run(void){
	...
	// Start temp measurement
		...
		// Time out
		mbus_write_message32(0xEE, 0xFAFAFAFA);
		temp_sensor_disable();
