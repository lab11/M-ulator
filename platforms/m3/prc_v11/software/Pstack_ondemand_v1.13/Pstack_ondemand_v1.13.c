...
inline static void set_pmu_sleep_clk_low(){
    ...
    *((volatile uint32_t *) 0xA200000C) = 0x8F77094B; // 0x8F77194B: Sleep current 3nA, use GOC x9-15
...
inline static void set_pmu_sleep_clk_default(){
    // PRCv11 Default: 0x8F770049
    *((volatile uint32_t *) 0xA200000C) = 0x8F7709CB; // 0x8F7719CB: Sleep current 4nA w/ Poly2, use GOC x9-15
...
inline static void set_pmu_sleep_clk_high(){
    // PRCv11 Default: 0x8F770049
    *((volatile uint32_t *) 0xA200000C) = 0x8F77086B; // 0x8F77184B: Sleep current 8nA, use GOC x9-15
}
