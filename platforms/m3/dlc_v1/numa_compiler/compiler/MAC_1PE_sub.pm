...
my $PE3_INST = 1;
if (defined $argv[7]) {
  $PE0_INST	= $argv[7] & 0b0001;
  $PE1_INST	= $argv[7] & 0b0010;
  $PE2_INST	= $argv[7] & 0b0100;
  $PE3_INST	= $argv[7] & 0b1000;
}
#
my $PE0_MAC_OFFSET = 1;
my $PE1_MAC_OFFSET = 1;
...
my $PE3_MAC_OFFSET = 1;
if (defined $argv[8]) {
  $PE0_MAC_OFFSET	= $argv[8] & 0b0001;
  $PE1_MAC_OFFSET	= $argv[8] & 0b0010;
  $PE2_MAC_OFFSET	= $argv[8] & 0b0100;
  $PE3_MAC_OFFSET	= $argv[8] & 0b1000;
}
#
my $PE0_MAC_NLI	= 0;
my $PE1_MAC_NLI	= 0;
...
my $PE3_MAC_NLI	= 0;
if (defined $argv[9]) {
  $PE0_MAC_NLI = $argv[9] & 0b0001;
  $PE1_MAC_NLI = $argv[9] & 0b0010;
  $PE2_MAC_NLI = $argv[9] & 0b0100;
  $PE3_MAC_NLI = $argv[9] & 0b1000;
}
#
my $PE0_O_SIGN = 0;
my $PE1_O_SIGN = 0;
...
my $PE3_O_SIGN = 0;
if (defined $argv[10]) {
  $PE0_MAC_NLI = $argv[10] & 0b0001;
  $PE1_MAC_NLI = $argv[10] & 0b0010;
  $PE2_MAC_NLI = $argv[10] & 0b0100;
  $PE3_MAC_NLI = $argv[10] & 0b1000;
}
...
if (defined $argv[11] and defined $argv[12] and defined $argv[13] and defined $artv[14] and defined $argv[15]) {
  $PE0_TO_MEM_START_BASE = $argv[11]; 
...
if (defined $argv[21] and defined $argv[22] and defined $argv[23] and defined $argv[23] and defined $argv[24]) {
  $PE2_TO_MEM_START_BASE = $argv[19]; 
  $PE2_I_MEM_START_BASE = $argv[20]; 
  $PE2_O_MEM_START_BASE = $argv[21]; 
  $PE2_W_MEM_START_BASE = $argv[22]; 
  $PE2_OS_MEM_START_BASE = $argv[23]; 
}
#
...
if (defined $argv[25] and defined $argv[26] and defined $argv[27] and defined $argv[28] and defined $argv[29]) {
  $PE3_TO_MEM_START_BASE = $argv[25]; 
  $PE3_I_MEM_START_BASE = $argv[26]; 
  $PE3_O_MEM_START_BASE = $argv[27]; 
  $PE3_W_MEM_START_BASE = $argv[28]; 
  $PE3_OS_MEM_START_BASE = $argv[29]; 
}
##################
