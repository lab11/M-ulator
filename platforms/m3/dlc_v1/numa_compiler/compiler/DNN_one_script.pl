...
my $MEM_H4B1_START	= $MEM_H4_START + 0*$MEM_H4_LINESpBANK; # 0
my $MEM_H4B2_START	= $MEM_H4_START + 1*$MEM_H4_LINESpBANK; # 1024
my $MEM_H4B3_START	= $MEM_H4_START + 2*$MEM_H4_LINESpBANK; # 2048
my $MEM_H4B4_START	= $MEM_H4_START + 3*$MEM_H4_LINESpBANK; # 3072

my $MEM_H3B1_START	= $MEM_H3_START + 0*$MEM_H3_LINESpBANK; # 4096
...
my $MEM_H2B1_START	= $MEM_H2_START + 0*$MEM_H2_LINESpBANK; # 5120
my $MEM_H2B2_START	= $MEM_H2_START + 1*$MEM_H2_LINESpBANK; # 5248
my $MEM_H2B3_START	= $MEM_H2_START + 2*$MEM_H2_LINESpBANK; # 5376
my $MEM_H2B4_START	= $MEM_H2_START + 3*$MEM_H2_LINESpBANK; # 5504

my $MEM_H1B1_START	= $MEM_H1_START + 0*$MEM_H1_LINESpBANK; # 5632
my $MEM_H1B2_START	= $MEM_H1_START + 1*$MEM_H1_LINESpBANK; # 5664
my $MEM_H1B3_START	= $MEM_H1_START + 2*$MEM_H1_LINESpBANK; # 5696
my $MEM_H1B4_START	= $MEM_H1_START + 3*$MEM_H1_LINESpBANK; # 5728

my $NLI_SEGMENT		= 10;

my @L1_tempout_addr  = ((5696) x 4);  ## L1B3 
my @L1_input_addr  = ((5632) x 4);    ## L1B1 L1B2
my @L1_output_addr = (5504, 5516, 5528, 5540);  ## L2B4
#my @L1_output_addr = (5504, 5507, 5510, 5513); 
my @L1_offset_addr = ((5376) x 4);  ## L2B3
my @L1_weight_addr = ((0) x 4);     ## L4B1

my @L2_tempout_addr  = ((5728) x 4);    ## L1B4
my @L2_input_addr  = ((5504) x 4);      ## L2B4
my @L2_output_addr = (5632, 5644, 5656, 5668); # L1B1 L1B2
#my @L2_output_addr = (5632, 5635, 5638, 5641); 
my @L2_offset_addr = ((5388) x 4);   ## L2B3
my @L2_weight_addr = ((2496) x 4);   ## L4B3

my @L3_tempout_addr  = (5696);  
my @L3_input_addr  = (5632);          ## L1B1 L1B2
my @L3_output_addr = (5504);          ## L2B4
my @L3_offset_addr = (5400);          ## L2B3
my @L3_weight_addr = (4800);          ## L3B2 
##########
## caogao
...
my $INPUT_MEM_FILE = "DNN_INIT_MEM";
################################################################################
################################################################################
## inst0: MACNLI0
print	sprintf("##############################################\n#####MACNLI0\n");
...
my $test_OF0 = join "", $inst, "_test_MEM_0.data";
open ($test_OUT0, ">$test_OF0")
	or die "cannot open < ", $test_OF0, ": $!";
my $test_OF1 = join "", $inst, "_test_MEM_1.data";
open ($test_OUT1, ">$test_OF1")
	or die "cannot open < ", $test_OF1, ": $!";
my $test_OF2 = join "", $inst, "_test_MEM_2.data";
open ($test_OUT2, ">$test_OF2")
	or die "cannot open < ", $test_OF2, ": $!";
my $test_OF3 = join "", $inst, "_test_MEM_3.data";
...
## caogao
printf $output_file sprintf("%d %d %d %d\n", $PE0_MAC_ROW_NUM_ORG + $PE1_MAC_ROW_NUM_ORG + $PE2_MAC_ROW_NUM_ORG + $PE3_MAC_ROW_NUM_ORG, $PE0_I_EXP, $PE0_O_EXP, $PE0_TO_EXP);
for ($i = 0; $i < $MAC_ROW_NUM_ORG; $i++){
  printf $output_file sprintf("%d ", $PE0_DATA_O_NLI[$i]);
}
for ($i = 0; $i < $MAC_ROW_NUM_ORG; $i++){
  printf $output_file sprintf("%d ", $PE1_DATA_O_NLI[$i]);
}
for ($i = 0; $i < $MAC_ROW_NUM_ORG; $i++){
  printf $output_file sprintf("%d ", $PE2_DATA_O_NLI[$i]);
}
for ($i = 0; $i < $MAC_ROW_NUM_ORG; $i++){
  printf $output_file sprintf("%d ", $PE3_DATA_O_NLI[$i]);
}
close ($output_file);
#
#
...
###################
$PE0_I_MEM_START_BASE = $L1_output_addr[3];
$PE0_I_MEM_START  	= $PE0_I_MEM_START_BASE + $PE0_I*(2**13);
$PE0_I_MEM_SIZE 	= $PE0_O_MEM_SIZE;
$PE0_I_PREC		= 0;

$PE1_I_MEM_START_BASE = $L1_output_addr[0];
$PE1_I_MEM_START  	= $PE1_I_MEM_START_BASE + $PE1_I*(2**13);
$PE1_I_MEM_SIZE 	= $PE1_O_MEM_SIZE;
$PE1_I_PREC		= 0;

$PE2_I_MEM_START_BASE = $L1_output_addr[1];
$PE2_I_MEM_START  	= $PE2_I_MEM_START_BASE + $PE2_I*(2**13);
$PE2_I_MEM_SIZE 	= $PE2_O_MEM_SIZE;
$PE2_I_PREC		= 0;

$PE3_I_MEM_START_BASE = $L1_output_addr[2];
$PE3_I_MEM_START  	= $PE3_I_MEM_START_BASE + $PE3_I*(2**13);
$PE3_I_MEM_SIZE 	= $PE3_O_MEM_SIZE;
$PE3_I_PREC		= 0;

$PE0_O_MEM_START_BASE = $L1_output_addr[3];
$PE0_O_MEM_START  	= $PE0_O_MEM_START_BASE + $PE0_O*(2**13);
$PE0_O_MEM_SIZE 	= $PE0_I_MEM_SIZE;
$PE0_O_PREC		= 0;

$PE1_O_MEM_START_BASE = $L1_output_addr[0];
$PE1_O_MEM_START  	= $PE1_O_MEM_START_BASE + $PE1_O*(2**13);
$PE1_O_MEM_SIZE 	= $PE1_I_MEM_SIZE;
$PE1_O_PREC		= 0;

$PE2_O_MEM_START_BASE = $L1_output_addr[1];
$PE2_O_MEM_START  	= $PE2_O_MEM_START_BASE + $PE2_O*(2**13);
$PE2_O_MEM_SIZE 	= $PE2_I_MEM_SIZE;
$PE2_O_PREC		= 0;

$PE3_O_MEM_START_BASE = $L1_output_addr[2];
$PE3_O_MEM_START  	= $PE3_O_MEM_START_BASE + $PE3_O*(2**13);
$PE3_O_MEM_SIZE 	= $PE3_I_MEM_SIZE;
$PE3_O_PREC		= 0;
...
###################
$PE0_I_MEM_START_BASE = $L1_output_addr[2];
$PE0_I_MEM_START  	= $PE0_I_MEM_START_BASE + $PE0_I*(2**13);
$PE0_I_MEM_SIZE 	= $PE0_O_MEM_SIZE;
$PE0_I_PREC		= 0;

$PE1_I_MEM_START_BASE = $L1_output_addr[3];
$PE1_I_MEM_START  	= $PE1_I_MEM_START_BASE + $PE1_I*(2**13);
$PE1_I_MEM_SIZE 	= $PE1_O_MEM_SIZE;
$PE1_I_PREC		= 0;

$PE2_I_MEM_START_BASE = $L1_output_addr[0];
$PE2_I_MEM_START  	= $PE2_I_MEM_START_BASE + $PE2_I*(2**13);
$PE2_I_MEM_SIZE 	= $PE2_O_MEM_SIZE;
$PE2_I_PREC		= 0;

$PE3_I_MEM_START_BASE = $L1_output_addr[1];
$PE3_I_MEM_START  	= $PE3_I_MEM_START_BASE + $PE3_I*(2**13);
$PE3_I_MEM_SIZE 	= $PE3_O_MEM_SIZE;
$PE3_I_PREC		= 0;

$PE0_O_MEM_START_BASE = $L1_output_addr[2];
$PE0_O_MEM_START  	= $PE0_O_MEM_START_BASE + $PE0_O*(2**13);
$PE0_O_MEM_SIZE 	= $PE0_I_MEM_SIZE;
$PE0_O_PREC		= 0;

$PE1_O_MEM_START_BASE = $L1_output_addr[3];
$PE1_O_MEM_START  	= $PE1_O_MEM_START_BASE + $PE1_O*(2**13);
$PE1_O_MEM_SIZE 	= $PE1_I_MEM_SIZE;
$PE1_O_PREC		= 0;

$PE2_O_MEM_START_BASE = $L1_output_addr[0];
$PE2_O_MEM_START  	= $PE2_O_MEM_START_BASE + $PE2_O*(2**13);
$PE2_O_MEM_SIZE 	= $PE2_I_MEM_SIZE;
$PE2_O_PREC		= 0;

$PE3_O_MEM_START_BASE = $L1_output_addr[1];
$PE3_O_MEM_START  	= $PE3_O_MEM_START_BASE + $PE3_O*(2**13);
$PE3_O_MEM_SIZE 	= $PE3_I_MEM_SIZE;
$PE3_O_PREC		= 0;
...
$PE_INST_LD_0	= 0;
$PE_INST_ADDR_0	= 0;
$PE_INST_DATA_0	= "00000000000000000000000000000000";
$PE_INST_SEL_0	= 0;
$PE_INST_LD_1	= 0;
$PE_INST_ADDR_1	= 0;
$PE_INST_DATA_1	= "00000000000000000000000000000000";
$PE_INST_SEL_1	= 0;
$PE_INST_LD_2	= 0;
$PE_INST_ADDR_2	= 0;
$PE_INST_DATA_2	= "00000000000000000000000000000000";
$PE_INST_SEL_2	= 0;
$PE_INST_LD_3	= 0;
$PE_INST_ADDR_3	= 0;
$PE_INST_DATA_3	= "00000000000000000000000000000000";
$PE_INST_SEL_3	= 0;
...
# MEM_* INITIALIZATION
#
#if (not defined $ARGV[x]) {
#if (1) {    ## not using this feature here
#  for($i=0; $i<$MEM_OUT_BOUND; $i++){
#  	$PE0_MEM_LINES[$i] = "xxxxxxxxxxxxxxxxxxxxxxxx\n";
#  	$PE1_MEM_LINES[$i] = "xxxxxxxxxxxxxxxxxxxxxxxx\n";
#  	$PE2_MEM_LINES[$i] = "xxxxxxxxxxxxxxxxxxxxxxxx\n";
...
# MAC I/W/OS DATA WRITING INTO MEMORY
#
# debug purpose: this should be the same as MOV0_2 result
$test_OF0 = join "", $inst, "_test_MEM_0.data";
open ($test_OUT0, ">$test_OF0")
	or die "cannot open < ", $test_OF0, ": $!";
$test_OF1 = join "", $inst, "_test_MEM_1.data";
open ($test_OUT1, ">$test_OF1")
	or die "cannot open < ", $test_OF1, ": $!";
$test_OF2 = join "", $inst, "_test_MEM_2.data";
open ($test_OUT2, ">$test_OF2")
	or die "cannot open < ", $test_OF2, ": $!";
$test_OF3 = join "", $inst, "_test_MEM_3.data";
open ($test_OUT3, ">$test_OF3")
	or die "cannot open < ", $test_OF3, ": $!";
...
###################
$PE0_I_MEM_START_BASE = $L2_output_addr[0];
$PE0_I_MEM_START  	= $PE0_I_MEM_START_BASE + $PE0_I*(2**13);
$PE0_I_MEM_SIZE 	= $PE0_O_MEM_SIZE;
$PE0_I_PREC		= 0;

$PE1_I_MEM_START_BASE = $L2_output_addr[1];
$PE1_I_MEM_START  	= $PE1_I_MEM_START_BASE + $PE1_I*(2**13);
$PE1_I_MEM_SIZE 	= $PE1_O_MEM_SIZE;
$PE1_I_PREC		= 0;

$PE2_I_MEM_START_BASE = $L2_output_addr[2];
$PE2_I_MEM_START  	= $PE2_I_MEM_START_BASE + $PE2_I*(2**13);
$PE2_I_MEM_SIZE 	= $PE2_O_MEM_SIZE;
$PE2_I_PREC		= 0;

$PE3_I_MEM_START_BASE = $L2_output_addr[3];
$PE3_I_MEM_START  	= $PE3_I_MEM_START_BASE + $PE3_I*(2**13);
$PE3_I_MEM_SIZE 	= $PE3_O_MEM_SIZE;
$PE3_I_PREC		= 0;
...
###################
$PE0_I_MEM_START_BASE = $L2_output_addr[3];
$PE0_I_MEM_START  	= $PE0_I_MEM_START_BASE + $PE0_I*(2**13);
$PE0_I_MEM_SIZE 	= $PE0_O_MEM_SIZE;
$PE0_I_PREC		= 0;

$PE1_I_MEM_START_BASE = $L2_output_addr[0];
$PE1_I_MEM_START  	= $PE1_I_MEM_START_BASE + $PE1_I*(2**13);
$PE1_I_MEM_SIZE 	= $PE1_O_MEM_SIZE;
$PE1_I_PREC		= 0;

$PE2_I_MEM_START_BASE = $L2_output_addr[1];
$PE2_I_MEM_START  	= $PE2_I_MEM_START_BASE + $PE2_I*(2**13);
$PE2_I_MEM_SIZE 	= $PE2_O_MEM_SIZE;
$PE2_I_PREC		= 0;

$PE3_I_MEM_START_BASE = $L2_output_addr[2];
$PE3_I_MEM_START  	= $PE3_I_MEM_START_BASE + $PE3_I*(2**13);
$PE3_I_MEM_SIZE 	= $PE3_O_MEM_SIZE;
$PE3_I_PREC		= 0;

$PE0_O_MEM_START_BASE = $L2_output_addr[3];
$PE0_O_MEM_START  	= $PE0_O_MEM_START_BASE + $PE0_O*(2**13);
$PE0_O_MEM_SIZE 	= $PE0_I_MEM_SIZE;
$PE0_O_PREC		= 0;

$PE1_O_MEM_START_BASE = $L2_output_addr[0];
$PE1_O_MEM_START  	= $PE1_O_MEM_START_BASE + $PE1_O*(2**13);
$PE1_O_MEM_SIZE 	= $PE1_I_MEM_SIZE;
$PE1_O_PREC		= 0;

$PE2_O_MEM_START_BASE = $L2_output_addr[1];
$PE2_O_MEM_START  	= $PE2_O_MEM_START_BASE + $PE2_O*(2**13);
$PE2_O_MEM_SIZE 	= $PE2_I_MEM_SIZE;
$PE2_O_PREC		= 0;

$PE3_O_MEM_START_BASE = $L2_output_addr[2];
$PE3_O_MEM_START  	= $PE3_O_MEM_START_BASE + $PE3_O*(2**13);
$PE3_O_MEM_SIZE 	= $PE3_I_MEM_SIZE;
$PE3_O_PREC		= 0;
...
###################
$PE0_I_MEM_START_BASE = $L2_output_addr[2];
$PE0_I_MEM_START  	= $PE0_I_MEM_START_BASE + $PE0_I*(2**13);
$PE0_I_MEM_SIZE 	= $PE0_O_MEM_SIZE;
$PE0_I_PREC		= 0;

$PE1_I_MEM_START_BASE = $L2_output_addr[3];
$PE1_I_MEM_START  	= $PE1_I_MEM_START_BASE + $PE1_I*(2**13);
$PE1_I_MEM_SIZE 	= $PE1_O_MEM_SIZE;
$PE1_I_PREC		= 0;

$PE2_I_MEM_START_BASE = $L2_output_addr[0];
$PE2_I_MEM_START  	= $PE2_I_MEM_START_BASE + $PE2_I*(2**13);
$PE2_I_MEM_SIZE 	= $PE2_O_MEM_SIZE;
$PE2_I_PREC		= 0;

$PE3_I_MEM_START_BASE = $L2_output_addr[1];
$PE3_I_MEM_START  	= $PE3_I_MEM_START_BASE + $PE3_I*(2**13);
$PE3_I_MEM_SIZE 	= $PE3_O_MEM_SIZE;
$PE3_I_PREC		= 0;

$PE0_O_MEM_START_BASE = $L2_output_addr[2];
$PE0_O_MEM_START  	= $PE0_O_MEM_START_BASE + $PE0_O*(2**13);
$PE0_O_MEM_SIZE 	= $PE0_I_MEM_SIZE;
$PE0_O_PREC		= 0;

$PE1_O_MEM_START_BASE = $L2_output_addr[3];
$PE1_O_MEM_START  	= $PE1_O_MEM_START_BASE + $PE1_O*(2**13);
$PE1_O_MEM_SIZE 	= $PE1_I_MEM_SIZE;
$PE1_O_PREC		= 0;

$PE2_O_MEM_START_BASE = $L2_output_addr[0];
$PE2_O_MEM_START  	= $PE2_O_MEM_START_BASE + $PE2_O*(2**13);
$PE2_O_MEM_SIZE 	= $PE2_I_MEM_SIZE;
$PE2_O_PREC		= 0;

$PE3_O_MEM_START_BASE = $L2_output_addr[1];
$PE3_O_MEM_START  	= $PE3_O_MEM_START_BASE + $PE3_O*(2**13);
$PE3_O_MEM_SIZE 	= $PE3_I_MEM_SIZE;
$PE3_O_PREC		= 0;
...
# MAC I/W/OS DATA WRITING INTO MEMORY
#
# debug purpose: this should be the same as MOV1_2 result
$test_OF0 = join "", $inst, "_test_MEM_0.data";
open ($test_OUT0, ">$test_OF0")
	or die "cannot open < ", $test_OF0, ": $!";
$test_OF1 = join "", $inst, "_test_MEM_1.data";
...
## caogao
printf $output_file sprintf("%d %d %d %d\n", $MAC_ROW_NUM_ORG, $PE0_I_EXP, $PE0_O_EXP, $PE0_TO_EXP);
for ($i = 0; $i < $MAC_ROW_NUM_ORG; $i++){
  printf $output_file sprintf("%d ", $PE0_DATA_O_NLI[$i]);
}
close ($output_file);
...
@insts = ("MACNLI0", "MOV0_0", "MOV0_1", "MOV0_2", 
          "MACNLI1", "MOV1_0", "MOV1_1", "MOV1_2", 
          "MACNLI2"); 
foreach (@insts) { 
  $OF0 = join "", $_, "_MEM_0.goldendata";
  system ($^X,"V2_MEM.pl", $OF0);
  $OF1 = join "", $_, "_MEM_1.goldendata";
  system ($^X,"V2_MEM.pl", $OF1);
  $OF2 = join "", $_, "_MEM_2.goldendata";
  system ($^X,"V2_MEM.pl", $OF2);
  $OF3 = join "", $_, "_MEM_3.goldendata";
  system ($^X,"V2_MEM.pl", $OF3);
}
