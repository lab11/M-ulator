...
my $I_MEM_START_BASE = 4096;
my $W_MEM_START_BASE = 0;
my $OS_MEM_START_BASE = 3072;
...
my $MAC_NLI = 0b0000; 
my $O_SIGN = 0b0000; 
$TO_MEM_START_BASE = 4300;
$I_MEM_START_BASE = 4096;
@O_MEM_START_BASE = (4608, 4608, 4608, 4608);
$W_MEM_START_BASE = 0;
$OS_MEM_START_BASE = 3072;
