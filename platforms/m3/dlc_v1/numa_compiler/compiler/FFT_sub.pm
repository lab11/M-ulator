...
my $output_filename = "fft.outputs";
...
#my $PE0_SHIFT_OS 	= 0;
my $PE0_SHIFT_OS		= int($PE0_I_EXP + $PE0_W_EXP - $PE0_O_EXP) - 2; 
  ## should shift the fractional bits of weight
## V3 fix
my $PE0_SHIFT_NL	= 0;
#
print 	"\n";
...
#my $PE1_SHIFT_OS 	= 0;
my $PE1_SHIFT_OS		= int($PE1_I_EXP + $PE1_W_EXP - $PE1_O_EXP) - 2; 
  ## should shift the fractional bits of weight
## V3 fix
my $PE1_SHIFT_NL	= 0;
#
...
#my $PE2_SHIFT_OS 	= 0;
my $PE2_SHIFT_OS		= int($PE2_I_EXP + $PE2_W_EXP - $PE2_O_EXP) - 2; 
  ## should shift the fractional bits of weight
## V3 fix
my $PE2_SHIFT_NL	= 0;
#
...
#my $PE3_SHIFT_OS 	= 0;
my $PE3_SHIFT_OS		= int($PE3_I_EXP + $PE3_W_EXP - $PE3_O_EXP) - 2; 
  ## should shift the fractional bits of weight
## V3 fix
my $PE3_SHIFT_NL	= 0;
#
...
##
  ...
  ## V3 fix
  ## latest
	$PE0_DATA_O0_RE[$i] = floor(int($PE0_DATA_I0_RE[$i] + floor(int($PE0_W_RE*$PE0_DATA_I1_RE[$i] - $PE0_W_IM*$PE0_DATA_I1_IM[$i])/(2**$PE0_SHIFT_OS)))/(2**$PE0_SHIFT));
	$PE0_DATA_O1_RE[$i] = floor(int($PE0_DATA_I0_RE[$i] - floor(int($PE0_W_RE*$PE0_DATA_I1_RE[$i] - $PE0_W_IM*$PE0_DATA_I1_IM[$i])/(2**$PE0_SHIFT_OS)))/(2**$PE0_SHIFT));
	$PE0_DATA_O0_IM[$i] = floor(int($PE0_DATA_I0_IM[$i] + floor(int($PE0_W_RE*$PE0_DATA_I1_IM[$i] + $PE0_W_IM*$PE0_DATA_I1_RE[$i])/(2**$PE0_SHIFT_OS)))/(2**$PE0_SHIFT));
	$PE0_DATA_O1_IM[$i] = floor(int($PE0_DATA_I0_IM[$i] - floor(int($PE0_W_RE*$PE0_DATA_I1_IM[$i] + $PE0_W_IM*$PE0_DATA_I1_RE[$i])/(2**$PE0_SHIFT_OS)))/(2**$PE0_SHIFT));
  ## V3
 # $PE0_DATA_O0_RE[$i] = floor(($PE0_DATA_I0_RE[$i] + floor(int($PE0_W_RE*$PE0_DATA_I1_RE[$i] - $PE0_W_IM*$PE0_DATA_I1_IM[$i])/(2**$PE0_SHIFT_OS)))/(2**$PE0_SHIFT));
 # $PE0_DATA_O1_RE[$i] = floor(($PE0_DATA_I0_RE[$i] - floor(int($PE0_W_RE*$PE0_DATA_I1_RE[$i] - $PE0_W_IM*$PE0_DATA_I1_IM[$i])/(2**$PE0_SHIFT_OS)))/(2**$PE0_SHIFT));
 # $PE0_DATA_O0_IM[$i] = floor(($PE0_DATA_I0_IM[$i] + floor(int($PE0_W_RE*$PE0_DATA_I1_IM[$i] + $PE0_W_IM*$PE0_DATA_I1_RE[$i])/(2**$PE0_SHIFT_OS)))/(2**$PE0_SHIFT));
 # $PE0_DATA_O1_IM[$i] = floor(($PE0_DATA_I0_IM[$i] - floor(int($PE0_W_RE*$PE0_DATA_I1_IM[$i] + $PE0_W_IM*$PE0_DATA_I1_RE[$i])/(2**$PE0_SHIFT_OS)))/(2**$PE0_SHIFT));
  ## new
#	$PE0_DATA_O1_RE[$i] = floor(($PE0_DATA_I0_RE[$i] - floor(($PE0_W_RE*$PE0_DATA_I1_RE[$i] - $PE0_W_IM*$PE0_DATA_I1_IM[$i])/(2**$PE0_SHIFT_OS)))/(2**$PE0_SHIFT));
#	$PE0_DATA_O0_IM[$i] = floor(($PE0_DATA_I0_IM[$i] + floor(($PE0_W_RE*$PE0_DATA_I1_IM[$i] + $PE0_W_IM*$PE0_DATA_I1_RE[$i])/(2**$PE0_SHIFT_OS)))/(2**$PE0_SHIFT));
#	$PE0_DATA_O1_IM[$i] = floor(($PE0_DATA_I0_IM[$i] - floor(($PE0_W_RE*$PE0_DATA_I1_IM[$i] + $PE0_W_IM*$PE0_DATA_I1_RE[$i])/(2**$PE0_SHIFT_OS)))/(2**$PE0_SHIFT));
  ## original
#	$PE0_DATA_O0_RE[$i] = floor(($PE0_DATA_I0_RE[$i] + ($PE0_W_RE*$PE0_DATA_I1_RE[$i] - $PE0_W_IM*$PE0_DATA_I1_IM[$i]))/(2**$PE0_SHIFT));
#	$PE0_DATA_O1_RE[$i] = floor(($PE0_DATA_I0_RE[$i] - ($PE0_W_RE*$PE0_DATA_I1_RE[$i] - $PE0_W_IM*$PE0_DATA_I1_IM[$i]))/(2**$PE0_SHIFT));
#	$PE0_DATA_O0_IM[$i] = floor(($PE0_DATA_I0_IM[$i] + ($PE0_W_RE*$PE0_DATA_I1_IM[$i] + $PE0_W_IM*$PE0_DATA_I1_RE[$i]))/(2**$PE0_SHIFT));
#	$PE0_DATA_O1_IM[$i] = floor(($PE0_DATA_I0_IM[$i] - ($PE0_W_RE*$PE0_DATA_I1_IM[$i] + $PE0_W_IM*$PE0_DATA_I1_RE[$i]))/(2**$PE0_SHIFT));
	#
  ## debug 522
#	print sprintf("i = %i\tj = %i\n", $i, $j);
#	print sprintf("W_r = %d\tW_i = %d\n", $PE0_W_RE, $PE0_W_IM);
#	print sprintf("I0_r = %d\tI1_r = %d\tI0_i = %d\tI1_i = %d\n", $PE0_DATA_I0_RE[$i], $PE0_DATA_I1_RE[$i],$PE0_DATA_I0_IM[$i],$PE0_DATA_I1_IM[$i]);
#	print sprintf("O0_r = %d\tO1_r = %d\tO0_i = %d\tO1_i = %d\n", $PE0_DATA_O0_RE[$i], $PE0_DATA_O1_RE[$i],$PE0_DATA_O0_IM[$i],$PE0_DATA_O1_IM[$i]);
#  print sprintf("O_rt = %d\tO_it = %d\n", 
#   floor(($PE0_W_RE*$PE0_DATA_I1_RE[$i] - $PE0_W_IM*$PE0_DATA_I1_IM[$i])/(2**$PE0_SHIFT_OS)),
#   floor(($PE0_W_RE*$PE0_DATA_I1_IM[$i] - $PE0_W_IM*$PE0_DATA_I1_RE[$i])/(2**$PE0_SHIFT_OS))
#  );
#  print sprintf("without floor: O_rt = %d\tO_it = %d\n", 
#   (($PE0_W_RE*$PE0_DATA_I1_RE[$i] - $PE0_W_IM*$PE0_DATA_I1_IM[$i])/(2**$PE0_SHIFT_OS)),
#   (($PE0_W_RE*$PE0_DATA_I1_IM[$i] - $PE0_W_IM*$PE0_DATA_I1_RE[$i])/(2**$PE0_SHIFT_OS))
#  );
#  print sprintf("without shift: O_rt = %d\tO_it = %d\n", 
#   (($PE0_W_RE*$PE0_DATA_I1_RE[$i] - $PE0_W_IM*$PE0_DATA_I1_IM[$i])),
#   (($PE0_W_RE*$PE0_DATA_I1_IM[$i] - $PE0_W_IM*$PE0_DATA_I1_RE[$i]))
#  );
#  print sprintf("%d\t%d\t%d\t%d\t%d\n", $PE0_W_RE, $PE0_DATA_I1_RE[$i], $PE0_W_IM, $PE0_DATA_I1_IM[$i], $PE0_SHIFT_OS); 
  ## debug 522
  ## debug 523
	if($PE0_DATA_O0_RE[$i] > 2**($PE0_O_EXP-1)-1) {	print "overflow";}
	if($PE0_DATA_O0_RE[$i] < -2**($PE0_O_EXP-1))  {	print "overflow";}
	if($PE0_DATA_O0_IM[$i] > 2**($PE0_O_EXP-1)-1) {	print "overflow";}
	if($PE0_DATA_O0_IM[$i] < -2**($PE0_O_EXP-1))  {	print "overflow";}
	if($PE0_DATA_O1_RE[$i] > 2**($PE0_O_EXP-1)-1) {	print "overflow";}
	if($PE0_DATA_O1_RE[$i] < -2**($PE0_O_EXP-1))  {	print "overflow";}
	if($PE0_DATA_O1_IM[$i] > 2**($PE0_O_EXP-1)-1) {	print "overflow";}
	if($PE0_DATA_O1_IM[$i] < -2**($PE0_O_EXP-1))  {	print "overflow";}
  ## debug 523
...
if ($PE0_DBG){
	...
	for($i = 0; $i < $PE0_W_MEM_SIZE*$PE0_W_DATApWORD; $i++){	
		...
		print sprintf("PE0_DATA_W_RE[%i] = %4.4x\n",$i,$PE0_DATA_W_RE[$i]&0xFFFF);
	}
	print "\n";
	print "\n";
	print "PE0_DATA_I0\n";
	for($i = 0; $i < $PE0_I_MEM_SIZE*$PE0_I_DATApWORD/2; $i++){	
		...
		print sprintf("PE0_DATA_I0_RE[%i] = %4.4x\n",$i,$PE0_DATA_I0_RE[$i]&0xFFFF);
	}
	print "\n";
	print "\n";
	print "PE0_DATA_I1\n";
	for($i = 0; $i < $PE0_I_MEM_SIZE*$PE0_I_DATApWORD/2; $i++){	
		...
		print sprintf("PE0_DATA_I1_RE[%i] = %4.4x\n",$i,$PE0_DATA_I1_RE[$i]&0xFFFF);
	}
	print "\n";
	print "\n";
	print "PE0_DATA_O0\n";
	for($i = 0; $i < $PE0_O_MEM_SIZE*$PE0_O_DATApWORD/2; $i++){	
		...
		print sprintf("PE0_DATA_O0_RE[%i] = %4.4x\n",$i,$PE0_DATA_O0_RE[$i]&0xFFFF);
	}
	print "\n";
	print "\n";
	print "PE0_DATA_O1\n";
	for($i = 0; $i < $PE0_O_MEM_SIZE*$PE0_O_DATApWORD/2; $i++){	
		...
		print sprintf("PE0_DATA_O1_RE[%i] = %4.4x\n",$i,$PE0_DATA_O1_RE[$i]&0xFFFF);
	}
	print "\n";
	print "\n";
}
...
if ($PE0_DBG){
	...
	for($i = 0; $i < $PE0_W_MEM_SIZE*$PE0_W_DATApWORD; $i++){	
		...
		print sprintf("PE0_DATA_W_RE[%i] = %.d\n",$i,$PE0_DATA_W_RE[$i]);
	}
	print "\n";
	print "\n";
	print "PE0_DATA_I0\n";
	for($i = 0; $i < $PE0_I_MEM_SIZE*$PE0_I_DATApWORD/2; $i++){	
		...
		print sprintf("PE0_DATA_I0_RE[%i] = %.d\n",$i,$PE0_DATA_I0_RE[$i]);
	}
	print "\n";
	print "\n";
	print "PE0_DATA_I1\n";
	for($i = 0; $i < $PE0_I_MEM_SIZE*$PE0_I_DATApWORD/2; $i++){	
		...
		print sprintf("PE0_DATA_I1_RE[%i] = %.d\n",$i,$PE0_DATA_I1_RE[$i]);
	}
	print "\n";
	print "\n";
	print "PE0_DATA_O0\n";
	for($i = 0; $i < $PE0_O_MEM_SIZE*$PE0_O_DATApWORD/2; $i++){	
		...
		print sprintf("PE0_DATA_O0_RE[%i] = %.d\n",$i,$PE0_DATA_O0_RE[$i]);
	}
	print "\n";
	print "\n";
	print "PE0_DATA_O1\n";
	for($i = 0; $i < $PE0_O_MEM_SIZE*$PE0_O_DATApWORD/2; $i++){	
		...
		print sprintf("PE0_DATA_O1_RE[%i] = %.d\n",$i,$PE0_DATA_O1_RE[$i]);
	}
	print "\n";
	print "\n";
}
...
for($i = 0; $i < $PE1_O_MEM_SIZE*$PE1_O_DATApWORD/2; $i++){
	...
	#
  #V3 fix
	$PE1_DATA_O0_RE[$i] = floor(int($PE1_DATA_I0_RE[$i] + floor(int($PE1_W_RE*$PE1_DATA_I1_RE[$i] - $PE1_W_IM*$PE1_DATA_I1_IM[$i])/(2**$PE1_SHIFT_OS)))/(2**$PE1_SHIFT));
	$PE1_DATA_O1_RE[$i] = floor(int($PE1_DATA_I0_RE[$i] - floor(int($PE1_W_RE*$PE1_DATA_I1_RE[$i] - $PE1_W_IM*$PE1_DATA_I1_IM[$i])/(2**$PE1_SHIFT_OS)))/(2**$PE1_SHIFT));
	$PE1_DATA_O0_IM[$i] = floor(int($PE1_DATA_I0_IM[$i] + floor(int($PE1_W_RE*$PE1_DATA_I1_IM[$i] + $PE1_W_IM*$PE1_DATA_I1_RE[$i])/(2**$PE1_SHIFT_OS)))/(2**$PE1_SHIFT));
	$PE1_DATA_O1_IM[$i] = floor(int($PE1_DATA_I0_IM[$i] - floor(int($PE1_W_RE*$PE1_DATA_I1_IM[$i] + $PE1_W_IM*$PE1_DATA_I1_RE[$i])/(2**$PE1_SHIFT_OS)))/(2**$PE1_SHIFT));
#	$PE1_DATA_O0_RE[$i] = int(($PE1_DATA_I0_RE[$i] + int(($PE1_W_RE*$PE1_DATA_I1_RE[$i] - $PE1_W_IM*$PE1_DATA_I1_IM[$i])/(2**$PE1_SHIFT_OS)))/(2**$PE1_SHIFT));
#	$PE1_DATA_O1_RE[$i] = int(($PE1_DATA_I0_RE[$i] - int(($PE1_W_RE*$PE1_DATA_I1_RE[$i] - $PE1_W_IM*$PE1_DATA_I1_IM[$i])/(2**$PE1_SHIFT_OS)))/(2**$PE1_SHIFT));
#	$PE1_DATA_O0_IM[$i] = floor(($PE1_DATA_I0_IM[$i] + floor(($PE1_W_RE*$PE1_DATA_I1_IM[$i] + $PE1_W_IM*$PE1_DATA_I1_RE[$i])/(2**$PE1_SHIFT_OS)))/(2**$PE1_SHIFT));
#	$PE1_DATA_O1_IM[$i] = floor(($PE1_DATA_I0_IM[$i] - floor(($PE1_W_RE*$PE1_DATA_I1_IM[$i] + $PE1_W_IM*$PE1_DATA_I1_RE[$i])/(2**$PE1_SHIFT_OS)))/(2**$PE1_SHIFT));
  #V3 fix
...
for($i = 0; $i < $PE2_O_MEM_SIZE*$PE2_O_DATApWORD/2; $i++){
	...
	#
  # V3 fix
	$PE2_DATA_O0_RE[$i] = floor(int($PE2_DATA_I0_RE[$i] + floor(int($PE2_W_RE*$PE2_DATA_I1_RE[$i] - $PE2_W_IM*$PE2_DATA_I1_IM[$i])/(2**$PE2_SHIFT_OS)))/(2**$PE2_SHIFT));
	$PE2_DATA_O1_RE[$i] = floor(int($PE2_DATA_I0_RE[$i] - floor(int($PE2_W_RE*$PE2_DATA_I1_RE[$i] - $PE2_W_IM*$PE2_DATA_I1_IM[$i])/(2**$PE2_SHIFT_OS)))/(2**$PE2_SHIFT));
	$PE2_DATA_O0_IM[$i] = floor(int($PE2_DATA_I0_IM[$i] + floor(int($PE2_W_RE*$PE2_DATA_I1_IM[$i] + $PE2_W_IM*$PE2_DATA_I1_RE[$i])/(2**$PE2_SHIFT_OS)))/(2**$PE2_SHIFT));
	$PE2_DATA_O1_IM[$i] = floor(int($PE2_DATA_I0_IM[$i] - floor(int($PE2_W_RE*$PE2_DATA_I1_IM[$i] + $PE2_W_IM*$PE2_DATA_I1_RE[$i])/(2**$PE2_SHIFT_OS)))/(2**$PE2_SHIFT));
#	$PE2_DATA_O0_RE[$i] = int(($PE2_DATA_I0_RE[$i] + int(($PE2_W_RE*$PE2_DATA_I1_RE[$i] - $PE2_W_IM*$PE2_DATA_I1_IM[$i])/(2**$PE2_SHIFT_OS)))/(2**$PE2_SHIFT));
#	$PE2_DATA_O1_RE[$i] = int(($PE2_DATA_I0_RE[$i] - int(($PE2_W_RE*$PE2_DATA_I1_RE[$i] - $PE2_W_IM*$PE2_DATA_I1_IM[$i])/(2**$PE2_SHIFT_OS)))/(2**$PE2_SHIFT));
#	$PE2_DATA_O0_IM[$i] = floor(($PE2_DATA_I0_IM[$i] + floor(($PE2_W_RE*$PE2_DATA_I1_IM[$i] + $PE2_W_IM*$PE2_DATA_I1_RE[$i])/(2**$PE2_SHIFT_OS)))/(2**$PE2_SHIFT));
#	$PE2_DATA_O1_IM[$i] = floor(($PE2_DATA_I0_IM[$i] - floor(($PE2_W_RE*$PE2_DATA_I1_IM[$i] + $PE2_W_IM*$PE2_DATA_I1_RE[$i])/(2**$PE2_SHIFT_OS)))/(2**$PE2_SHIFT));
...
for($i = 0; $i < $PE3_O_MEM_SIZE*$PE3_O_DATApWORD/2; $i++){
	...
	#
  # V3 fix
	$PE3_DATA_O0_RE[$i] = floor(int($PE3_DATA_I0_RE[$i] + floor(int($PE3_W_RE*$PE3_DATA_I1_RE[$i] - $PE3_W_IM*$PE3_DATA_I1_IM[$i])/(2**$PE3_SHIFT_OS)))/(2**$PE3_SHIFT));
	$PE3_DATA_O1_RE[$i] = floor(int($PE3_DATA_I0_RE[$i] - floor(int($PE3_W_RE*$PE3_DATA_I1_RE[$i] - $PE3_W_IM*$PE3_DATA_I1_IM[$i])/(2**$PE3_SHIFT_OS)))/(2**$PE3_SHIFT));
	$PE3_DATA_O0_IM[$i] = floor(int($PE3_DATA_I0_IM[$i] + floor(int($PE3_W_RE*$PE3_DATA_I1_IM[$i] + $PE3_W_IM*$PE3_DATA_I1_RE[$i])/(2**$PE3_SHIFT_OS)))/(2**$PE3_SHIFT));
	$PE3_DATA_O1_IM[$i] = floor(int($PE3_DATA_I0_IM[$i] - floor(int($PE3_W_RE*$PE3_DATA_I1_IM[$i] + $PE3_W_IM*$PE3_DATA_I1_RE[$i])/(2**$PE3_SHIFT_OS)))/(2**$PE3_SHIFT));
#	$PE3_DATA_O0_RE[$i] = int(($PE3_DATA_I0_RE[$i] + int(($PE3_W_RE*$PE3_DATA_I1_RE[$i] - $PE3_W_IM*$PE3_DATA_I1_IM[$i])/(2**$PE3_SHIFT_OS)))/(2**$PE3_SHIFT));
#	$PE3_DATA_O1_RE[$i] = int(($PE3_DATA_I0_RE[$i] - int(($PE3_W_RE*$PE3_DATA_I1_RE[$i] - $PE3_W_IM*$PE3_DATA_I1_IM[$i])/(2**$PE3_SHIFT_OS)))/(2**$PE3_SHIFT));
#	$PE3_DATA_O0_IM[$i] = floor(($PE3_DATA_I0_IM[$i] + floor(($PE3_W_RE*$PE3_DATA_I1_IM[$i] + $PE3_W_IM*$PE3_DATA_I1_RE[$i])/(2**$PE3_SHIFT_OS)))/(2**$PE3_SHIFT));
#	$PE3_DATA_O1_IM[$i] = floor(($PE3_DATA_I0_IM[$i] - floor(($PE3_W_RE*$PE3_DATA_I1_IM[$i] + $PE3_W_IM*$PE3_DATA_I1_RE[$i])/(2**$PE3_SHIFT_OS)))/(2**$PE3_SHIFT));
...
## caogao
printf $output_file sprintf("%d\n",$I_ELEMENTS);
if ($COMMON_FFT_NUM == 1) {
  for ($i = 0; $i < $I_ELEMENTS / 2; $i++){
    printf $output_file sprintf("%d %d ", $PE0_DATA_O0_RE[$i], $PE0_DATA_O0_IM[$i]);
  }
  for ($i = 0; $i < $I_ELEMENTS / 2; $i++){
    printf $output_file sprintf("%d %d ", $PE0_DATA_O1_RE[$i], $PE0_DATA_O1_IM[$i]);
  }
} else {
  for ($i = 0; $i < $I_ELEMENTS / 2; $i += $PE0_W_MEM_SIZE * $PE0_W_DATApWORD * 2){
  
  	for($p = 0; $p < $PE0_W_MEM_SIZE*$PE0_W_DATApWORD; $p++){
      printf $output_file sprintf("%d %d ", $PE0_DATA_O0_RE[$i + $p], $PE0_DATA_O0_IM[$i + $p]);
      printf $output_file sprintf("%d %d ", $PE0_DATA_O0_RE[$i + $PE0_W_MEM_SIZE * $PE0_W_DATApWORD + $p], $PE0_DATA_O0_IM[$i + $PE0_W_MEM_SIZE * $PE0_W_DATApWORD + $p]);
    }
  	for($p = 0; $p < $PE0_W_MEM_SIZE*$PE0_W_DATApWORD; $p++){
      printf $output_file sprintf("%d %d ", $PE0_DATA_O1_RE[$i + $p], $PE0_DATA_O1_IM[$i + $p]);
      printf $output_file sprintf("%d %d ", $PE0_DATA_O1_RE[$i + $PE0_W_MEM_SIZE * $PE0_W_DATApWORD + $p], $PE0_DATA_O1_IM[$i + $PE0_W_MEM_SIZE * $PE0_W_DATApWORD + $p]);
    }
  }
}
close ($output_file);
...
## debug 5.23
my $output_debug_filename = $output_filename . "debug";
open($output_file_debug, ">", $output_debug_filename) 
	or die "cannot open < ", $output_debug_filename, ": $!";
printf $output_file_debug sprintf("%d\n",$I_ELEMENTS);
for ($i = 0; $i < $I_ELEMENTS / 2; $i += 1){
  printf $output_file_debug sprintf("%d ", $i * 2);
  printf $output_file_debug sprintf("%d %d\n", $PE0_DATA_O0_RE[$i], $PE0_DATA_O0_IM[$i]);
  printf $output_file_debug sprintf("%d ", $i * 2 + 1);
  printf $output_file_debug sprintf("%d %d\n", $PE0_DATA_O1_RE[$i], $PE0_DATA_O1_IM[$i]);
}
...
if (not (defined $argv[1] and $argv[1] ne "NULL")) {
  ...
  $OF0 = join "", $inst, "_MEM_0.testdata";
  open (OUT0, ">$OF0")
  	or die "cannot open < ", $OF0, ": $!";
  $OF1 = join "", $inst, "_MEM_1.testdata";
  open (OUT1, ">$OF1")
  	or die "cannot open < ", $OF1, ": $!";
  $OF2 = join "", $inst, "_MEM_2.testdata";
  open (OUT2, ">$OF2")
  	or die "cannot open < ", $OF2, ": $!";
  $OF3 = join "", $inst, "_MEM_3.testdata";
  open (OUT3, ">$OF3")
  	or die "cannot open < ", $OF3, ": $!";
  for($i=0; $i<$MEM_OUT_BOUND; $i++){
  	printf OUT0 $PE0_MEM_LINES[$i];
