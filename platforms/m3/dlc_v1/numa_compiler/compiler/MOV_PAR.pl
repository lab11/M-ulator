...
#my $M = $ARGV[0];
my $OF0 = join "", "MOV_MEM_0.data";
open (OUT0, ">$OF0")
	or die "cannot open < ", $OF0, ": $!";
my $OF1 = join "", "MOV_MEM_1.data";
open (OUT1, ">$OF1")
	or die "cannot open < ", $OF1, ": $!";
my $OF2 = join "", "MOV_MEM_2.data";
open (OUT2, ">$OF2")
	or die "cannot open < ", $OF2, ": $!";
my $OF3 = join "", "MOV_MEM_3.data";
open (OUT3, ">$OF3")
	or die "cannot open < ", $OF3, ": $!";

my $OF_LOG = join "", "MOV_GEN.log";
open (OUT_LOG, ">$OF_LOG")
	or die "cannot open < ", $OF_LOG, ": $!";

my $INST = join "", "MOV.inst";
open (OUT_INST, ">$INST")
...
if (defined $ARGV[0]) { $weight_filename = $ARGV[0]; }
if (defined $ARGV[1]) { $input_filename = $ARGV[1];  }
if (defined $ARGV[2]) { $offset_filename = $ARGV[2]; }
...
my $MAC_COL_NUM_ORG	= 100; 
my $MAC_ROW_NUM_ORG	= 100;
...
my $total_inst_no = 2;
my $out_dnn_parameter_filename = "dnn_parameters.h";
open (OUT_DNN_PARA, ">$out_dnn_parameter_filename")
	or die "cannot open < ", $out_dnn_parameter_filename, ": $!";
printf OUT_DNN_PARA sprintf("#ifndef _DNN_PARAMETERS_H\n");
printf OUT_DNN_PARA sprintf("#define _DNN_PARAMETERS_H\n");
printf OUT_DNN_PARA sprintf("#include <stdint.h>\n");
printf OUT_DNN_PARA sprintf("extern uint32_t PE_INSTS[%d][4][6];\n", $total_inst_no);	## inst_no, PE_no, ADDR_no
printf OUT_DNN_PARA sprintf("\n");	
printf OUT_DNN_PARA sprintf("void set_dnn_insts();\n");	
printf OUT_DNN_PARA sprintf("void set_nli_parameters();\n");	
printf OUT_DNN_PARA sprintf("#endif\n");

my $out_dnn_inst_filename = "dnn.inst.c";
open (OUT_DNN_INST, ">$out_dnn_inst_filename")
	or die "cannot open < ", $out_dnn_inst_filename, ": $!";
printf OUT_DNN_INST sprintf("#include \"dnn_parameters.h\"\n");
printf OUT_DNN_INST sprintf("uint32_t PE_INSTS[%d][4][6];\n", $total_inst_no);
printf OUT_DNN_INST sprintf("\n");
printf OUT_DNN_INST sprintf("void set_dnn_insts() {\n"); # bracket closed at the of the file 

my $out_dnn_nli_filename = "dnn.nli.c";
open (OUT_DNN_NLI, ">$out_dnn_nli_filename")
	or die "cannot open < ", $out_dnn_nli_filename, ": $!";
printf OUT_DNN_NLI sprintf("#include \"dnn_parameters.h\"\n");
printf OUT_DNN_NLI sprintf("\n");
printf OUT_DNN_NLI sprintf("void set_nli_parameters() {}\n"); # bracket closed at the of the file 
close (OUT_DNN_NLI);
##########
...
#my $MEM_H4_LINES = 4096;
#my $MEM_H3_LINES = 1024;
#my $MEM_H2_LINES = 512;
#my $MEM_H1_LINES = 128;
...
## caogao
my $inst_no = 0;
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][0][0] = 0b%32.32s;\n", $inst_no, $PE0_INST_0);
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][0][1] = 0b%32.32s;\n", $inst_no, $PE0_INST_1);
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][0][2] = 0b%32.32s;\n", $inst_no, $PE0_INST_2);
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][0][3] = 0b%32.32s;\n", $inst_no, $PE0_INST_3);
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][0][4] = 0b%32.32s;\n", $inst_no, $PE0_INST_4);
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][0][5] = 0b%32.32s;\n", $inst_no, $PE0_INST_5);
#
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][1][0] = 0b%32.32s;\n", $inst_no, $PE1_INST_0);
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][1][1] = 0b%32.32s;\n", $inst_no, $PE1_INST_1);
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][1][2] = 0b%32.32s;\n", $inst_no, $PE1_INST_2);
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][1][3] = 0b%32.32s;\n", $inst_no, $PE1_INST_3);
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][1][4] = 0b%32.32s;\n", $inst_no, $PE1_INST_4);
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][1][5] = 0b%32.32s;\n", $inst_no, $PE1_INST_5);
#
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][2][0] = 0b%32.32s;\n", $inst_no, $PE2_INST_0);
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][2][1] = 0b%32.32s;\n", $inst_no, $PE2_INST_1);
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][2][2] = 0b%32.32s;\n", $inst_no, $PE2_INST_2);
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][2][3] = 0b%32.32s;\n", $inst_no, $PE2_INST_3);
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][2][4] = 0b%32.32s;\n", $inst_no, $PE2_INST_4);
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][2][5] = 0b%32.32s;\n", $inst_no, $PE2_INST_5);
#
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][3][0] = 0b%32.32s;\n", $inst_no, $PE3_INST_0);
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][3][1] = 0b%32.32s;\n", $inst_no, $PE3_INST_1);
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][3][2] = 0b%32.32s;\n", $inst_no, $PE3_INST_2);
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][3][3] = 0b%32.32s;\n", $inst_no, $PE3_INST_3);
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][3][4] = 0b%32.32s;\n", $inst_no, $PE3_INST_4);
#printf OUT_DNN_INST sprintf("PE_INSTS[%d][3][5] = 0b%32.32s;\n", $inst_no, $PE3_INST_5);
...
### debug
#    print "debug weights file\n";
#    print $k, "\t", $PE0_DATA_W[$k], "\n";
### debug
		$k++;
	}
}
...
### debug
#    print "debug inputs file\n";
#    print $k, "\t", $PE0_DATA_I[$k], "\n";
### debug
	$k++;
}
$k=0;
...
### debug
#    print "debug offset file\n";
#    print $k, "\t", $PE0_DATA_OS[$k], "\n";
### debug
	$k++;
}
############################################################################
...
$LINE_MEM = ""; 	
#######debug
#  print "debug: weight PE0\n";
#  print $PE0_W_MEM_START_BASE, "\n";
#  print $PE0_W_DATApWORD/2, "\n";
...
while ($k < $PE0_W_MEM_SIZE){
	...
	$q++;
#######debug
# print $idx1, "\t", $PE0_DATA_W[$idx2], "\t", $PE0_DATA_W[$idx1], "\n";
#######debug
...
$i = 0;
#######debug
#  print "debug: input PE0\n";
#  print $PE0_I_MEM_START_BASE, "\n";
#  print $PE0_I_DATApWORD/2, "\n";
...
#######debug
# print $i, "\t", $PE0_DATA_I[$i+1], "\t", $PE0_DATA_I[$i], "\n";
#######debug
		$i = $i + 2;
	}
...
#######debug
#  print "debug: offset PE0\n";
#  print $PE0_O_MEM_START_BASE, "\n";
#  print $PE0_O_DATApWORD/2, "\n";
#  print $PE0_O_MEM_SIZE, "\n";
#######debug
...
#######debug
# print $i, "\t", $PE0_DATA_OS[$i+1], "\t", $PE0_DATA_OS[$i], "\n";
#######debug
		$i = $i + 2;
	}
	#printf OUT_LOG "$LINE_MEM\n";
...
#######debug
# print $i, "\t", $PE0_DATA_O_FINAL[$i+1], "\t", $PE0_DATA_O_FINAL[$i], "\n";
#######debug
		$i = $i + 2;
	}
	#printf OUT_LOG "$LINE_MEM\n";
...
$LINE_MEM = ""; 	
#########debug
#  print "debug: weight PE2\n";
#  print $PE2_W_MEM_START_BASE, "\n";
#  print $PE2_W_DATApWORD/2, "\n";
#  print $PE2_W_MEM_SIZE, "\n";
#########debug
printf OUT_LOG "\n";
printf OUT_LOG "W_INDEX INFO IN STORING ORDER: W_INDEX = CURRENT_ROW_INDEX x TOT_COL_NUM + INDEX_OF_COL_IN_CURRENT_ROW\n";
printf OUT_LOG "\n";
while ($k < $PE2_W_MEM_SIZE){
	...
	$q++;
#########debug
#  print $idx1, "\t", $PE2_DATA_W[$idx2], "\t", $PE2_DATA_W[$idx1], "\n";
#########debug
...
$i = 0;
#######debug
#  print "debug: input PE2\n";
#  print $PE2_I_MEM_START_BASE, "\n";
#  print $PE2_I_DATApWORD/2, "\n";
#  print $PE2_I_MEM_SIZE, "\n";
#######debug
#while($i < $MAC_COL_NUM_ZP){
...
#######debug
#  print $i, "\t", $PE2_DATA_I[$i+1], "\t", $PE2_DATA_I[$i], "\n"; 
#######debug
		$i = $i + 2;
	}
	#printf OUT_LOG "$LINE_MEM\n";
...
#######debug
#  print "debug: offset PE2\n";
#  print $PE2_O_MEM_START_BASE, "\n";
#  print $PE2_O_DATApWORD/2, "\n";
#  print $PE2_O_MEM_SIZE, "\n";
#######debug
...
#######debug
#  print $i, "\t", $PE2_DATA_OS[$i+1], "\t", $PE2_DATA_OS[$i], "\n"; 
#######debug
		$i = $i + 2;
	}
	#printf OUT_LOG "$LINE_MEM\n";
...
#######debug
# print $i, "\t", $PE2_DATA_O_FINAL[$i+1], "\t", $PE2_DATA_O_FINAL[$i], "\n"; 
#######debug
		$i = $i + 2;
	}
	#printf OUT_LOG "$LINE_MEM\n";
...
#
$OF0 = join "", "MAC_MEM_0.goldendata";
$OF1 = join "", "MAC_MEM_1.goldendata";
$OF2 = join "", "MAC_MEM_2.goldendata";
$OF3 = join "", "MAC_MEM_3.goldendata";
open (OUT0, ">$OF0");
open (OUT1, ">$OF1");
open (OUT2, ">$OF2");
open (OUT3, ">$OF3");
...
###################
#$I_MEM_START_BASE 	= $MEM_H3_START;
$PE0_I_MEM_START_BASE = $PE0_O_MEM_START_BASE;
$PE0_I_MEM_START  	= $PE0_O_MEM_START;
$PE0_I_MEM_SIZE 	= $PE0_O_MEM_SIZE;
$PE0_I_PREC		= 0;

$PE1_I_MEM_START_BASE = $PE1_O_MEM_START_BASE;
$PE1_I_MEM_START  	= $PE1_O_MEM_START;
$PE1_I_MEM_SIZE 	= $PE1_O_MEM_SIZE;
$PE1_I_PREC		= 0;

$PE2_I_MEM_START_BASE = $PE2_O_MEM_START_BASE;
$PE2_I_MEM_START  	= $PE2_O_MEM_START;
$PE2_I_MEM_SIZE 	= $PE2_O_MEM_SIZE;
$PE2_I_PREC		= 0;

$PE3_I_MEM_START_BASE = $PE3_O_MEM_START_BASE;
$PE3_I_MEM_START  	= $PE3_O_MEM_START;
$PE3_I_MEM_SIZE 	= $PE3_O_MEM_SIZE;
$PE3_I_PREC		= 0;

$PE0_O_MEM_START_BASE = $PE1_I_MEM_START_BASE + $PE1_I_MEM_SIZE;		## equal to old PE1_O_MEM_START + PE1_O_MEM_SIZE
$PE0_O_MEM_START  	= $PE1_I_MEM_START + $PE1_I_MEM_SIZE;	
$PE0_O_MEM_SIZE 	= $PE1_I_MEM_SIZE;
$PE0_O_PREC		= 0;

$PE1_O_MEM_START_BASE = $PE2_I_MEM_START_BASE + $PE2_I_MEM_SIZE;
$PE1_O_MEM_START  	= $PE2_I_MEM_START + $PE2_I_MEM_SIZE;		## after DNN result
$PE1_O_MEM_SIZE 	= $PE2_I_MEM_SIZE;
$PE1_O_PREC		= 0;

$PE2_O_MEM_START_BASE = $PE3_I_MEM_START_BASE + $PE3_I_MEM_SIZE;
$PE2_O_MEM_START  	= $PE3_I_MEM_START + $PE3_I_MEM_SIZE;		## after DNN result
$PE2_O_MEM_SIZE 	= $PE3_I_MEM_SIZE;
$PE2_O_PREC		= 0;

$PE3_O_MEM_START_BASE = $PE0_I_MEM_START_BASE + $PE0_I_MEM_SIZE;
$PE3_O_MEM_START  	= $PE0_I_MEM_START + $PE0_I_MEM_SIZE;		## after DNN result
$PE3_O_MEM_SIZE 	= $PE0_I_MEM_SIZE;
$PE3_O_PREC		= 0;

$PE0_OP		= $OP_MOV;
$PE0_TO_MEM_START	= 0;
#$TO_MEM_START 	= $TO_MEM_START_BASE + $TEST_PE*(2**13);
$PE0_TO_MEM_SIZE	= 0;
$PE0_TO_PREC		= 0;
#$O_MEM_START_BASE 	= 5632;
$PE0_O_SIGN		= 1;
$PE0_OS_MEM_START_BASE= 0;
...
#
print 	"\n";
print	sprintf("PE1_TO_MEM_START = %d\n", $PE1_TO_MEM_START + 0*(2**13));
print	sprintf("PE1_TO_MEM_END = %d\n", $PE1_TO_MEM_START + 0*(2**13) + $PE1_TO_MEM_SIZE - 1);
print	sprintf("PE1_I_MEM_START  = %d\n", $PE1_I_MEM_START);
print	sprintf("PE1_I_MEM_END    = %d\n", $PE1_I_MEM_START + $PE1_I_MEM_SIZE - 1);
print	sprintf("PE1_O_MEM_START  = %d\n", $PE1_O_MEM_START);
print	sprintf("PE1_O_MEM_END    = %d\n", $PE1_O_MEM_START + $PE1_O_MEM_SIZE - 1);
...
#
print 	"\n";
print	sprintf("PE2_TO_MEM_START = %d\n", $PE2_TO_MEM_START + 0*(2**13));
print	sprintf("PE2_TO_MEM_END	 = %d\n", $PE2_TO_MEM_START + 0*(2**13) + $PE2_TO_MEM_SIZE - 1);
print	sprintf("PE2_I_MEM_START  = %d\n", $PE2_I_MEM_START);
print	sprintf("PE2_I_MEM_END    = %d\n", $PE2_I_MEM_START + $PE2_I_MEM_SIZE - 1);
print	sprintf("PE2_O_MEM_START  = %d\n", $PE2_O_MEM_START);
print	sprintf("PE2_O_MEM_END    = %d\n", $PE2_O_MEM_START + $PE2_O_MEM_SIZE - 1);
...
#
print 	"\n";
print	sprintf("PE3_TO_MEM_START = %d\n", $PE3_TO_MEM_START + 0*(2**13));
print	sprintf("PE3_TO_MEM_END 	= %d\n", $PE3_TO_MEM_START + 0*(2**13) + $PE3_TO_MEM_SIZE - 1);
print	sprintf("PE3_I_MEM_START  = %d\n", $PE3_I_MEM_START);
print	sprintf("PE3_I_MEM_END    = %d\n", $PE3_I_MEM_START + $PE3_I_MEM_SIZE - 1);
print	sprintf("PE3_O_MEM_START  = %d\n", $PE3_O_MEM_START);
print	sprintf("PE3_O_MEM_END    = %d\n", $PE3_O_MEM_START + $PE3_O_MEM_SIZE - 1);
...
$PE3_SHIFT_NL	= 0;
###################
$PE1_I_MEM_START  	= 13574;
$PE1_O_MEM_START  	= 21766; 
...
for ($i=5376; $i<5382; $i++){
	$PE0_MEM_LINES[$i] = "01234567890123456789abcd\n";
}

$OF0 = join "", "TEST_MOV_MEM_0.data";
$OF1 = join "", "TEST_MOV_MEM_1.data";
$OF2 = join "", "TEST_MOV_MEM_2.data";
$OF3 = join "", "TEST_MOV_MEM_3.data";
open (OUT0, ">$OF0");
open (OUT1, ">$OF1");
open (OUT2, ">$OF2");
open (OUT3, ">$OF3");
...
for ($i=5382; $i<5388; $i++){
	$PE1_MEM_LINES[$i] = "01234567890123456789abcd\n";
}
$OF0 = join "", "TEST_MOV_0_MEM_0.goldendata";
$OF1 = join "", "TEST_MOV_0_MEM_1.goldendata";
$OF2 = join "", "TEST_MOV_0_MEM_2.goldendata";
$OF3 = join "", "TEST_MOV_0_MEM_3.goldendata";
open (OUT0, ">$OF0");
open (OUT1, ">$OF1");
open (OUT2, ">$OF2");
open (OUT3, ">$OF3");
...
for ($i=5382; $i<5389; $i++){
	$PE2_MEM_LINES[$i] = "01234567890123456789abcd\n";
}
$OF0 = join "", "TEST_MOV_1_MEM_0.goldendata";
$OF1 = join "", "TEST_MOV_1_MEM_1.goldendata";
$OF2 = join "", "TEST_MOV_1_MEM_2.goldendata";
$OF3 = join "", "TEST_MOV_1_MEM_3.goldendata";
open (OUT0, ">$OF0");
open (OUT1, ">$OF1");
open (OUT2, ">$OF2");
open (OUT3, ">$OF3");
