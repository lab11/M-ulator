...
if (defined $ARGV[5]) { $nli_filename = $ARGV[5]; }
if (defined $ARGV[6]) { $output_filename = $ARGV[6]; }
...
#$MAC_ROW_NUM_ORG = ceil($MAC_ROW_NUM_ORG / 4); ### not parallel
print	sprintf("MAC_ROW_NUM_ORG(output)= %d\n", $MAC_ROW_NUM_ORG);
print	sprintf("MAC_COL_NUM_ORG(input)= %d\n", $MAC_COL_NUM_ORG);

my $PE0_TO_MEM_START	   = $MEM_H1B1_START;
my $PE0_I_MEM_START_BASE = $MEM_H2B1_START;
my $PE0_O_MEM_START_BASE = $MEM_H3B1_START;
my $PE0_W_MEM_START_BASE = $MEM_H4B1_START;
my $PE0_OS_MEM_START_BASE= $MEM_H3B2_START;
if (defined $ARGV[7] and $ARGV[7]) { 
  $PE0_I_MEM_START_BASE = $MEM_H3B1_START; $PE0_O_MEM_START_BASE = $MEM_H2B1_START;
  $PE0_W_MEM_START_BASE = $MEM_H4B3_START; $PE0_OS_MEM_START_BASE = $MEM_H2B1_START;
}
#
my $PE1_TO_MEM_START	   = $MEM_H1B1_START;
my $PE1_I_MEM_START_BASE = $MEM_H2B1_START;
my $PE1_O_MEM_START_BASE = $MEM_H3B3_START;
my $PE1_W_MEM_START_BASE = $MEM_H4B1_START;
my $PE1_OS_MEM_START_BASE= $MEM_H3B2_START;
my $PE2_TO_MEM_START	   = $MEM_H1B1_START;
my $PE2_I_MEM_START_BASE = $MEM_H2B1_START;
my $PE2_O_MEM_START_BASE = $MEM_H3B3_START;
my $PE2_W_MEM_START_BASE = $MEM_H4B1_START;
my $PE2_OS_MEM_START_BASE= $MEM_H3B2_START;
my $PE3_TO_MEM_START	   = $MEM_H1B1_START;
my $PE3_I_MEM_START_BASE = $MEM_H2B1_START;
my $PE3_O_MEM_START_BASE = $MEM_H3B3_START;
my $PE3_W_MEM_START_BASE = $MEM_H4B1_START;
my $PE3_OS_MEM_START_BASE= $MEM_H3B2_START;
