...
my $weight_filename = "w1.csv.weight";
#my $input_filename = "in50.csv.inputs";
my $input_filename = "in51.csv.inputs";
my $offset_filename = "b1.csv.offsets";
my $import_input_file = 0b0001;
my $PE_on = 0b1111;        
my $MAC_OFFSET = 0b1111; 
my $I_MEM_START_BASE = 5632;
my $W_MEM_START_BASE = 0;
my $OS_MEM_START_BASE = 5376;
...
$weight_filename = join "", "w2.csv.weight";
$offset_filename = join "", "b2.csv.offsets";
...
$PE_on = 0b0001;
$INPUT_MEM_FILE = "DNN_INIT_MEM";
$weight_filename = join "", "w3.csv.weight";
$offset_filename = join "", "b3.csv.offsets";
#  $I_MEM_START_BASE = 5632;  ## doesn't matter
...
$INPUT_MEM_FILE = $inst . "_MEM";
$inst = "layer_0";
$weight_filename = "w1.csv.weight";
#$input_filename = "in50.csv.inputs";
$input_filename = "in51.csv.inputs";
my $output_filename = "dnn_0.outputs";
$offset_filename = "b1.csv.offsets";
...
@O_MEM_START_BASE = (5504, 5516, 5528, 5540);
$W_MEM_START_BASE = 0;
$OS_MEM_START_BASE = 5376;
...
$INPUT_MEM_FILE = $inst . "_MEM";
$inst = "layer_1";
$weight_filename = "w2.csv.weight";
$input_filename = "dnn_0.outputs";
$output_filename = "dnn_1.outputs";
$offset_filename = "b2.csv.offsets";
...
$INPUT_MEM_FILE = $inst . "_MEM";
$inst = "layer_2";
$weight_filename = "w3.csv.weight";
$input_filename = "dnn_1.outputs";
$output_filename = "dnn_2.outputs";
$offset_filename = "b3.csv.offsets";
$PE_on = 0b0001;       
$O_SIGN = 0b1111; 
$TO_MEM_START_BASE = 5696;
$I_MEM_START_BASE = 5632;
