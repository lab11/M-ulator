...
for ($i = 0; $i < $MAC_ROW_NUM_ORG; $i++){
  printf $output_file sprintf("%f ", $PE0_DATA_O_NLI[$i]);
}
for ($i = 0; $i < $MAC_ROW_NUM_ORG; $i++){
  printf $output_file sprintf("%f ", $PE1_DATA_O_NLI[$i]);
}
for ($i = 0; $i < $MAC_ROW_NUM_ORG; $i++){
  printf $output_file sprintf("%f ", $PE2_DATA_O_NLI[$i]);
}
for ($i = 0; $i < $MAC_ROW_NUM_ORG; $i++){
  printf $output_file sprintf("%f ", $PE3_DATA_O_NLI[$i]);
}
close ($output_file);
#
#
