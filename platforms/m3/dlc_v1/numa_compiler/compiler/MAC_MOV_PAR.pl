...
###### Initial memory footprint: MAC_MEM_*.data
###### Final result: MOV_MEM_*.goldendata
###### Intermediate result: MAC_MEM_*.goldendata

#my $M = $ARGV[0];
my $OF0 = join "", "MAC_MEM_0.data";
open (OUT0, ">$OF0")
	or die "cannot open < ", $OF0, ": $!";
my $OF1 = join "", "MAC_MEM_1.data";
open (OUT1, ">$OF1")
	or die "cannot open < ", $OF1, ": $!";
my $OF2 = join "", "MAC_MEM_2.data";
open (OUT2, ">$OF2")
	or die "cannot open < ", $OF2, ": $!";
my $OF3 = join "", "MAC_MEM_3.data";
open (OUT3, ">$OF3")
	or die "cannot open < ", $OF3, ": $!";

my $OF_LOG = join "", "MAC_GEN.log";
open (OUT_LOG, ">$OF_LOG")
	or die "cannot open < ", $OF_LOG, ": $!";

my $INST = join "", "MAC.inst";
open (OUT_INST, ">$INST")
...
# for($i=0; $i<$MEM_OUT_BOUND; $i++){
	# $PE0_MEM_LINES[$i] = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\n";
...
$OF0 = join "", "MOV_MEM_0.goldendata";
$OF1 = join "", "MOV_MEM_1.goldendata";
$OF2 = join "", "MOV_MEM_2.goldendata";
$OF3 = join "", "MOV_MEM_3.goldendata";
open (OUT0, ">$OF0");
open (OUT1, ">$OF1");
open (OUT2, ">$OF2");
open (OUT3, ">$OF3");
