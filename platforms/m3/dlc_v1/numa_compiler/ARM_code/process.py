...
mem_0_file = open(directory + "SRAM_0.mem", "w+")
mem_1_file = open(directory + "SRAM_1.mem", "w+")
mem_2_file = open(directory + "SRAM_2.mem", "w+")
mem_3_file = open(directory + "SRAM_3.mem", "w+")
