...
with open(directory + surfix) as hex_file:
    ...
    for line in hex_file:
        ...
        if(count < 1023):
            mem_L4B1_file.write(str(line_split[0]) + '\n')
            count = count + 1
        elif(count == 1023):
            mem_L4B1_file.write(str(line_split[0]))
            count = count + 1
        elif(count < 2047):
            mem_L4B2_file.write(str(line_split[0]) + '\n')
            count = count + 1
        elif(count == 2047):
            mem_L4B2_file.write(str(line_split[0]))
            count = count + 1
        elif(count < 3071):
            mem_L4B3_file.write(str(line_split[0]) + '\n')
            count = count + 1
        elif(count == 3071):
            mem_L4B3_file.write(str(line_split[0]))
            count = count + 1
        elif(count < 4095):
            mem_L4B4_file.write(str(line_split[0]) + '\n')
            count = count + 1
        elif(count == 4095):
            mem_L4B4_file.write(str(line_split[0]))
            count = count + 1
        elif(count < 5119):
            mem_L3_file.write(str(line_split[0]) + '\n')
            count = count + 1
        elif(count == 5119):
            mem_L3_file.write(str(line_split[0]))
            count = count + 1
        elif(count < 5759):
            mem_L1L2_file.write(str(line_split[0]) + '\n')
            count = count + 1
        elif(count == 5759):
            mem_L1L2_file.write(str(line_split[0]))
            count = count + 1
