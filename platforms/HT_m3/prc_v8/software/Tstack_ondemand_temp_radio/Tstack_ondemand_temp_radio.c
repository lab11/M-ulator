...
#define TEMP_WAKEUP_CYCLE 4000     //800:2min       //Wake up timer tuning: # of wake up timer cycles to sleep
#define TEMP_WAKEUP_CYCLE_INITIAL 500 // Wake up timer duration for initial periods
