...
void handler_ext_int_0(void){
  *((volatile uint32_t *) 0xE000E280) = 0x1;
    *((volatile uint32_t *) 0x00000740) = 0x000000FF;	// Temp Data Reception Marker
}
...
int main() {
  ...
  *((volatile uint32_t *) 0xE000E100) = 0xF;
  ...
  if ( exec_marker != 0x12345678 ) {
    ...
    *((volatile uint32_t *) 0x00000740) = 0x00000000;	// Temp Data Reception Marker
...
/*    for( temp_wait_count = 20; temp_wait_count >0; --temp_wait_count ){
    	temp_recp_mark = *((volatile uint32_t *) 0x00000740);
	if( temp_recp_mark ){
	    //Grab Data after IRQ
	    temp_data = *((volatile uint32_t *) IMSG0);
	    break;
	}
	else if( temp_wait_count ){
	    delay( 0x500 );
            continue;
	}
	else {
	    temp_data = 0xAAAAAAAA;
	    break;
	}
    }
*/
