...
#define RAD_BIT_DELAY 84     //0x54    //Radio tuning: Delay between bits sent (16 bits / packet)
#define RAD_PACKET_DELAY 600  //1000    //Radio tuning: Delay between packets sent (3 packets / sample)
#define RAD_SAMPLE_DELAY 3     //2//213:10min       //Wake up timer tuning: # of wake up timer cycles to sleep
...
//      else                   write_mbus_register(RAD_ADDR,0x27,0x0);
    ...
    // Debug pointer
    //delay(MBUS_DELAY);
    //write_mbus_register(0x17,3,0xDDDD);
  ...
  *((volatile uint32_t *) 0xE000E100) = 0xF;
  ...
  if ( exec_marker != 0x12345678 ) {
    ...
    *((volatile uint32_t *) 0x00000730) = 0x00000010;
    ...
    //Current Limiter  
    uint32_t _rad_r26 = 0x2F; // 2F is 30uA, 1F is 3uA
  ...
  *((volatile uint32_t *) 0xE000E100) = 0xF;
  ...
  if ( exec_temp_marker != 0x87654321 ) {
    ...
    *((volatile uint32_t *) 0x00000750) = 0x87654321;
    ...
    // Set wakeup timer
    *((volatile uint32_t *) 0xA2000010) = 0x000080FF;
